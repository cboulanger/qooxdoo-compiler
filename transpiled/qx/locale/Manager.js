  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_36_0 = qx.$$translations || {};
      this.__P_36_1 = qx.$$locales || {};
      this.initLocale();
      this.__P_36_2 = this.getLocale();
    },
    ...
    */
    members: {
      __P_36_3: qx.core.Environment.get("locale.default"),
      __P_36_4: null,
      __P_36_5: null,
      __P_36_0: null,
      __P_36_1: null,
      ...
      getAvailableLocales: function getAvailableLocales(includeNonloaded) {
        ...
        for (var locale in this.__P_36_1) {
          if (locale != this.__P_36_3) {
            if (this.__P_36_1[locale] === null && !includeNonloaded) {
       ...
       */
      __P_36_6: function __P_36_6(locale) {
        var language;
      ...
      _applyLocale: function _applyLocale(value, old) {
        this.__P_36_4 = value;
        this.__P_36_5 = this.__P_36_6(value);
      },
      ...
      translate: function translate(messageId, args, locale) {
        var catalog = this.__P_36_0;
        return this.__P_36_7(catalog, messageId, args, locale);
      },
       ...
       * @return {String | LocalizedString} translated message or localized string
       */
      __P_36_7: function __P_36_7(catalog, messageId, args, locale) {
        var txt;
        ...
        if (locale) {
          var language = this.__P_36_6(locale);
        } else {
          locale = this.__P_36_4;
          language = this.__P_36_5;
        } // e.g. DE_at
        ...
        if (!txt && catalog[this.__P_36_3]) {
          txt = catalog[this.__P_36_3][messageId];
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__P_36_1);
        }
        return txt;
      }
    }
...
//# sourceMappingURL=Manager.js.map?dt=1593592726738