    ...
    */
    members: {
      ...
      getIds: function getIds(pathfragment) {
        var registry = qx.util.ResourceManager.__P_4_0;
       ...
       */
      has: function has(id) {
        return !!qx.util.ResourceManager.__P_4_0[id];
      },
      ...
      getData: function getData(id) {
        return qx.util.ResourceManager.__P_4_0[id] || null;
      },
      ...
      getImageWidth: function getImageWidth(id) {
        ...
        var entry = qx.util.ResourceManager.__P_4_0[id]; // [ width, height, codepoint ]
      ...
      getImageHeight: function getImageHeight(id) {
        ...
        var entry = qx.util.ResourceManager.__P_4_0[id];
      ...
      getCombinedFormat: function getCombinedFormat(id) {
        var clippedtype = "";
        var entry = qx.util.ResourceManager.__P_4_0[id];
        var isclipped = entry && entry.length > 4 && typeof entry[4] == "string" && this.constructor.__P_4_0[entry[4]];

        if (isclipped) {
          var combId = entry[4];
          var combImg = this.constructor.__P_4_0[combId];
      ...
      toUri: function toUri(id) {
        ...
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("io.ssl")) {
          urlPrefix = qx.util.ResourceManager.__P_4_1[lib];
        }
      ...
      toDataUri: function toDataUri(resid) {
        var resentry = this.constructor.__P_4_0[resid];
        var combined = resentry ? this.constructor.__P_4_0[resentry[4]] : null;
        var uri;
        ...
        if (qx.core.Environment.get("io.ssl")) {
          for (var lib in qx.$$libraries) {
            ...
            if (resourceUri.match(/^\/\//) != null) {
              statics.__P_4_1[lib] = window.location.protocol;
            } // If the resourceUri begins with a single slash, include the current
            // hostname
            else if (resourceUri.match(/^\//) != null) {
                if (href) {
                  statics.__P_4_1[lib] = href;
                } else {
                  statics.__P_4_1[lib] = window.location.protocol + "//" + window.location.host;
                }
              ...
              // IMPORTANT: this is only applicable for the source version
                  ...
                  statics.__P_4_1[lib] = url.substring(0, url.lastIndexOf("/") + 1);
                  ...
                  statics.__P_4_1[lib] = href.substring(0, href.lastIndexOf("/") + 1);
                }
          }
        }
      }
...
//# sourceMappingURL=ResourceManager.js.map?dt=1593594338866