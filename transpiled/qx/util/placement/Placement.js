  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.placement.Placement", {
    ...
    construct: function construct() {
      ...
      this.__P_159_0 = qx.util.placement.DirectAxis;
    },
    properties: {
      /**
    ...
    statics: {
      ...
      compute: function compute(size, area, target, offsets, position, modeX, modeY) {
        this.__P_159_1 = this.__P_159_1 || new qx.util.placement.Placement();
        var splitted = position.split("-");
        var edge = splitted[0];
        var align = splitted[1];

        this.__P_159_1.set({
          axisX: this.__P_159_2(modeX),
          axisY: this.__P_159_2(modeY),
          edge: edge,
          align: align
        });

        return this.__P_159_1.compute(size, area, target, offsets);
      },
      __P_159_3: null,
      __P_159_4: null,
      __P_159_5: null,
       ...
       */
      __P_159_2: function __P_159_2(mode) {
        switch (mode) {
          case "direct":
            this.__P_159_3 = this.__P_159_3 || qx.util.placement.DirectAxis;
            return this.__P_159_3;

          case "keep-align":
            this.__P_159_4 = this.__P_159_4 || qx.util.placement.KeepAlignAxis;
            return this.__P_159_4;

          case "best-fit":
            this.__P_159_5 = this.__P_159_5 || qx.util.placement.BestFitAxis;
    ...
    members: {
      ...
      compute: function compute(size, area, target, offsets) {
        var axisX = this.getAxisX() || this.__P_159_0;
        ...
        }, area.width, this.__P_159_6());

        var axisY = this.getAxisY() || this.__P_159_0;
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_159_0");
    }
  });
  qx.util.placement.Placement.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Placement.js.map?dt=1595486337274