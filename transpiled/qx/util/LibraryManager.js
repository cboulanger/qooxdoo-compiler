  ...
  qx.Class.define("qx.util.LibraryManager", {
    ...
    members: {
      ...
      has: function has(namespace) {
        return !!qx.util.LibraryManager.__P_20_0[namespace];
      },
      ...
      get: function get(namespace, key) {
        return qx.util.LibraryManager.__P_20_0[namespace][key] ? qx.util.LibraryManager.__P_20_0[namespace][key] : null;
      },
      ...
      set: function set(namespace, key, value) {
        qx.util.LibraryManager.__P_20_0[namespace][key] = value;
      }
    }
  });
...
//# sourceMappingURL=LibraryManager.js.map?dt=1593592725040