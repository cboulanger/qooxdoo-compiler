  ...
  qx.Bootstrap.define("qx.type.BaseError", {
    ...
    */
    ...
    construct: function construct(comment, failMessage) {
      ...
      this.__P_219_0 = comment || ""; // opera 10 crashes if the message is an empty string!!!?!?!
    ...
    */
    members: {
      ...
      toString: function toString() {
        return this.__P_219_0 + (this.message ? ": " + this.message : "");
      }
    }
  });
...
//# sourceMappingURL=BaseError.js.map?dt=1593594372916