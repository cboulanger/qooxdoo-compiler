  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.dev.StackTrace", {
    statics: {
      ...
      getStackTraceFromError: function getStackTraceFromError(error) {
        ...
        if (traceProp === "stack") {
          ...
          while ((hit = lineRe.exec(error.stack)) != null) {
            url = hit[1];
            lineNumber = hit[2];
            className = this.__P_143_0(url);
            trace.push(className + ":" + lineNumber);
          }

          if (trace.length > 0) {
            return this.__P_143_1(trace);
          }
          /*
          ...
          while ((hit = lineRe.exec(error.stack)) != null) {
            ...
            if (fileMatch) {
              className = this.__P_143_0(fileMatch[1]);
          ...
          for (var i = 0; i < lines.length; i++) {
            ...
            if (reResult && reResult.length >= 2) {
              ...
              fileName = this.__P_143_0(reResult[2]);
              trace.push(fileName + ":" + lineNumber);
            }
          }
        } else if (error.sourceURL && error.line) {
          // Safari
          trace.push(this.__P_143_0(error.sourceURL) + ":" + error.line);
        }
       ...
       */
      __P_143_0: function __P_143_0(fileName) {
        ...
        return qx.dev.StackTrace.__P_143_2(fileName);
      },
       ...
       */
      __P_143_2: function __P_143_2(fileName) {
       ...
       */
      __P_143_1: function __P_143_1(trace) {
...
//# sourceMappingURL=StackTrace.js.map?dt=1593587984539