    ...
    members: {
      ...
      */
      ...
      _createDomElement: function _createDomElement() {
        return qx.bom.Input.create(this.__P_207_0);
      },
      // overridden
      ...
      setEnabled: function setEnabled(value) {
        ...
        if (qx.core.Environment.get("engine.name") == "webkit") {
          if (!value) {
            ...
            this.setStyles({
              "userModify": null,
              "userSelect": this.__P_207_1 ? null : "none"
            });
          }
        }
      },
      ...
      setSelectable: qx.core.Environment.select("engine.name", {
        "webkit": function webkit(value) {
          this.__P_207_1 = value; // Only apply the value when it is enabled

          qx.html.Input.prototype.setSelectable.base.call(this, this.__P_207_2 && value);
        },
...
//# sourceMappingURL=Input.js.map?dt=1595486344278