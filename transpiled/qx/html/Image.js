    ...
    */
    members: {
      ...
      setPadding: function setPadding(paddingLeft, paddingTop) {
        this.__P_156_1 = paddingLeft;
        this.__P_156_0 = paddingTop;
      ...
      _applyProperty: function _applyProperty(name, value) {
        ...
        if (name === "source") {
          ...
          if (source != null) {
            // Normalize "" to null
            source = source || null;
            styles.paddingTop = this.__P_156_0;
            styles.paddingLeft = this.__P_156_1;
...
//# sourceMappingURL=Image.js.map?dt=1593592747406