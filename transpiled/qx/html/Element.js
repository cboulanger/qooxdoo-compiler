  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__P_33_0 = tagName || "div";
      this.__P_33_1 = styles || null;
      this.__P_33_2 = attributes || null;
    },
    ...
    statics: {
      ...
      */
      ...
      _scheduleFlush: function _scheduleFlush(job) {
        qx.html.Element.__P_33_6.schedule();
      },
      ...
      flush: function flush() {
        ...
        var focusHandler = this.__P_33_7();

        var focusedDomElement = focusHandler.getFocus();

        if (focusedDomElement && this.__P_33_8(focusedDomElement)) {
        ...
        if (activeDomElement && this.__P_33_8(activeDomElement)) {
          qx.bom.Element.deactivate(activeDomElement);
        } // release capture for elements, which will be removed


        var captureDomElement = this.__P_33_9();

        if (captureDomElement && this.__P_33_8(captureDomElement)) {
        ...
        for (var hc in modified) {
          ...
          if (obj.__P_33_10() || obj.classname == "qx.html.Iframe") {
            // Separately queue rendered elements
            if (obj.__P_33_11 && qx.dom.Hierarchy.isRendered(obj.__P_33_11)) {
              later.push(obj);
        ...
        for (var hc in visibility) {
          ...
          if (!obj.$$disposed) {
            element.style.display = obj.__P_33_13 ? "" : "none"; // also hide the element (fixed some rendering problem in IE<8 & IE8 quirks)

            if (qx.core.Environment.get("engine.name") == "mshtml") {
              if (!(document.documentMode >= 8)) {
                element.style.visibility = obj.__P_33_13 ? "visible" : "hidden";
              }
            }
          }
        ...
        for (var hc in scroll) {
          obj = scroll[hc];
          var elem = obj.__P_33_11;

          if (elem && elem.offsetWidth) {
            var done = true; // ScrollToX

            if (obj.__P_33_14 != null) {
              obj.__P_33_11.scrollLeft = obj.__P_33_14;
              delete obj.__P_33_14;
            } // ScrollToY


            if (obj.__P_33_15 != null) {
              obj.__P_33_11.scrollTop = obj.__P_33_15;
              delete obj.__P_33_15;
            } // ScrollIntoViewX


            var intoViewX = obj.__P_33_16;
        ...
        for (var i = 0; i < this._actions.length; i++) {
          ...
          var element = action.element.__P_33_11;

          if (!element || !activityEndActions[action.type] && !action.element.__P_33_10()) {
            continue;
          }
        ...
        for (var hc in this.__P_33_3) {
          var selection = this.__P_33_3[hc];
          var elem = selection.element.__P_33_11;

          if (elem) {
            qx.bom.Selection.set(elem, selection.start, selection.end);
            delete this.__P_33_3[hc];
          }
      ...
      __P_33_7: function __P_33_7() {
        if (!this.__P_33_4) {
          ...
          this.__P_33_4 = eventManager.getHandler(qx.event.handler.Focus);
        }

        return this.__P_33_4;
      },
       ...
       */
      __P_33_9: function __P_33_9() {
        if (!this.__P_33_5) {
          var eventManager = qx.event.Registration.getManager(window);
          this.__P_33_5 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
        }

        return this.__P_33_5.getCaptureElement();
      },
       ...
       */
      __P_33_8: function __P_33_8(domElement) {
        var element = this.fromDomElement(domElement);
        return element && !element.__P_33_10();
      },
    ...
    members: {
      ...
      */
      ...
      _createDomElement: function _createDomElement() {
        return qx.dom.Element.create(this.__P_33_0);
      },
      ...
      connectWidget: function connectWidget(widget) {
        this.__P_33_18 = widget;

        if (this.__P_33_11) {
          this.__P_33_11.$$widget = widget.toHashCode();
          this.__P_33_11.$$widgetObject = widget;
        }
      ...
      disconnectWidget: function disconnectWidget(widget) {
        delete this.__P_33_18;

        if (this.__P_33_11) {
          this.__P_33_11.$$widget = "";
          delete this.__P_33_11.$$widgetObject;
        }
       ...
       */
      __P_33_29: function __P_33_29(domElement) {
        ;
        this.__P_33_11 = domElement;
        domElement.$$elementObject = this;
        domElement.$$element = this.toHashCode();

        if (this.__P_33_18) {
          domElement.$$widget = this.__P_33_18.toHashCode();
          domElement.$$widgetObject = this.__P_33_18;
        }
      },
      ...
      */
       ...
       *
       */
      __P_33_12: function __P_33_12() {
        var length;
        var children = this.__P_33_26;
        ...
        if (children) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__P_33_13 && child.__P_33_20 && !child.__P_33_11) {
              child.__P_33_12();
            }
          }
        }
        ...
        if (!this.__P_33_11) {
          this.__P_33_29(this._createDomElement());
      ...
      */
      ...
      _insertChildren: function _insertChildren() {
        ...
        if (length > 2) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__P_33_11 && child.__P_33_20) {
              domElement.appendChild(child.__P_33_11);
            }
          }

          this.__P_33_11.appendChild(domElement);
        } else {
          var domElement = this.__P_33_11;
      ...
      _syncChildren: function _syncChildren() {
        var dataChildren = this.__P_33_26;
        var dataLength = dataChildren.length;
        var dataChild;
        var dataEl;
        var domParent = this.__P_33_11;
        ...
        for (var i = domChildren.length - 1; i >= 0; i--) {
          ...
          if (!dataEl || !dataEl.__P_33_20 || dataEl.__P_33_28 !== this) {
        ...
        for (var i = 0; i < dataLength; i++) {
          ...
          if (dataChild.__P_33_20) {
            dataEl = dataChild.__P_33_11;
      ...
      */
      updateObjectId: function updateObjectId() {
        ...
        if (qx.core.Environment.get("module.objectid")) {
          ...
          if (this.__P_33_18 && this.__P_33_18.getQxObjectId()) {
            id = qx.core.Id.getAbsoluteIdOf(this.__P_33_18, true) || null;
          }
      ...
      _copyData: function _copyData(fromMarkup) {
        var elem = this.__P_33_11; // Copy attributes

        var data = this.__P_33_2;
      ...
      _syncData: function _syncData() {
        var elem = this.__P_33_11;
        var Attribute = qx.bom.element.Attribute;
        var Style = qx.bom.element.Style; // Sync attributes

        var jobs = this.__P_33_22;
      ...
      */
       ...
       *     of this element
       */
      __P_33_30: function __P_33_30(child) {
        if (child.__P_33_28 === this) {
        ...
        if (child.__P_33_28) {
          child.__P_33_28.remove(child);
        } // Convert to child of this object


        child.__P_33_28 = this; // Prepare array
       ...
       *     of this element
       */
      __P_33_31: function __P_33_31(child) {
        if (child.__P_33_28 !== this) {
       ...
       *     of this element
       */
      __P_33_32: function __P_33_32(child) {
        if (child.__P_33_28 !== this) {
          throw new Error("Has no child: " + child);
        } // Schedule children update
      ...
      */
      ...
      add: function add(varargs) {
        if (arguments[1]) {
          for (var i = 0, l = arguments.length; i < l; i++) {
            this.__P_33_30(arguments[i]);
          }

          this.__P_33_26.push.apply(this.__P_33_26, arguments);
        } else {
          this.__P_33_30(varargs);

          this.__P_33_26.push(varargs);
        } // Chaining support
      ...
      addAt: function addAt(child, index) {
        this.__P_33_30(child);

        qx.lang.Array.insertAt(this.__P_33_26, child, index); // Chaining support
      ...
      remove: function remove(childs) {
        ...
        if (arguments[1]) {
          ...
          for (var i = 0, l = arguments.length; i < l; i++) {
            ...
            this.__P_33_31(child);

            qx.lang.Array.remove(children, child);
          }
        } else {
          this.__P_33_31(childs);
      ...
      removeAt: function removeAt(index) {
        ...
        qx.lang.Array.removeAt(this.__P_33_26, index); // Chaining support
      ...
      */
      ...
      insertInto: function insertInto(parent, index) {
        parent.__P_33_30(this);

        if (index == null) {
          parent.__P_33_26.push(this);
        } else {
          qx.lang.Array.insertAt(this.__P_33_26, this, index);
        }
      ...
      insertBefore: function insertBefore(rel) {
        var parent = rel.__P_33_28;

        parent.__P_33_30(this);

        qx.lang.Array.insertBefore(parent.__P_33_26, this, rel);
        return this;
      },
      ...
      insertAfter: function insertAfter(rel) {
        ...
        qx.lang.Array.insertAfter(parent.__P_33_26, this, rel);
        return this;
      },
      ...
      moveTo: function moveTo(index) {
        var parent = this.__P_33_28;

        parent.__P_33_32(this);

        var oldIndex = parent.__P_33_26.indexOf(this);
        ...
        qx.lang.Array.removeAt(parent.__P_33_26, oldIndex);
        qx.lang.Array.insertAt(parent.__P_33_26, this, index);
        return this;
      },
      ...
      moveBefore: function moveBefore(rel) {
        var parent = this.__P_33_28;
        return this.moveTo(parent.__P_33_26.indexOf(rel));
      },
      ...
      moveAfter: function moveAfter(rel) {
        var parent = this.__P_33_28;
        return this.moveTo(parent.__P_33_26.indexOf(rel) + 1);
      },
      ...
      free: function free() {
        ...
        parent.__P_33_31(this);

        qx.lang.Array.remove(parent.__P_33_26, this);
        return this;
      },
      ...
      */
      ...
      useElement: function useElement(elem) {
        ...
        this.__P_33_29(elem); // Copy currently existing data over to element
      ...
      isFocusable: function isFocusable() {
        ...
        if (tabIndex >= 0 && focusable[this.__P_33_0]) {
          return true;
        }
      ...
      isNativelyFocusable: function isNativelyFocusable() {
        return !!qx.event.handler.Focus.FOCUSABLE_ELEMENTS[this.__P_33_0];
      },
      ...
      */
      ...
      include: function include() {
        ...
        delete this.__P_33_20;

        if (this.__P_33_28) {
          this.__P_33_28._scheduleChildrenUpdate();
        }
      ...
      */
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_33_33, this);
      },
      ...
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__P_33_33, this);
      },
      __P_33_34: null,
       ...
       */
      __P_33_33: function __P_33_33(e) {
        if (!this.__P_33_34) {
          this.__P_33_34 = true;
          this.__P_33_11.scrollTop = 0;
          this.__P_33_11.scrollLeft = 0;
          delete this.__P_33_34;
        }
      },
      ...
      */
      ...
      setTextSelection: function setTextSelection(start, end) {
        ...
        qx.html.Element.__P_33_3[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection: function clearTextSelection() {
        ...
        delete qx.html.Element.__P_33_3[this.toHashCode()];
      },
      ...
      */
       ...
       */
      __P_33_35: function __P_33_35(action, args) {
      ...
      capture: function capture(containerCapture) {
        this.__P_33_35("capture", [containerCapture !== false]);
      },
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        ...
        if (this.__P_33_1[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_33_1[key];
        } else {
          this.__P_33_1[key] = value;
        ...
        if (this.__P_33_11) {
          ...
          if (direct) {
            qx.bom.element.Style.set(this.__P_33_11, key, value);
            return this;
          ...
          this.__P_33_21[key] = true; // Register modification
      ...
      setStyles: function setStyles(map, direct) {
        ...
        if (this.__P_33_11) {
          ...
          for (var key in map) {
            ...
            if (direct) {
              Style.set(this.__P_33_11, key, value);
              continue;
            } // Store job info


            this.__P_33_21[key] = true;
      ...
      getStyle: function getStyle(key) {
        return this.__P_33_1 ? this.__P_33_1[key] : null;
      },
      ...
      */
      ...
      setAttribute: function setAttribute(key, value, direct) {
        ...
        if (this.__P_33_2[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_33_2[key];
        } else {
          this.__P_33_2[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__P_33_11) {
          // Omit queuing in direct mode
          if (direct) {
            qx.bom.element.Attribute.set(this.__P_33_11, key, value);
            return this;
          } // Dynamically create if needed
          ...
          this.__P_33_22[key] = true; // Register modification
      ...
      getAttribute: function getAttribute(key) {
        return this.__P_33_2 ? this.__P_33_2[key] : null;
      },
      ...
      */
      ...
      _setProperty: function _setProperty(key, value, direct) {
        ...
        if (this.__P_33_24[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_33_24[key];
        } else {
          this.__P_33_24[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__P_33_11) {
          ...
          this.__P_33_23[key] = true; // Register modification
      ...
      */
      ...
      addListener: function addListener(type, listener, self, capture) {
        ...
        if (this.__P_33_11) {
          return qx.event.Registration.addListener(this.__P_33_11, type, listener, self, capture);
        }
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        ...
        if (this.__P_33_11) {
          ...
          qx.event.Registration.removeListener(this.__P_33_11, type, listener, self, capture);
        } else {
          var values = this.__P_33_25;
          var entry;
      ...
      removeListenerById: function removeListenerById(id) {
        ...
        if (this.__P_33_11) {
          qx.event.Registration.removeListenerById(this.__P_33_11, id);
        } else {
          delete this.__P_33_25[id];
        }
      ...
      hasListener: function hasListener(type, capture) {
        ...
        if (this.__P_33_11) {
          return qx.event.Registration.hasListener(this.__P_33_11, type, capture);
        }
      ...
      getListeners: function getListeners() {
        ...
        if (this.__P_33_11) {
          return qx.event.Registration.getManager(this.__P_33_11).serializeListeners(this.__P_33_11);
        }

        var listeners = [];

        for (var id in this.__P_33_25) {
          var listenerData = this.__P_33_25[id];
          listeners.push({
    ...
    */
    defer: function defer(statics) {
      statics.__P_33_6 = new qx.util.DeferredCall(statics.flush, statics);
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeArray("__P_33_26");

      this.__P_33_2 = this.__P_33_1 = this.__P_33_25 = this.__P_33_24 = this.__P_33_22 = this.__P_33_21 = this.__P_33_23 = this.__P_33_11 = this.__P_33_28 = this.__P_33_16 = this.__P_33_17 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1593592726430