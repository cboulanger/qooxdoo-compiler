  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_69_0, this, true); // Instantiate timers

      this.__P_69_1 = new qx.event.Timer();

      this.__P_69_1.addListener("interval", this.__P_69_2, this);

      this.__P_69_3 = new qx.event.Timer();

      this.__P_69_3.addListener("interval", this.__P_69_4, this); // Init pointer position
    ...
    */
    members: {
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__P_69_6) {
          this.__P_69_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__P_69_7) {
          this.__P_69_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });

          this.__P_69_7.setLabel(""); // trigger label widget creation


          this.__P_69_7.syncAppearance();
        }

        return this.__P_69_7;
      },
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_69_1.startWith(value.getShowTimeout()); // Register hide handler


          Registration.addListener(el, "pointerout", this.__P_69_8, this, true);
          Registration.addListener(el, "focusout", this.__P_69_9, this, true);
          Registration.addListener(el, "pointermove", this.__P_69_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__P_69_8, this, true);
          Registration.removeListener(el, "focusout", this.__P_69_9, this, true);
          Registration.removeListener(el, "pointermove", this.__P_69_10, this, true);
        }
      },
      ...
      */
       ...
       */
      __P_69_2: function __P_69_2(e) {
        var current = this.getCurrent();

        if (current && !current.isDisposed()) {
          this.__P_69_3.startWith(current.getHideTimeout());

          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__P_69_5);
          }
      ...
      */
       ...
       */
      __P_69_10: function __P_69_10(e) {
        var pos = this.__P_69_5;
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_69_0, this, true); // Dispose timers

      this._disposeObjects("__P_69_1", "__P_69_3", "__P_69_6");
...
//# sourceMappingURL=Manager.js.map?dt=1596533196387