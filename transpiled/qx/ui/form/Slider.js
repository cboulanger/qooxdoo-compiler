    ...
    members: {
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        var isHorizontal = this.__P_238_13;
        ...
        var sliderLocation = this.__P_238_0 = qx.bom.element.Location.get(this.getContentElement().getDomElement())[locationProperty];
        sliderLocation += padding;
        var knobLocation = this.__P_238_1 = qx.bom.element.Location.get(knob.getContentElement().getDomElement())[locationProperty];
        ...
        if (e.getTarget() === knob) {
          ...
          if (!this.__P_238_9) {
            ...
            this.__P_238_9 = new qx.event.Timer(100);

            this.__P_238_9.addListener("interval", this._fireValue, this);
          }

          this.__P_238_9.start(); // Compute dragOffset (includes both: inner position of the widget and
          // cursor position on knob)


          this.__P_238_4 = cursorLocation + sliderLocation - knobLocation; // add state

          knob.addState("pressed");
        } else {
          // Switch into tracking mode
          this.__P_238_5 = true; // Detect tracking direction

          this.__P_238_6 = cursorLocation <= knobLocation ? -1 : 1; // Compute end value

          this.__P_238_14(e); // Directly call interval method once
          ...
          if (!this.__P_238_8) {
            this.__P_238_8 = new qx.event.Timer(100);

            this.__P_238_8.addListener("interval", this._onInterval, this);
          } // Start timer


          this.__P_238_8.start();
      ...
      _onPointerUp: function _onPointerUp(e) {
        if (this.__P_238_3) {
          ...
          delete this.__P_238_3; // as we come out of drag mode, make
          ...
          delete this.__P_238_4; // remove state
          ...
          if (e.getType() === "pointerup") {
            ...
            if (this.__P_238_13) {
              deltaSlider = e.getDocumentLeft() - (this._valueToPosition(this.getValue()) + this.__P_238_0);
              ...
              deltaSlider = e.getDocumentTop() - (this._valueToPosition(this.getValue()) + this.__P_238_0);
            ...
            if (deltaPosition < 0 || deltaPosition > this.__P_238_2 || deltaSlider < 0 || deltaSlider > this.__P_238_2) {
              this.getChildControl("knob").removeState("hovered");
            }
          }
        } else if (this.__P_238_5) {
          // Stop timer interval
          this.__P_238_8.stop(); // Release capture mode


          this.releaseCapture(); // Cleanup status flags

          delete this.__P_238_5;
          delete this.__P_238_6;
          delete this.__P_238_7;
      ...
      _onPointerMove: function _onPointerMove(e) {
        if (this.__P_238_3) {
          var dragStop = this.__P_238_13 ? e.getDocumentLeft() : e.getDocumentTop();
          var position = dragStop - this.__P_238_4;
      ...
      _onInterval: function _onInterval(e) {
        // Compute new value
        var value = this.getValue() + this.__P_238_6 * this.getPageStep(); // Limit value
        ...
        var slideBack = this.__P_238_6 == -1;

        if (slideBack && value <= this.__P_238_7 || !slideBack && value >= this.__P_238_7) {
          value = this.__P_238_7;
      ...
      _onUpdate: function _onUpdate(e) {
        ...
        var sizeProperty = this.__P_238_13 ? "width" : "height"; // Sync knob size

        this._updateKnobSize(); // Store knob size


        this.__P_238_15 = availSize[sizeProperty] - knobSize[sizeProperty];
        this.__P_238_2 = knobSize[sizeProperty]; // Update knob position (sliding space must be updated first)
      ...
      */
       ...
       * @param e {qx.event.type.Pointer} Incoming pointer event
       */
      __P_238_14: function __P_238_14(e) {
        var isHorizontal = this.__P_238_13;
        var cursorLocation = isHorizontal ? e.getDocumentLeft() : e.getDocumentTop();
        var sliderLocation = this.__P_238_0;
        var knobLocation = this.__P_238_1;
        var knobSize = this.__P_238_2; // Compute relative position
        ...
        if (value < min) {
          ...
          var method = this.__P_238_6 < 0 ? "floor" : "ceil"; // Fix to page step
        ...
        if (this.__P_238_7 == null || this.__P_238_6 == -1 && value <= this.__P_238_7 || this.__P_238_6 == 1 && value >= this.__P_238_7) {
          this.__P_238_7 = value;
        }
      },
      ...
      _positionToValue: function _positionToValue(position) {
        ...
        var avail = this.__P_238_15; // Protect undefined value (before initial resize) and division by zero
      ...
      */
      ...
      slideTo: function slideTo(value, duration) {
        ...
        if (duration) {
          this.__P_238_16(value, duration);
        } else {
      ...
      updatePosition: function updatePosition(value) {
        this.setValue(this.__P_238_17(value));
      },
      ...
      stopSlideAnimation: function stopSlideAnimation() {
        if (this.__P_238_12) {
          this.__P_238_12.cancelSequence();

          this.__P_238_12 = null;
        }
      },
       ...
       */
      __P_238_17: function __P_238_17(value) {
       ...
       * @param duration {Number} The time in milliseconds the slide to should take.
       */
      __P_238_16: function __P_238_16(to, duration) {
        to = this.__P_238_17(to);
        var from = this.getValue();
        this.__P_238_12 = new qx.bom.AnimationFrame();

        this.__P_238_12.on("frame", function (timePassed) {
          this.setValue(parseInt(timePassed / duration * (to - from) + from));
        }, this);

        this.__P_238_12.on("end", function () {
          this.setValue(to);
          this.__P_238_12 = null;
          this.fireEvent("slideAnimationEnd");
        }, this);

        this.__P_238_12.startSequence(duration);
      },
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        this.__P_238_13 = value === "horizontal"; // Toggle states and knob layout
      ...
      _fireValue: function _fireValue() {
        ...
        var tmp = this.__P_238_11;
        this.__P_238_11 = null;
...
//# sourceMappingURL=Slider.js.map?dt=1596533226334