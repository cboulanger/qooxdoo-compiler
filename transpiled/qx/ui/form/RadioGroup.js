  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.__P_51_0 = []; // add listener before call add!!!

      this.addListener("changeSelection", this.__P_51_1, this);
    ...
    members: {
      ...
      */
      ...
      _applyGroupedProperty: function _applyGroupedProperty(value, old) {
        ...
        for (var i = 0; i < this.__P_51_0.length; i++) {
          item = this.__P_51_0[i]; // remove the listener for the old change event
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_51_0.length; i++) {
          this.__P_51_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__P_51_0.length; i++) {
          this.__P_51_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      _isItemSelectable: function _isItemSelectable(item) {
        return this.__P_51_0.indexOf(item) != -1;
      },
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__P_51_0");
    }
  });
  qx.ui.form.RadioGroup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RadioGroup.js.map?dt=1593552883701