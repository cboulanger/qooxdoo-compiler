  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_116_0 = new qx.data.Array(); // listen to the changes

      this.__P_116_0.addListener("change", this.__P_116_1, this);

      this.addListener("changeSelection", this.__P_116_2, this);
    },
    events: {
      /**
    ...
    members: {
      ...
      __P_116_1: function __P_116_1() {
        ...
        var modelSelection = this.__P_116_0.toArray();
        ...
        this.__P_116_3 = false; // check if the setting has worked
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        if (!modelSelection) {
          this.__P_116_0.removeAll();

          return;
        }

        // add the first two parameter
        modelSelection.unshift(this.__P_116_0.getLength()); // remove index

        modelSelection.unshift(0); // start index

        var returnArray = this.__P_116_0.splice.apply(this.__P_116_0, modelSelection);
...
//# sourceMappingURL=MModelSelection.js.map?dt=1593592740082