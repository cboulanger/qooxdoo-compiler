  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_212_0 = new qx.event.AcceleratingTimer();

      this.__P_212_0.addListener("interval", this._onInterval, this);
    },
    events: {
      /**
    ...
    members: {
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          ...
          if (this.hasState("pressed") && !this.__P_212_1) {
            this.execute();
          }
        }
      ...
      */
       ...
       *
       */
      __P_212_2: function __P_212_2() {
        this.fireEvent("press");
        this.__P_212_1 = false;
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_212_0");
    }
  });
  qx.ui.form.RepeatButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RepeatButton.js.map?dt=1596533221242