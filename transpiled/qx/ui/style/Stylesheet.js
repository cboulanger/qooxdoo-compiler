  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    construct: function construct() {
      ...
      this.__P_70_0 = qx.bom.Stylesheet.createElement();
      this.__P_70_1 = [];
    },
    members: {
      __P_70_1: null,
      ...
      addRule: function addRule(selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__P_70_0, selector, css);

        this.__P_70_1.push(selector);
      },
      ...
      hasRule: function hasRule(selector) {
        return this.__P_70_1.indexOf(selector) != -1;
      },
      ...
      removeRule: function removeRule(selector) {
        delete this.__P_70_1[this.__P_70_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__P_70_0, selector);
      }
    }
  });
...
//# sourceMappingURL=Stylesheet.js.map?dt=1595486322293