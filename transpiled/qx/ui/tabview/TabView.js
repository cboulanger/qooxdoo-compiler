  ...
  qx.Class.define("qx.ui.tabview.TabView", {
    ...
    */
    ...
    construct: function construct(barPosition) {
      ...
      var mgr = this.__P_122_1 = this._createRadioGroupInstance();
    ...
    members: {
      ...
      */
      ...
      add: function add(page) {
        ...
        this.__P_122_1.add(button); // Add state to page


        page.addState(this.__P_122_0[this.getBarPosition()]); // Update states
      ...
      remove: function remove(page) {
        ...
        this.__P_122_1.remove(button); // Remove state from page


        page.removeState(this.__P_122_0[this.getBarPosition()]); // Update states
      ...
      */
      ...
      _applyBarPosition: function _applyBarPosition(value, old) {
        ...
        if (old) {
          var oldState = this.__P_122_0[old]; // Update bar
        ...
        if (value) {
          var newState = this.__P_122_0[value]; // Update bar
      ...
      */
      ...
      getSelection: function getSelection() {
        var buttons = this.__P_122_1.getSelection();
      ...
      setSelection: function setSelection(items) {
        ...
        this.__P_122_1.setSelection(buttons);
      },
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__P_122_1.isSelected(button);
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_122_1.isSelectionEmpty();
      },
      ...
      getSelectables: function getSelectables(all) {
        var buttons = this.__P_122_1.getSelectables(all);
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_122_1");
...
//# sourceMappingURL=TabView.js.map?dt=1593592740924