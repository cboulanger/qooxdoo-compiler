  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        if (this.__P_55_1) {
          this.__P_55_4 = this.__P_55_5();
          delete this.__P_55_1;
        }

        return {
          width: this.__P_55_4.width,
          height: this.__P_55_4.height
        };
      },
      // overridden
      ...
      _getContentHeightForWidth: function _getContentHeightForWidth(width) {
        ...
        return this.__P_55_5(width).height;
      },
      // overridden
      ...
      */
      ...
      _applyFont: function _applyFont(value, old) {
        if (old && this.__P_55_0 && this.__P_55_3) {
          this.__P_55_0.removeListenerById(this.__P_55_3);
        ...
        if (value) {
          this.__P_55_0 = qx.theme.manager.Font.getInstance().resolve(value);

          if (this.__P_55_0 instanceof qx.bom.webfonts.WebFont) {
            this.__P_55_3 = this.__P_55_0.addListener("changeStatus", this._onWebFontStatusChange, this);
          }

          styles = this.__P_55_0.getStyles();
        } else {
          this.__P_55_0 = null;
        ...
        this.__P_55_1 = true; // Update layout
       ...
       */
      __P_55_5: function __P_55_5(width) {
        var Label = qx.bom.Label;
        var font = this.getFont();
        var styles = font ? this.__P_55_0.getStyles() : qx.bom.Font.getDefaultStyles();
      ...
      */
      ...
      _applyBuddy: function _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__P_55_2);
          this.__P_55_2 = null;
        }

        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__P_55_2 = this.addListener("tap", function () {
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__P_55_0 && this.__P_55_3) {
        this.__P_55_0.removeListenerById(this.__P_55_3);
      }
...
//# sourceMappingURL=Label.js.map?dt=1593594346261