  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_102_1 || 0,
          height: this.__P_102_2 || 0
        };
      },
      // overridden
      _applyDecorator: function _applyDecorator(value, old) {
        ...
        this.__P_102_8(el, source);
      },
      // overridden
      _applyTextColor: function _applyTextColor(value) {
        if (this.__P_102_9() === "font") {
          var el = this.getContentElement();
      ...
      */
       ...
       */
      __P_102_10: function __P_102_10(mode) {
        this.__P_102_3 = mode;
      },
       ...
       */
      __P_102_9: function __P_102_9() {
        if (this.__P_102_3 == null) {
          var source = this.getSource();
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_102_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_102_3 = "scaled";
          } else {
            this.__P_102_3 = "nonScaled";
          }
        }
       ...
       */
      __P_102_11: function __P_102_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_102_5 = new qx.html.Element("div");
            element.connectWidget(this);
      ...
      __P_102_7: function __P_102_7() {
        ...
        var mode = this.__P_102_9();

        if (this.__P_102_0[mode] == null) {
          this.__P_102_0[mode] = this.__P_102_11(mode);
        }

        var element = this.__P_102_0[mode];

        if (!this.__P_102_4) {
          this.__P_102_4 = element;
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_102_12(element);

          return;
        }

        this.__P_102_13(source);
        ...
        var contentEl = this.__P_102_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__P_102_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_102_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_102_17(contentEl, source);

          this.__P_102_16();
        } else {
          this.__P_102_18(contentEl, source);
        }
      },
       ...
       */
      __P_102_14: function __P_102_14() {
        var contentEl = this.__P_102_4;
       ...
       */
      __P_102_13: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(source) {
          ...
          if (isFont) {
            this.__P_102_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_102_9() != "alphaScaled") {
              this.__P_102_10("alphaScaled");
            } else if (!this.getScale() && this.__P_102_9() != "nonScaled") {
              this.__P_102_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_102_9() != "scaled") {
              this.__P_102_10("scaled");
            } else if (!this.getScale() && this.__P_102_9() != "nonScaled") {
              this.__P_102_10("nonScaled");
            }
          }

          this.__P_102_19(this.__P_102_7());
        },
        "default": function _default(source) {
          ...
          if (isFont) {
            this.__P_102_10("font");
          } else if (this.getScale() && this.__P_102_9() != "scaled") {
            this.__P_102_10("scaled");
          } else if (!this.getScale() && this.__P_102_9() != "nonScaled") {
            this.__P_102_10("nonScaled");
          }
       ...
       */
      __P_102_19: function __P_102_19(elementToAdd) {
        var currentContentElement = this.__P_102_4;
        ...
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_102_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_102_15: function __P_102_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          this.__P_102_20(width, height);

          this.__P_102_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_102_8(el, source); // Compare with old sizes and relayout if necessary


          this.__P_102_20(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
       ...
       * @param source {String} source path
       */
      __P_102_17: function __P_102_17(el, source) {
       ...
       * @param el {Element} image DOM element
       */
      __P_102_12: function __P_102_12(el) {
        if (el != null) {
       ...
       * @param source {String} source path
       */
      __P_102_8: function __P_102_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            el.setStyle("fontSize", (this.__P_102_1 > this.__P_102_2 ? this.__P_102_2 : this.__P_102_1) + "px");
          } else {
       ...
       */
      __P_102_21: function __P_102_21(source, imageInfo) {
        ...
        this.__P_102_17(this.__P_102_14(), source);
      },
       ...
       */
      __P_102_20: function __P_102_20(width, height) {
        // Compare with old sizes and relayout if necessary
        if (width !== this.__P_102_1 || height !== this.__P_102_2) {
          this.__P_102_1 = width;
          this.__P_102_2 = height;
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_102_0) {
        if (this.__P_102_0.hasOwnProperty(mode)) {
          this.__P_102_0[mode].disconnectWidget(this);
        }
      }

      delete this.__P_102_4;

      if (this.__P_102_5) {
        delete this.__P_102_5;
      }

      this._disposeMap("__P_102_0");
    }
  });
  qx.ui.basic.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1593592737651