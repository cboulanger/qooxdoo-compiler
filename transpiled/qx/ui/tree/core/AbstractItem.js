    ...
    members: {
      ...
      */
      ...
      addSpacer: function addSpacer() {
        if (!this.__P_206_2) {
          this.__P_206_2 = new qx.ui.core.Spacer();
        } else {
          this._remove(this.__P_206_2);
        }

        this._add(this.__P_206_2);
      },
      ...
      */
      ...
      _applyIconOpened: function _applyIconOpened(value, old) {
        if (this.isOpen()) {
          ...
          if (this.__P_206_5() && this.__P_206_3()) {
            this.__P_206_4(value);
          } // .. only "opened" icon was user-defined
          else if (!this.__P_206_5() && this.__P_206_3()) {
              this.__P_206_4(value);
            }
        }
      },
      ...
      _applyOpen: function _applyOpen(value, old) {
        ...
        if (value) {
          ...
          source = this.__P_206_3() ? this.getIconOpened() : null;
        } // Closed
        else {
            source = this.getIcon();
          }
      ...
      */
      __P_206_4: function __P_206_4(url) {
      ...
      */
      ...
      _updateIndent: function _updateIndent() {
        ...
        if (this.__P_206_2) {
          this.__P_206_2.setWidth((this.getLevel() + 1) * this.getIndent() - openWidth);
        }
      },
      // property apply
...
//# sourceMappingURL=AbstractItem.js.map?dt=1593587992173