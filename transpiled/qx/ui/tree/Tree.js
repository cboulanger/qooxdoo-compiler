  ...
  qx.Class.define("qx.ui.tree.Tree", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_106_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
        allowShrinkY: false,
        allowGrowX: true
      });
      this.getChildControl("pane").add(this.__P_106_0);
      this.initOpenMode();
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_106_0");
    }
  });
  qx.ui.tree.Tree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Tree.js.map?dt=1593552894174