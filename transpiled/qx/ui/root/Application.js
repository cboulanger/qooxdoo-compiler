  ...
  qx.Class.define("qx.ui.root.Application", {
    ...
    */
    ...
    construct: function construct(doc) {
      // Symbolic links
      this.__P_16_0 = qx.dom.Node.getWindow(doc);
      this.__P_16_1 = doc; // Base call

      qx.ui.root.Abstract.constructor.call(this); // Resize handling

      qx.event.Registration.addListener(this.__P_16_0, "resize", this._onResize, this); // Use a hard-coded canvas layout
      ...
      this.addListener("touchmove", this.__P_16_2, this); // handle focus for iOS which seems to deny any focus action
    ...
    */
    members: {
      ...
      _computeSizeHint: function _computeSizeHint() {
        var width = qx.bom.Viewport.getWidth(this.__P_16_0);
        var height = qx.bom.Viewport.getHeight(this.__P_16_0);
        return {
          minWidth: width,
          width: width,
          maxWidth: width,
    ...
    */
    destruct: function destruct() {
      this.__P_16_0 = this.__P_16_1 = null;
    }
  });
  qx.ui.root.Application.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Application.js.map?dt=1593552879298