    ...
    */
    members: {
      ...
      */
      ...
      _recalculateOverflow: function _recalculateOverflow(width, requiredWidth) {
        ...
        if (width < requiredWidth) {
          do {
            ...
            this.__P_49_2(childToHide); // new width is the requiredWidth - the removed childs width
        ...
        } else if (this.__P_49_0.length > 0) {
          do {
            var removedChild = this.__P_49_0[0]; // if we have something we can show
            ...
            if (removedChild) {
              ...
              if (this.__P_49_0.length == 1 && overflowWidgetWidth > 0) {
          ...
          } while (width >= requiredWidth && this.__P_49_0.length > 0);
        }
      },
       ...
       */
      __P_49_3: function __P_49_3(child) {
       ...
       */
      __P_49_2: function __P_49_2(child) {
        // ignore the call if no child is given
        if (!child) {
          return;
        }

        this.__P_49_0.unshift(child);
      ...
      _getNextToHide: function _getNextToHide() {
        ...
        for (var i = this.__P_49_1.length - 1; i >= 0; i--) {
          var item = this.__P_49_1[i]; // maybe a priority is left out and spacers don't have the visibility
      ...
      setRemovePriority: function setRemovePriority(item, priority, override) {
        ...
        if (!override && this.__P_49_1[priority] != undefined) {
          throw new Error("Priority already in use!");
        }

        this.__P_49_1[priority] = item;
      },
      // property apply
      _applyOverflowHandling: function _applyOverflowHandling(value, old) {
        ...
        if (value) {
          ...
          for (var i = 0; i < this.__P_49_0.length; i++) {
            this.__P_49_0[i].setVisibility("visible");
          }
...
//# sourceMappingURL=ToolBar.js.map?dt=1593587968887