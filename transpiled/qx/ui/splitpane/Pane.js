  ...
  qx.Class.define("qx.ui.splitpane.Pane", {
    ...
    */
    ...
    construct: function construct(orientation) {
      ...
      this.__P_53_0 = []; // Initialize orientation
      ...
      this.__P_53_1.addListener("pointerdown", this._onPointerDown, this);

      this.__P_53_1.addListener("pointerup", this._onPointerUp, this);

      this.__P_53_1.addListener("pointermove", this._onPointerMove, this);

      this.__P_53_1.addListener("pointerout", this._onPointerOut, this);

      this.__P_53_1.addListener("losecapture", this._onPointerUp, this);
    },
    ...
    */
    members: {
      ...
      _createChildControlImpl: function _createChildControlImpl(id, hash) {
        ...
        switch (id) {
          ...
          case "splitter":
            ...
            control.addListener("move", this.__P_53_9, this);
            break;
        }
       ...
       */
      __P_53_9: function __P_53_9(e) {
        this.__P_53_10(e.getData());
      },
       ...
       */
      __P_53_11: function __P_53_11(orientation) {
        this.__P_53_1 = new qx.ui.splitpane.Blocker(orientation);
        this.getContentElement().add(this.__P_53_1);
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        this.__P_53_6 = value === "horizontal";

        if (!this.__P_53_1) {
          this.__P_53_11(value);
        } // update the blocker


        this.__P_53_1.setOrientation(value); // Dispose old layout
       ...
       *   they can be added.
       */
      __P_53_10: function __P_53_10(bounds) {
        var splitter = this.getChildControl("splitter");
        ...
        if (this.__P_53_6) {
          ...
          if (width || !this.getChildControl("splitter").isKnobVisible()) {
            ...
            this.__P_53_1.setWidth(offset, width || 6);

            this.__P_53_1.setLeft(offset, left);
          } // vertical case
          ...
          if (height || !this.getChildControl("splitter").isKnobVisible()) {
            ...
            this.__P_53_1.setHeight(offset, height || 6);

            this.__P_53_1.setTop(offset, top);
          }
        }
      },
      ...
      */
      ...
      remove: function remove(widget) {
        ...
        qx.lang.Array.remove(this.__P_53_0, widget);
      },
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        this.__P_53_2 = this.__P_53_6 ? e.getDocumentLeft() - splitterLocation.left + paneLocation.left : e.getDocumentTop() - splitterLocation.top + paneLocation.top; // Synchronize slider to splitter size and show it
      ...
      _onPointerMove: function _onPointerMove(e) {
        ...
        if (this.__P_53_3) {
          ...
          this.__P_53_12(); // Update slider position


          var slider = this.getChildControl("slider");
          var pos = this.__P_53_7;

          if (this.__P_53_6) {
            slider.setDomLeft(pos);

            this.__P_53_1.setStyle("left", pos - this.getOffset() + "px");
          } else {
            slider.setDomTop(pos);

            this.__P_53_1.setStyle("top", pos - this.getOffset() + "px");
          }
      ...
      */
      ...
      _finalizeSizes: function _finalizeSizes() {
        var beginSize = this.__P_53_7;
        var endSize = this.__P_53_8;
      ...
      __P_53_12: function __P_53_12() {
        if (this.__P_53_6) {
          var min = "minWidth",
              size = "width",
              max = "maxWidth",
              pointer = this.__P_53_4;
        } else {
          var min = "minHeight",
              size = "height",
              max = "maxHeight",
              pointer = this.__P_53_5;
        }
        ...
        var beginSize = pointer - this.__P_53_2;
        ...
        this.__P_53_7 = beginSize;
        this.__P_53_8 = endSize;
      },
...
//# sourceMappingURL=Pane.js.map?dt=1593587969541