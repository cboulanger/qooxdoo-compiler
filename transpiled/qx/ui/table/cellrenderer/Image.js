  ...
  qx.Class.define("qx.ui.table.cellrenderer.Image", {
    ...
    */
    ...
    construct: function construct(width, height) {
      ...
      if (width) {
        this.__P_111_0 = width;
      }

      if (height) {
        this.__P_111_1 = height;
      }

      this.__P_111_2 = qx.util.AliasManager.getInstance();
    },
    ...
    */
    members: {
      ...
      _identifyImage: function _identifyImage(cellInfo) {
        var imageHints = {
          imageWidth: this.__P_111_0,
          imageHeight: this.__P_111_1
        };

        if (cellInfo.value == "") {
          imageHints.url = null;
        } else {
          imageHints.url = this.__P_111_2.resolve(cellInfo.value);
        }
...
//# sourceMappingURL=Image.js.map?dt=1593587978960