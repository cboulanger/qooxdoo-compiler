    ...
    members: {
      ...
      _getImageInfos: function _getImageInfos(cellInfo) {
        ...
        if (!imageData.imageWidth || !imageData.imageHeight) {
          var sizes = this.__P_178_3(imageData.url);
       ...
       *    <code>height</code>
       */
      __P_178_3: function __P_178_3(source) {
        ...
        if (ResourceManager.has(source)) {
          ...
          width = this.__P_178_0;
          height = this.__P_178_1;
        }
      ...
      createDataCellHtml: function createDataCellHtml(cellInfo, htmlArr) {
        this.__P_178_2 = this._getImageInfos(cellInfo);
      ...
      _getContentHtml: function _getContentHtml(cellInfo) {
        ...
        if (this.__P_178_2.url) {
          var srcUrl = this.__P_178_2.url;
          var highResolutionSource = qx.util.ResourceManager.getInstance().findHighResolutionSource(this.__P_178_2.url);
          ...
          var style = {
            width: this.__P_178_2.width + "px",
            height: this.__P_178_2.height + "px",
            display: qx.core.Environment.get("css.inlineblock"),
            verticalAlign: "middle",
            position: "static"
          };

          if (qx.util.ResourceManager.getInstance().getCombinedFormat(this.__P_178_2.url) === "") {
            // background size is critical for high-resolution images but breaks combined images
            style["background-size"] = this.__P_178_2.width + "px " + this.__P_178_2.height + "px";
          }
      ...
      _getCellAttributes: function _getCellAttributes(cellInfo) {
        var tooltip = this.__P_178_2.tooltip;
...
//# sourceMappingURL=AbstractImage.js.map?dt=1596533215289