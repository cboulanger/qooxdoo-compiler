  ...
  qx.Class.define("qx.ui.table.pane.Pane", {
    ...
    */
    members: {
      ...
      getTable: function getTable() {
        return this.__P_173_0.getTable();
      },
      ...
      setFocusedCell: function setFocusedCell(col, row, massUpdate) {
        if (col != this.__P_173_6 || row != this.__P_173_5) {
          var oldRow = this.__P_173_5;
          this.__P_173_6 = col;
          this.__P_173_5 = row; // Update the focused row background
      ...
      _applyMaxCacheLines: function _applyMaxCacheLines(value, old) {
        if (this.__P_173_7 >= value && value !== -1) {
          this.__P_173_8();
        }
      },
       ...
       *     index is not cached.
       */
      __P_173_9: function __P_173_9(row, selected, focused) {
        if (!selected && !focused && this.__P_173_3[row]) {
          return this.__P_173_3[row];
        } else {
          return null;
        }
      },
       ...
       * @param focused {Boolean} Whether the row is currently focused
       */
      __P_173_10: function __P_173_10(row, rowString, selected, focused) {
        var maxCacheLines = this.getMaxCacheLines();

        if (!selected && !focused && !this.__P_173_3[row] && maxCacheLines > 0) {
          this._applyMaxCacheLines(maxCacheLines);

          this.__P_173_3[row] = rowString;
          this.__P_173_7 += 1;
        }
      },
      ...
      _updateRowStyles: function _updateRowStyles(onlyRow) {
        ...
        for (; y < end; y++, row++) {
          ...
          cellInfo.focusedRow = this.__P_173_5 == row;
      ...
      _getRowsHtml: function _getRowsHtml(firstRow, rowCount) {
        ...
        for (var row = firstRow; row < firstRow + rowCount; row++) {
          ...
          var focusedRow = this.__P_173_5 == row;

          var cachedRow = this.__P_173_9(row, selected, focusedRow);
          ...
          this.__P_173_10(row, rowString, selected, focusedRow);
      ...
      _scrollContent: function _scrollContent(rowOffset) {
        ...
        if (!this.__P_173_4) {
          this.__P_173_4 = document.createElement("div");
        }

        var tableDummy = '<div>';
        tableDummy += this._getRowsHtml(firstRow + addRowBase, Math.abs(rowOffset));
        tableDummy += '</div>';
        this.__P_173_4.innerHTML = tableDummy;
        var newTableRows = this.__P_173_4.firstChild.childNodes; // append new lines
        ...
        if (this.__P_173_5 !== null) {
          this._updateRowStyles(this.__P_173_5 - rowOffset);

          this._updateRowStyles(this.__P_173_5);
        }
      ...
      _updateAllRows: function _updateAllRows() {
        ...
        this.__P_173_1 = colCount;
        this.__P_173_2 = rowCount;
        this.fireEvent("paneUpdated");
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__P_173_4 = this.__P_173_0 = this.__P_173_3 = null;
...
//# sourceMappingURL=Pane.js.map?dt=1596533214619