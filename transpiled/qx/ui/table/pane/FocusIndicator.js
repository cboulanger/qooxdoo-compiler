  ...
  qx.Class.define("qx.ui.table.pane.FocusIndicator", {
    ...
    members: {
      ...
      moveToCell: function moveToCell(col, row) {
        ...
        if (!this.__P_177_0.getShowCellFocusIndicator() && !this.__P_177_0.getTable().getTableModel().isColumnEditable(col)) {
          this.exclude();
          return;
        } else {
          this.show();
        ...
        if (col == null) {
          ...
          var xPos = this.__P_177_0.getTablePaneModel().getX(col);
          ...
          if (xPos == -1) {
            ...
            var table = this.__P_177_0.getTable();

            var columnModel = table.getTableColumnModel();

            var paneModel = this.__P_177_0.getTablePaneModel();

            var firstRow = this.__P_177_0.getTablePane().getFirstVisibleRow();
...
//# sourceMappingURL=FocusIndicator.js.map?dt=1593587988102