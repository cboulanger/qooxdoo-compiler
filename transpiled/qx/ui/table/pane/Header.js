  ...
  qx.Class.define("qx.ui.table.pane.Header", {
    ...
    */
    ...
    construct: function construct(paneScroller) {
      ...
      this.__P_174_0 = new qx.ui.core.Blocker(this);
      this.__P_174_1 = paneScroller;
    },
    ...
    */
    members: {
      ...
      getTable: function getTable() {
        return this.__P_174_1.getTable();
      },
      ...
      setPointerOverColumn: function setPointerOverColumn(col) {
        if (col != this.__P_174_3) {
          if (this.__P_174_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__P_174_3);
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(col, x) {
        ...
        if (this.__P_174_2 == null) {
          ...
          this.__P_174_2 = feedback;
        }

        this.__P_174_2.setLayoutProperties({
          left: pos.left + x
        });
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_174_1");
    }
  });
  qx.ui.table.pane.Header.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Header.js.map?dt=1595486339082