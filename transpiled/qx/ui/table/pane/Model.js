    ...
    */
    members: {
      ...
      setTableColumnModel: function setTableColumnModel(tableColumnModel) {
        if (this.__P_176_1) {
          this.__P_176_1.removeListener("visibilityChangedPre", this._onColVisibilityChanged, this);

          this.__P_176_1.removeListener("headerCellRendererChanged", this._onHeaderCellRendererChanged, this);
        }

        this.__P_176_1 = tableColumnModel;

        this.__P_176_1.addListener("visibilityChangedPre", this._onColVisibilityChanged, this);

        this.__P_176_1.addListener("headerCellRendererChanged", this._onHeaderCellRendererChanged, this);
      ...
      getColumnCount: function getColumnCount() {
        if (this.__P_176_0 == null) {
          var firstX = this.getFirstColumnX();
          var maxColCount = this.getMaxColumnCount();

          var totalColCount = this.__P_176_1.getVisibleColumnCount();

          if (maxColCount == -1 || firstX + maxColCount > totalColCount) {
            this.__P_176_0 = totalColCount - firstX;
          } else {
            this.__P_176_0 = maxColCount;
          }
        }
      ...
      getColumnAtX: function getColumnAtX(xPos) {
        var firstX = this.getFirstColumnX();
        return this.__P_176_1.getVisibleColumnAtX(firstX + xPos);
      },
      ...
      getX: function getX(col) {
        var firstX = this.getFirstColumnX();
        var maxColCount = this.getMaxColumnCount();
        var x = this.__P_176_1.getVisibleX(col) - firstX;
      ...
      getColumnLeft: function getColumnLeft(col) {
        ...
        for (var x = 0; x < colCount; x++) {
          ...
          left += this.__P_176_1.getColumnWidth(currCol);
        }
      ...
      getTotalWidth: function getTotalWidth() {
        ...
        for (var x = 0; x < colCount; x++) {
          ...
          totalWidth += this.__P_176_1.getColumnWidth(col);
        }
...
//# sourceMappingURL=Model.js.map?dt=1593592749646