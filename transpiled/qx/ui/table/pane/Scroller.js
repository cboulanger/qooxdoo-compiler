  ...
  qx.Class.define("qx.ui.table.pane.Scroller", {
    ...
    */
    ...
    construct: function construct(table) {
      ...
      this.__P_175_0 = table; // init layout
      ...
      this.__P_175_1 = this._showChildControl("header");
      this.__P_175_2 = this._showChildControl("pane"); // the top line containing the header clipper and the top right widget

      this.__P_175_3 = new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({
        minWidth: 0
      });

      this._add(this.__P_175_3, {
        row: 0,
        column: 0,
        colSpan: 2
      ...
      this._headerClipper.add(this.__P_175_1);
      ...
      this.__P_175_3.add(this._headerClipper, {
        flex: 1
      ...
      this._paneClipper.add(this.__P_175_2);
      ...
      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this.__P_175_4 = new qx.ui.container.Composite();

        this.__P_175_4.setLayout(new qx.ui.layout.Canvas());

        this.__P_175_4.add(this._paneClipper, {
          edge: 0
        });

        this._add(this.__P_175_4, {
          row: 1,
          column: 0
        });
      } else {
      ...
      this.__P_175_5 = this._showChildControl("scrollbar-x");
      this.__P_175_6 = this._showChildControl("scrollbar-y"); // init focus indicator

      this.__P_175_7 = this.getChildControl("focus-indicator"); // need to run the apply method at least once [BUG #4057]
      ...
      this.__P_175_8 = new qx.event.Timer();

      this.__P_175_8.addListener("interval", this._oninterval, this);
    ...
    */
    members: {
      ...
      _applyHorizontalScrollBarVisible: function _applyHorizontalScrollBarVisible(value, old) {
        if (value === null) {
          this.__P_175_5.setVisibility("hidden");
        } else {
          this.__P_175_5.setVisibility(value ? "visible" : "excluded");
        }
      },
      // property modifier
      _applyVerticalScrollBarVisible: function _applyVerticalScrollBarVisible(value, old) {
        this.__P_175_6.setVisibility(value ? "visible" : "excluded");
      },
      // property modifier
      ...
      _applyShowCellFocusIndicator: function _applyShowCellFocusIndicator(value, old) {
        if (value) {
          this.__P_175_7.setDecorator("table-scroller-focus-indicator");

          this._updateFocusIndicator();
        } else {
          if (this.__P_175_7) {
            this.__P_175_7.setDecorator(null);
          }
        }
      },
      ...
      getScrollY: function getScrollY() {
        return this.__P_175_6.getPosition();
      },
      ...
      setScrollY: function setScrollY(scrollY, renderSync) {
        this.__P_175_6.scrollTo(scrollY);
      ...
      getScrollX: function getScrollX() {
        return this.__P_175_5.getPosition();
      },
      ...
      setScrollX: function setScrollX(scrollX) {
        this.__P_175_5.scrollTo(scrollX);
      },
      ...
      setColumnWidth: function setColumnWidth(col, width) {
        this.__P_175_1.setColumnWidth(col, width);

        this.__P_175_2.setColumnWidth(col, width);
      ...
      onColOrderChanged: function onColOrderChanged() {
        this.__P_175_1.onColOrderChanged();

        this.__P_175_2.onColOrderChanged();
      ...
      onTableModelDataChanged: function onTableModelDataChanged(firstRow, lastRow, firstColumn, lastColumn) {
        this.__P_175_2.onTableModelDataChanged(firstRow, lastRow, firstColumn, lastColumn);

        var rowCount = this.getTable().getTableModel().getRowCount();

        var colCount = this.__P_175_0.getTableColumnModel().getOverallColumnCount();

        if (rowCount != this.__P_175_9) {
      ...
      onSelectionChanged: function onSelectionChanged() {
        this.__P_175_2.onSelectionChanged();
      },
      ...
      onTableModelMetaDataChanged: function onTableModelMetaDataChanged() {
        this.__P_175_1.onTableModelMetaDataChanged();

        this.__P_175_2.onTableModelMetaDataChanged();
      },
      ...
      _onPaneModelChanged: function _onPaneModelChanged() {
        this.__P_175_1.onPaneModelChanged();

        this.__P_175_2.onPaneModelChanged();
      },
      ...
      _onResizePane: function _onResizePane() {
        ...
        this.__P_175_1._updateContent();

        this.__P_175_0._updateScrollBarVisibility();
      },
      ...
      _onScrollY: function _onScrollY(e) {
        ...
        var scrollbar = this.__P_175_6;
        this.__P_175_28 = true; // calculate delta so that one row is scrolled at an minimum
      ...
      _onRoll: function _onRoll(e) {
        ...
        this.__P_175_6.scrollBy(parseInt(delta.y, 10));

        var scrolled = delta.y != 0 && !this.__P_175_29(this.__P_175_6, delta.y); // horizontal scrolling
        ...
        this.__P_175_5.scrollBy(parseInt(delta.x, 10)); // Update the focus


        if (this.__P_175_21 && this.getFocusCellOnPointerMove()) {
          this._focusCellAtPagePos(this.__P_175_21, this.__P_175_22);
        }

        scrolled = scrolled || delta.x != 0 && !this.__P_175_29(this.__P_175_5, delta.x); // pass the event to the parent if the scrollbar is at an edge
       ...
       */
      __P_175_29: function __P_175_29(scrollBar, delta) {
       ...
       */
      __P_175_30: function __P_175_30(pageX) {
        var table = this.getTable(); // We are currently resizing -> Update the position

        var headerCell = this.__P_175_1.getHeaderWidgetAtColumn(this.__P_175_15);

        var minColumnWidth = headerCell.getSizeHint().minWidth;
        var newWidth = Math.max(minColumnWidth, this.__P_175_17 + pageX - this.__P_175_16);

        if (this.getLiveResize()) {
          var columnModel = table.getTableColumnModel();
          columnModel.setColumnWidth(this.__P_175_15, newWidth, true);
        } else {
          var paneModel = this.getTablePaneModel();

          this._showResizeLine(paneModel.getColumnLeft(this.__P_175_15) + newWidth);
        }

        this.__P_175_16 += newWidth - this.__P_175_17;
        this.__P_175_17 = newWidth;
      },
       ...
       *
       */
      __P_175_31: function __P_175_31(pageX) {
        ...
        if (this.__P_175_1.isShowingColumnMoveFeedback() || pageX > this.__P_175_14 + tapTolerance || pageX < this.__P_175_14 - tapTolerance) {
          this.__P_175_13 += pageX - this.__P_175_14;

          this.__P_175_1.showColumnMoveFeedback(this._moveColumn, this.__P_175_13); // Get the responsible scroller


          var targetScroller = this.__P_175_0.getTablePaneScrollerAtPageX(pageX);
      ...
      _onPointermoveHeader: function _onPointermoveHeader(e) {
        ...
        this.__P_175_21 = pageX;
        this.__P_175_22 = pageY;

        if (this.__P_175_15 != null) {
          // We are currently resizing -> Update the position
          this.__P_175_30(pageX);

          useResizeCursor = true;
          e.stopPropagation();
        } else if (this._moveColumn != null) {
          // We are moving a column
          this.__P_175_31(pageX);
        ...
        this.__P_175_1.setPointerOverColumn(pointerOverColumn);
      },
      ...
      _onPointermovePane: function _onPointermovePane(e) {
        ...
        this.__P_175_1.setPointerOverColumn(null);
      },
      ...
      _startResizeHeader: function _startResizeHeader(resizeCol, pageX) {
        ...
        this.__P_175_15 = resizeCol;
        this.__P_175_16 = pageX;
        this.__P_175_17 = columnModel.getColumnWidth(this.__P_175_15);
      ...
      _startMoveHeader: function _startMoveHeader(moveCol, pageX) {
        ...
        this.__P_175_14 = pageX;
        this.__P_175_13 = this.getTablePaneModel().getColumnLeft(moveCol);
      ...
      _onPointerupFocusIndicator: function _onPointerupFocusIndicator(e) {
        if (this.__P_175_18 && !this.__P_175_19 && !this.isEditing() && this.__P_175_7.getRow() == this.__P_175_18.row && this.__P_175_7.getColumn() == this.__P_175_18.col) {
          this.fireEvent("cellTap", qx.ui.table.pane.CellEvent, [this, e, this.__P_175_18.row, this.__P_175_18.col], true);
          this.__P_175_19 = true;
      ...
      _stopResizeHeader: function _stopResizeHeader() {
        ...
        if (!this.getLiveResize()) {
          ...
          columnModel.setColumnWidth(this.__P_175_15, this.__P_175_17, true);
        }

        this.__P_175_15 = null;
      ...
      _stopMoveHeader: function _stopMoveHeader() {
        ...
        this.__P_175_1.hideColumnMoveFeedback();
      ...
      _onTapPane: function _onTapPane(e) {
        ...
        if (row != null && col != null) {
          ...
          if (this.__P_175_7.isHidden() || this.__P_175_18 && !this.__P_175_19 && !this.isEditing() && row == this.__P_175_18.row && col == this.__P_175_18.col) {
      ...
      _onContextMenu: function _onContextMenu(e) {
        ...
        if (!this.getShowCellFocusIndicator() || row === null || this.__P_175_18 && row == this.__P_175_18.row && col == this.__P_175_18.col) {
      ...
      _onPointerout: function _onPointerout(e) {
        ...
        this.__P_175_1.setPointerOverColumn(null); // in case the focus follows the pointer, it should be remove on pointerout


        if (this.getFocusCellOnPointerMove()) {
          this.__P_175_0.setFocusedCell();
        }
      },
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(pageX) {
        ...
        var paneLeft = this.__P_175_2.getContentLocation().left;
      ...
      _focusCellAtPagePos: function _focusCellAtPagePos(pageX, pageY) {
        ...
        if (row != -1 && row != null) {
          ...
          this.__P_175_0.setFocusedCell(col, row);
        }
      },
      ...
      setFocusedCell: function setFocusedCell(col, row) {
        if (!this.isEditing()) {
          this.__P_175_2.setFocusedCell(col, row, this.__P_175_11);
      ...
      startEditing: function startEditing() {
        ...
        if (!this.isEditing() && col != null && tableModel.isColumnEditable(col)) {
          ...
          this._cellEditor = this.__P_175_25.createCellEditor(cellInfo); // We handle two types of cell editors: the traditional in-place
          ...
          if (this._cellEditor === null) {
            ...
            this.__P_175_27 = this.__P_175_7.addListener("pointerdown", function (e) {
              this.__P_175_18 = {
                row: this.__P_175_24,
                col: this.__P_175_23
              };
            ...
            this.__P_175_7.add(this._cellEditor);

            this.__P_175_7.addState("editing");

            this.__P_175_7.setKeepActive(false); // Make the focus indicator visible during editing
      ...
      flushEditor: function flushEditor(cancel) {
        if (this.isEditing()) {
          var value = this.__P_175_25.getCellEditorValue(this._cellEditor);

          var oldValue = this.getTable().getTableModel().getValue(this.__P_175_23, this.__P_175_24);
          this.getTable().getTableModel().setValue(this.__P_175_23, this.__P_175_24, value);

          this.__P_175_0.focus();
          ...
          this.__P_175_0.fireDataEvent("dataEdited", {
            row: this.__P_175_24,
            col: this.__P_175_23,
            oldValue: oldValue,
            value: value
      ...
      cancelEditing: function cancelEditing() {
        if (this.isEditing()) {
          if (!(this._cellEditor instanceof qx.ui.window.Window)) {
            this.__P_175_7.removeState("editing");

            this.__P_175_7.setKeepActive(true);

            if (this.__P_175_27 !== null) {
              this.__P_175_7.removeListenerById(this.__P_175_27);

              this.__P_175_27 = null;
            }
          }
      ...
      _getColumnForPageX: function _getColumnForPageX(pageX) {
        ...
        var currX = this.__P_175_2.getContentLocation().left;
      ...
      _getResizeColumnForPageX: function _getResizeColumnForPageX(pageX) {
        var contentLocation = this.__P_175_1.getContentLocation() || this.__P_175_2.getContentLocation();
      ...
      _getRowForPagePos: function _getRowForPagePos(pageX, pageY) {
        var panePos = this.__P_175_2.getContentLocation();
        ...
        if (pageY >= panePos.top && pageY <= panePos.bottom) {
          ...
          var scrollY = this.__P_175_6.getPosition();
        ...
        var headerPos = this.__P_175_1.getContentLocation();
      ...
      setTopRightWidget: function setTopRightWidget(widget) {
        var oldWidget = this.__P_175_26;

        if (oldWidget != null) {
          this.__P_175_3.remove(oldWidget);
        }

        if (widget != null) {
          this.__P_175_3.add(widget);
        }

        this.__P_175_26 = widget;
      },
      ...
      _startInterval: function _startInterval(timeout) {
        this.__P_175_8.setInterval(timeout);

        this.__P_175_8.start();
      },
      ...
      _oninterval: qx.event.GlobalError.observeMethod(function () {
        if (this.__P_175_11 && !this.__P_175_2._layoutPending) {
          this.__P_175_11 = false;
      ...
      _updateContent: function _updateContent() {
        ...
        var scrollX = this.__P_175_5.getPosition();
        ...
        var oldFirstRow = this.__P_175_2.getFirstVisibleRow();

        this.__P_175_2.setFirstVisibleRow(firstRow);
        ...
        this.__P_175_2.setVisibleRowCount(visibleRowCount);
      ...
      _updateFocusIndicator: function _updateFocusIndicator() {
        ...
        this.__P_175_7.moveToCell(this.__P_175_23, this.__P_175_24);
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_175_18 = this.__P_175_26 = this.__P_175_0 = null;

      this._disposeObjects("__P_175_5", "__P_175_6", "_headerClipper", "_paneClipper", "__P_175_7", "__P_175_1", "__P_175_2", "__P_175_3", "__P_175_8", "__P_175_4");
    }
  });
  qx.ui.table.pane.Scroller.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Scroller.js.map?dt=1593552905753