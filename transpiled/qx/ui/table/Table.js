  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    construct: function construct(tableModel, custom) {
      ...
      this.__P_110_0 = new qx.ui.container.Composite(new qx.ui.layout.HBox());

      this._add(this.__P_110_0, {
        flex: 1
      ...
      this.__P_110_1 = this.getNewSelectionManager()(this);
      ...
      this.__P_110_2 = null;
      this.__P_110_3 = null; // add an event listener which updates the table content on locale change
    ...
    */
    members: {
      ...
      _applySelectionModel: function _applySelectionModel(value, old) {
        this.__P_110_1.setSelectionModel(value);
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_110_10) {
          this.__P_110_10 = new qx.ui.table.model.Simple();

          this.__P_110_10.setColumns([]);

          this.__P_110_10.setData([]);
        }

        return this.__P_110_10;
      },
      // property modifier
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_110_9) {
          var columnModel = this.__P_110_9 = this.getNewTableColumnModel()(this);
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__P_110_4) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__P_110_4) {
            ...
            this.__P_110_0.add(paneScroller, {
              flex: flex
            });
      ...
      _getPaneScrollerArr: function _getPaneScrollerArr() {
        return this.__P_110_0.getChildren();
      },
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (removeCount) {
          ...
          if (this.__P_110_3 >= removeStart && this.__P_110_3 < removeStart + removeCount) {
            this.setFocusedCell();
          }
        }
        ...
        if (rowCount != this.__P_110_6) {
          this.__P_110_6 = rowCount;
      ...
      _onScrollY: function _onScrollY(evt) {
        if (!this.__P_110_7) {
          this.__P_110_7 = true; // Set the same scroll position to all meta columns
      ...
      _onKeyDown: function _onKeyDown(evt) {
        ...
        var oldFocusedRow = this.__P_110_3;
        ...
        if (this.isEditing()) {
          ...
          if (evt.getModifiers() == 0) {
            switch (identifier) {
              case "Enter":
                ...
                if (this.__P_110_3 != oldFocusedRow) {
          ...
          if (evt.isCtrlPressed()) {
            ...
            switch (identifier) {
              case "Space":
                this.__P_110_1.handleSelectKeyDown(this.__P_110_3, evt);
              ...
              case "Home":
                this.setFocusedCell(this.__P_110_2, 0, true);
                break;

              case "End":
                var rowCount = this.getTableModel().getRowCount();
                this.setFocusedCell(this.__P_110_2, rowCount - 1, true);
                break;
        ...
        if (oldFocusedRow != this.__P_110_3 && this.getRowFocusChangeModifiesSelection()) {
          // The focus moved -> Let the selection manager handle this event
          this.__P_110_1.handleMoveKeyDown(this.__P_110_3, evt);
        }
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        if (this.__P_110_8 != null && data.col != null && data.visible != null) {
          this.__P_110_8[data.col].setColumnVisible(data.visible);
        }
      ...
      setFocusedCell: function setFocusedCell(col, row, scrollVisible) {
        if (!this.isEditing() && (col != this.__P_110_2 || row != this.__P_110_3)) {
          if (col === null) {
            col = 0;
          }
      ...
      moveFocusedCell: function moveFocusedCell(deltaX, deltaY) {
        var col = this.__P_110_2;
        var row = this.__P_110_3; // could also be undefined [BUG #4676]
      ...
      isEditing: function isEditing() {
        if (this.__P_110_2 != null) {
          var x = this.getTableColumnModel().getVisibleX(this.__P_110_2);
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_110_11 == null) {
              this.__P_110_11 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_110_12 = qx.event.Timer.once(function () {
                // reset the last visible state of the vertical scroll bar
                // in a timeout to prevent infinite loops.
                this.__P_110_11 = null;
                this.__P_110_12 = null;
              }, this, 0);
            }
          }
          ...
          if (isLast && verNeeded != this.__P_110_11) {
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__P_110_4[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_110_1", "__P_110_0", "__P_110_10", "__P_110_10", "__P_110_9", "__P_110_12");

      this._disposeMap("__P_110_8");
    }
  });
  qx.ui.table.Table.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Table.js.map?dt=1593592739141