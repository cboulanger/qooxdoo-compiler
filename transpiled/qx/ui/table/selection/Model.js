    ...
    */
    members: {
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_172_0.length == 0;
      },
      ...
      getSelectedCount: function getSelectedCount() {
        ...
        for (var i = 0; i < this.__P_172_0.length; i++) {
          var range = this.__P_172_0[i];
      ...
      getSelectedRanges: function getSelectedRanges() {
        ...
        for (var i = 0; i < this.__P_172_0.length; i++) {
          retVal.push({
            minIndex: this.__P_172_0[i].minIndex,
            maxIndex: this.__P_172_0[i].maxIndex
          });
        }
      ...
      iterateSelection: function iterateSelection(iterator, object) {
        for (var i = 0; i < this.__P_172_0.length; i++) {
          for (var j = this.__P_172_0[i].minIndex; j <= this.__P_172_0[i].maxIndex; j++) {
      ...
      removeSelectionInterval: function removeSelectionInterval(fromIndex, toIndex, rowsRemoved) {
        this.__P_172_1 = fromIndex;
        this.__P_172_2 = toIndex;
      ...
      _addSelectionInterval: function _addSelectionInterval(fromIndex, toIndex) {
        ...
        for (; newRangeIndex < this.__P_172_0.length; newRangeIndex++) {
          var range = this.__P_172_0[newRangeIndex];
        ...
        this.__P_172_0.splice(newRangeIndex, 0, {
          minIndex: minIndex,
          maxIndex: maxIndex
        }); // Merge overlapping ranges


        var lastRange = this.__P_172_0[0];

        for (var i = 1; i < this.__P_172_0.length; i++) {
          var range = this.__P_172_0[i];
          ...
          if (lastRange.maxIndex + 1 >= range.minIndex) {
            ...
            this.__P_172_0.splice(i, 1); // Check this index another time
...
//# sourceMappingURL=Model.js.map?dt=1593552905301