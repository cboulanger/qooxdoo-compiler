  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Simple", {
    ...
    construct: function construct() {
      ...
      this._rowArr = [];
      this.__P_108_0 = -1; // Array of objects, each with property "ascending" and "descending"
    ...
    members: {
      ...
      setColumnEditable: function setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__P_108_2 == null) {
            this.__P_108_2 = [];
          }

          this.__P_108_2[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable: function isColumnEditable(columnIndex) {
        return this.__P_108_2 ? this.__P_108_2[columnIndex] == true : false;
      },
      ...
      setColumnSortable: function setColumnSortable(columnIndex, sortable) {
        if (sortable != this.isColumnSortable(columnIndex)) {
          if (this.__P_108_3 == null) {
            this.__P_108_3 = [];
          }

          this.__P_108_3[columnIndex] = sortable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnSortable: function isColumnSortable(columnIndex) {
        return this.__P_108_3 ? this.__P_108_3[columnIndex] !== false : true;
      },
      // overridden
      sortByColumn: function sortByColumn(columnIndex, ascending) {
        ...
        var comparator;
        var sortMethods = this.__P_108_1[columnIndex];
        ...
        this.__P_108_0 = columnIndex;
        this.__P_108_4 = ascending;
        var data = {
      ...
      setSortMethods: function setSortMethods(columnIndex, compare) {
        ...
        this.__P_108_1[columnIndex] = methods;
      },
      ...
      getSortMethods: function getSortMethods(columnIndex) {
        return this.__P_108_1[columnIndex];
      },
    ...
    destruct: function destruct() {
      this._rowArr = this.__P_108_2 = this.__P_108_1 = this.__P_108_3 = null;
    }
  });
  qx.ui.table.model.Simple.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Simple.js.map?dt=1595486329118