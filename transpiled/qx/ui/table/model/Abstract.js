  ...
  qx.Class.define("qx.ui.table.model.Abstract", {
    ...
    members: {
      ...
      setColumnIds: function setColumnIds(columnIdArr) {
        this.__P_166_0 = columnIdArr; // Create the reverse map

        this.__P_166_2 = {};

        for (var i = 0; i < columnIdArr.length; i++) {
          this.__P_166_2[columnIdArr[i]] = i;
        }

        this.__P_166_1 = new Array(columnIdArr.length); // Inform the listeners
      ...
      setColumnNamesByIndex: function setColumnNamesByIndex(columnNameArr) {
        if (this.__P_166_0.length != columnNameArr.length) {
          throw new Error("this.__columnIdArr and columnNameArr have different length: " + this.__P_166_0.length + " != " + columnNameArr.length);
        }

        this.__P_166_1 = columnNameArr; // Inform the listeners
      ...
      setColumnNamesById: function setColumnNamesById(columnNameMap) {
        this.__P_166_1 = new Array(this.__P_166_0.length);

        for (var i = 0; i < this.__P_166_0.length; ++i) {
          this.__P_166_1[i] = columnNameMap[this.__P_166_0[i]];
        }
      },
      ...
      setColumns: function setColumns(columnNameArr, columnIdArr) {
        var bSetIds = this.__P_166_0.length == 0 || columnIdArr;

        if (columnIdArr == null) {
          if (this.__P_166_0.length == 0) {
            columnIdArr = columnNameArr;
          } else {
            columnIdArr = this.__P_166_0;
          }
        }
    ...
    destruct: function destruct() {
      this.__P_166_0 = this.__P_166_1 = this.__P_166_2 = null;
    }
  });
  qx.ui.table.model.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1593552904813