  ...
  qx.Class.define("qx.ui.table.columnmodel.Basic", {
    ...
    */
    members: {
      ...
      init: function init(colCount, table) {
        ...
        var headerRenderer = this.__P_167_5 || (this.__P_167_5 = new qx.ui.table.columnmodel.Basic.DEFAULT_HEADER_RENDERER());
        var dataRenderer = this.__P_167_6 || (this.__P_167_6 = new qx.ui.table.columnmodel.Basic.DEFAULT_DATA_RENDERER());
        var editorFactory = this.__P_167_7 || (this.__P_167_7 = new qx.ui.table.columnmodel.Basic.DEFAULT_EDITOR_FACTORY());
        this.__P_167_0 = [];
        this.__P_167_1 = []; // Get the initially hidden column array, if one was provided. Older
        ...
        for (var col = 0; col < colCount; col++) {
          ...
          this.__P_167_0[col] = col;
          this.__P_167_1[col] = col;
        }

        this.__P_167_3 = null; // If any columns are initially hidden, hide them now. Make it an
      ...
      getVisibleColumns: function getVisibleColumns() {
        return this.__P_167_1 != null ? this.__P_167_1 : [];
      },
      ...
      setColumnWidth: function setColumnWidth(col, width, isPointerAction) {
        var oldWidth = this.__P_167_4[col].width;

        if (oldWidth != width) {
          this.__P_167_4[col].width = width;
          var data = {
            col: col,
            newWidth: width,
            oldWidth: oldWidth,
      ...
      getColumnWidth: function getColumnWidth(col) {
        return this.__P_167_4[col].width;
      },
      ...
      setHeaderCellRenderer: function setHeaderCellRenderer(col, renderer) {
        var oldRenderer = this.__P_167_4[col].headerRenderer;

        if (oldRenderer !== this.__P_167_5) {
          oldRenderer.dispose();
        }

        this.__P_167_4[col].headerRenderer = renderer;
      ...
      setHeaderCellRenderers: function setHeaderCellRenderers(renderers) {
        ...
        this.__P_167_2 = true; // For each listed column...
        ...
        this.__P_167_2 = false; // Now we can fire the event once. The data indicates which columns
      ...
      getHeaderCellRenderer: function getHeaderCellRenderer(col) {
        return this.__P_167_4[col].headerRenderer;
      },
      ...
      setDataCellRenderer: function setDataCellRenderer(col, renderer) {
        var oldRenderer = this.__P_167_4[col].dataRenderer;
        this.__P_167_4[col].dataRenderer = renderer;

        if (oldRenderer !== this.__P_167_6) {
          return oldRenderer;
        }
      ...
      getDataCellRenderer: function getDataCellRenderer(col) {
        return this.__P_167_4[col].dataRenderer;
      },
      ...
      setCellEditorFactory: function setCellEditorFactory(col, factory) {
        var oldFactory = this.__P_167_4[col].editorFactory;

        if (oldFactory === factory) {
          return;
        }

        if (oldFactory !== this.__P_167_7) {
          oldFactory.dispose();
        }

        this.__P_167_4[col].editorFactory = factory;
      },
      ...
      getCellEditorFactory: function getCellEditorFactory(col) {
        return this.__P_167_4[col].editorFactory;
      },
      ...
      _getColToXPosMap: function _getColToXPosMap() {
        if (this.__P_167_3 == null) {
          this.__P_167_3 = {};

          for (var overX = 0; overX < this.__P_167_0.length; overX++) {
            var col = this.__P_167_0[overX];
            this.__P_167_3[col] = {
              overX: overX
            };
          }

          for (var visX = 0; visX < this.__P_167_1.length; visX++) {
            var col = this.__P_167_1[visX];
            this.__P_167_3[col].visX = visX;
          }
        }
      ...
      getVisibleColumnCount: function getVisibleColumnCount() {
        return this.__P_167_1 != null ? this.__P_167_1.length : 0;
      },
      ...
      getOverallColumnAtX: function getOverallColumnAtX(overXPos) {
        return this.__P_167_0[overXPos];
      },
      ...
      setColumnVisible: function setColumnVisible(col, visible) {
        if (visible != this.isColumnVisible(col)) {
          if (visible) {
            ...
            for (var x = overX + 1; x < this.__P_167_0.length; x++) {
              var currCol = this.__P_167_0[x];
            ...
            if (nextVisX == null) {
              nextVisX = this.__P_167_1.length;
            } // Add the column to the visible columns


            this.__P_167_1.splice(nextVisX, 0, col);
          } else {
            var visX = this.getVisibleX(col);

            this.__P_167_1.splice(visX, 1);
          } // Invalidate the __colToXPosMap


          this.__P_167_3 = null; // Inform the listeners
      ...
      moveColumn: function moveColumn(fromOverXPos, toOverXPos) {
        this.__P_167_2 = true;
        var col = this.__P_167_0[fromOverXPos];
        ...
        this.__P_167_0.splice(fromOverXPos, 1);

        this.__P_167_0.splice(toOverXPos, 0, col); // Invalidate the __colToXPosMap
        ...
        this.__P_167_2 = false; // Inform the listeners
      ...
      setColumnsOrder: function setColumnsOrder(newPositions) {
        if (newPositions.length == this.__P_167_0.length) {
          this.__P_167_2 = true; // Go through each column an switch visible ones to invisible. Reason is unknown,
          ...
          for (var colIdx = 0; colIdx < this.__P_167_0.length; colIdx++) {
          ...
          this.__P_167_0 = qx.lang.Array.clone(newPositions); // Invalidate the __colToXPosMap

          this.__P_167_3 = null; // Go through each column an switch invisible ones back to visible
          ...
          this.__P_167_2 = false; // Inform the listeners. Do not add data as all known listeners in qooxdoo
          ...
          throw new Error("setColumnsOrder: Invalid number of column positions given, expected " + this.__P_167_0.length + ", got " + newPositions.length);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      for (var i = 0; i < this.__P_167_4.length; i++) {
        this.__P_167_4[i].headerRenderer.dispose();

        this.__P_167_4[i].dataRenderer.dispose();

        this.__P_167_4[i].editorFactory.dispose();
      }

      this.__P_167_0 = this.__P_167_1 = this.__P_167_4 = this.__P_167_3 = null;

      this._disposeObjects("__P_167_5", "__P_167_6", "__P_167_7");
    }
  });
  qx.ui.table.columnmodel.Basic.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Basic.js.map?dt=1593592748784