  ...
  qx.Class.define("qx.ui.table.columnmodel.Resize", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_109_0 = false; // Track when the table has appeared.  We want to ignore resize events
    ...
    */
    members: {
      ...
      init: function init(numColumns, table) {
        ...
        if (this.__P_109_2 == null) {
          this.__P_109_2 = table; // We'll do our column resizing when the table appears, ...
      ...
      _onappear: function _onappear(event) {
        ...
        this.__P_109_2._updateScrollerWidths();

        this.__P_109_2._updateScrollBarVisibility();
      ...
      _onTableWidthChanged: function _onTableWidthChanged(event) {
        ...
        if (this.__P_109_0 || !this.__P_109_1) {
          // Yup.  Ignore it.
          return;
        }
      ...
      _onverticalscrollbarchanged: function _onverticalscrollbarchanged(event) {
        ...
        qx.event.Timer.once(function () {
          if (this.__P_109_2 && !this.__P_109_2.isDisposed()) {
            this.__P_109_2._updateScrollerWidths();
...
//# sourceMappingURL=Resize.js.map?dt=1596533204180