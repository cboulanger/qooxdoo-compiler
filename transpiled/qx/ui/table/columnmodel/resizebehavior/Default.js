  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.columnmodel.resizebehavior.Default", {
    ...
    construct: function construct() {
      ...
      this.__P_168_0 = []; // This layout is not connected to a widget but to this class. This class
      ...
      this.__P_168_1 = new qx.ui.layout.HBox();

      this.__P_168_1.connectToWidget(this);

      this.__P_168_2 = new qx.util.DeferredCall(this._computeColumnsFlexWidth, this);
    },
    ...
    */
    members: {
      ...
      setWidth: function setWidth(col, width, flex) {
        ...
        if (col >= this.__P_168_0.length) {
          throw new Error("Column number out of range");
        } // Set the new width


        this.__P_168_0[col].setColumnWidth(width, flex);

        this.__P_168_2.schedule();
      },
      ...
      setMinWidth: function setMinWidth(col, width) {
        ...
        this.__P_168_0[col].setMinWidth(width);
      ...
      setMaxWidth: function setMaxWidth(col, width) {
        ...
        this.__P_168_0[col].setMaxWidth(width);
      ...
      onAppear: function onAppear(event, forceRefresh) {
        ...
        if (forceRefresh === true || !this.__P_168_4 || this.getInitializeWidthsOnEveryAppear()) {
      ...
      _setNumColumns: function _setNumColumns(numColumns) {
        var colData = this.__P_168_0; // Are there now fewer (or the same number of) columns than there were
        // previously?
      ...
      _computeColumnsFlexWidth: function _computeColumnsFlexWidth() {
        ...
        this.__P_168_3 = columns;

        this.__P_168_5(); // Use a horizontal box layout to determine the available width.


        this.__P_168_1.renderLayout(width, 100, {
          top: 0,
          right: 0,
          bottom: 0,
          left: 0
      ...
      __P_168_5: function __P_168_5() {
        this.__P_168_1.invalidateChildrenCache();

        var children = this.__P_168_3;
    ...
    */
    destruct: function destruct() {
      this.__P_168_0 = this.__P_168_3 = null;

      this._disposeObjects("__P_168_1", "__P_168_2");
    }
  });
  qx.ui.table.columnmodel.resizebehavior.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1593587987252