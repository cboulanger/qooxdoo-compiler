  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_44_4: function __P_44_4() {
        var children = this._getLayoutChildren();

        var length = children.length;
        var enableFlex = false;
        var reuse = this.__P_44_0 && this.__P_44_0.length != length && this.__P_44_1 && this.__P_44_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var heights = reuse ? this.__P_44_0 : new Array(length);
        var flexs = reuse ? this.__P_44_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__P_44_0 = heights;
          this.__P_44_1 = flexs;
        }

        this.__P_44_2 = enableFlex;
        this.__P_44_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_44_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;

          for (i = 0; i < length; i += 1) {
            flex = this.__P_44_1[i];
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        var children = this.__P_44_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_44_1[i];
          var percent = this.__P_44_0[i];
    ...
    */
    destruct: function destruct() {
      this.__P_44_0 = this.__P_44_1 = this.__P_44_3 = null;
    }
  });
  qx.ui.layout.VBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox.js.map?dt=1593587968306