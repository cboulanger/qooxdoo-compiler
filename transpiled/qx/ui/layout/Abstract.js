    ...
    members: {
      ...
      */
      ...
      getSizeHint: function getSizeHint() {
        ...
        return this.__P_105_0 = this._computeSizeHint();
      },
      ...
      _renderSeparator: function _renderSeparator(separator, bounds) {
        this.__P_105_1.renderSeparator(separator, bounds);
      },
      ...
      _applyLayoutChange: function _applyLayoutChange() {
        if (this.__P_105_1) {
          this.__P_105_1.scheduleLayoutUpdate();
        }
      },
      ...
      _getLayoutChildren: function _getLayoutChildren() {
        return this.__P_105_1.getLayoutChildren();
      }
    },
...
//# sourceMappingURL=Abstract.js.map?dt=1595486328411