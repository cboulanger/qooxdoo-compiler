  ...
  qx.Class.define("qx.ui.layout.Grid", {
    ...
    */
    members: {
      ...
      __P_107_9: function __P_107_9() {
        ...
        this.__P_107_2 = grid;
        this.__P_107_3 = colSpans;
        this.__P_107_4 = rowSpans;
        this.__P_107_5 = maxRowIndex;
        this.__P_107_6 = maxColIndex;
        this.__P_107_7 = null;
        this.__P_107_8 = null; // Clear invalidation marker
      ...
      _setRowData: function _setRowData(row, key, value) {
        var rowData = this.__P_107_0[row];

        if (!rowData) {
          this.__P_107_0[row] = {};
          this.__P_107_0[row][key] = value;
        } else {
          rowData[key] = value;
        }
      },
      ...
      _setColumnData: function _setColumnData(column, key, value) {
        var colData = this.__P_107_1[column];

        if (!colData) {
          this.__P_107_1[column] = {};
          this.__P_107_1[column][key] = value;
        } else {
          colData[key] = value;
        }
      },
      ...
      getCellAlign: function getCellAlign(row, column) {
        ...
        var rowData = this.__P_107_0[row];
        var colData = this.__P_107_1[column];
        var widget = this.__P_107_2[row][column];
      ...
      _fixHeightsRowSpan: function _fixHeightsRowSpan(rowHeights) {
        ...
        for (var i = 0, l = this.__P_107_4.length; i < l; i++) {
          var widget = this.__P_107_4[i];
      ...
      _getRowHeights: function _getRowHeights() {
        if (this.__P_107_7 != null) {
          return this.__P_107_7;
        }

        var rowHeights = [];
        var maxRowIndex = this.__P_107_5;
        var maxColIndex = this.__P_107_6;
        ...
        for (var row = 0; row <= maxRowIndex; row++) {
          ...
          for (var col = 0; col <= maxColIndex; col++) {
            var widget = this.__P_107_2[row][col];
        ...
        if (this.__P_107_4.length > 0) {
          this._fixHeightsRowSpan(rowHeights);
        }

        this.__P_107_7 = rowHeights;
        return rowHeights;
      },
      ...
      _getColWidths: function _getColWidths() {
        if (this.__P_107_8 != null) {
          return this.__P_107_8;
        }
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        for (var col = 0; col <= maxColIndex; col++) {
          ...
          for (var row = 0; row <= maxRowIndex; row++) {
            var widget = this.__P_107_2[row][col]; // ignore empty cells
    ...
    */
    destruct: function destruct() {
      this.__P_107_2 = this.__P_107_0 = this.__P_107_1 = this.__P_107_3 = this.__P_107_4 = this.__P_107_8 = this.__P_107_7 = null;
    }
  });
  qx.ui.layout.Grid.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Grid.js.map?dt=1593587978330