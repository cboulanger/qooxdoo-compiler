  ...
  qx.Class.define("qx.ui.layout.HBox", {
    ...
    members: {
      ...
      */
      ...
      __P_54_4: function __P_54_4() {
        ...
        var reuse = this.__P_54_0 && this.__P_54_0.length != length && this.__P_54_1 && this.__P_54_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var widths = reuse ? this.__P_54_0 : new Array(length);
        var flexs = reuse ? this.__P_54_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__P_54_0 = widths;
          this.__P_54_1 = flexs;
        }

        this.__P_54_2 = enableFlex;
        this.__P_54_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_54_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;

          for (i = 0; i < length; i += 1) {
            flex = this.__P_54_1[i];
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        var children = this.__P_54_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_54_1[i];
          var percent = this.__P_54_0[i];
    ...
    */
    destruct: function destruct() {
      this.__P_54_0 = this.__P_54_1 = this.__P_54_3 = null;
    }
  });
  qx.ui.layout.HBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HBox.js.map?dt=1593592728847