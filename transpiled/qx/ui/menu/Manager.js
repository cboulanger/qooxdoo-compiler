  ...
  qx.Class.define("qx.ui.menu.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_119_1 = new qx.event.Timer();

      this.__P_119_1.addListener("interval", this._onOpenInterval, this); // Create close timer


      this.__P_119_2 = new qx.event.Timer();

      this.__P_119_2.addListener("interval", this._onCloseInterval, this);
    },
    ...
    members: {
      ...
      */
      ...
      scheduleClose: function scheduleClose(menu) {
        ...
        if (!menu.isVisible()) {
          ...
          if (this.__P_119_4) {
            this.cancelClose(this.__P_119_4);
          }
        } // When the menu is visible and not scheduled already
        // then schedule it for closing
        else if (this.__P_119_4 != menu) {
            // menu.debug("Schedule close");
            this.__P_119_4 = menu;

            this.__P_119_2.restartWith(menu.getCloseInterval());
          }
      },
      ...
      */
      ...
      _onOpenInterval: function _onOpenInterval(e) {
        // Stop timer
        this.__P_119_1.stop(); // Open menu and reset flag
      ...
      _onCloseInterval: function _onCloseInterval(e) {
        ...
        this.__P_119_2.stop(); // Close menu and reset flag


        this.__P_119_4.exclude();
      ...
      */
      ...
      preventContextMenuOnce: function preventContextMenuOnce() {
        qx.event.Registration.addListener(document.body, "contextmenu", this.__P_119_5, this, true);
      },
       ...
       * @internal
       */
      __P_119_5: function __P_119_5(e) {
        ...
        qx.event.Registration.removeListener(document.body, "contextmenu", this.__P_119_5, this, true);
      },
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__P_119_0.length > 0 && !this._isInMenu(target)) {
          this.hideAll();
        }
      },
      ...
      */
      ...
      _onKeyUpDown: function _onKeyUpDown(e) {
        ...
        if (this.__P_119_7[iden] || this.__P_119_6[iden] && menu.getSelectedButton()) {
          e.stopPropagation();
        }
      },
      ...
      _onKeyPress: function _onKeyPress(e) {
        ...
        var iden = e.getKeyIdentifier();
        var navigation = this.__P_119_7[iden];
        var selection = this.__P_119_6[iden];
      ...
      _onRoll: function _onRoll(e) {
        ...
        if (this.__P_119_0.length > 0 && !this._isInMenu(target) && !this._isMenuOpener(target) && !e.getMomentum()) {
          this.hideAll();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_119_1", "__P_119_2");
...
//# sourceMappingURL=Manager.js.map?dt=1593592740375