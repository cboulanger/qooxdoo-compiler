    ...
    members: {
      ...
      */
      ...
      setLayoutParent: function setLayoutParent(parent) {
        ...
        if (oldParent && this.__P_209_3) {
          oldParent.removeListenerById(this.__P_209_3);
          this.__P_209_3 = null;
        } // Call the superclass
        ...
        if (parent && this.getCenterOnContainerResize()) {
          this.__P_209_3 = parent.addListener("resize", this.center, this);
        }
      },
      // overridden
      ...
      */
      ...
      maximize: function maximize() {
        ...
        if (parent != null && parent.supportsMaximize()) {
          if (this.fireNonBubblingEvent("beforeMaximize", qx.event.type.Event, [false, true])) {
            ...
            this.__P_209_1 = props.left === undefined ? 0 : props.left;
            this.__P_209_0 = props.top === undefined ? 0 : props.top; // Update layout properties
      ...
      minimize: function minimize() {
        ...
        if (this.fireNonBubblingEvent("beforeMinimize", qx.event.type.Event, [false, true])) {
          ...
          var props = this.getLayoutProperties();
          this.__P_209_1 = props.left === undefined ? 0 : props.left;
          this.__P_209_0 = props.top === undefined ? 0 : props.top;
      ...
      restore: function restore() {
        ...
        if (this.fireNonBubblingEvent("beforeRestore", qx.event.type.Event, [false, true])) {
          ...
          var left = this.__P_209_1;
          var top = this.__P_209_0;
          this.setLayoutProperties({
            edge: null,
            left: left,
            top: top
      ...
      */
      ...
      _applyCenterOnAppear: function _applyCenterOnAppear(value, old) {
        ...
        if (value) {
          this.__P_209_2 = this.addListener("appear", this.center, this);
        }
      },
      _applyCenterOnContainerResize: function _applyCenterOnContainerResize(value, old) {
        ...
        if (this.__P_209_3 !== null) {
          parent.removeListenerById(this.__P_209_3);
          this.__P_209_3 = null;
...
//# sourceMappingURL=Window.js.map?dt=1593587992817