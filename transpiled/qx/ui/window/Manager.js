  ...
  qx.Class.define("qx.ui.window.Manager", {
    ...
    */
    members: {
      ...
      syncWidget: function syncWidget() {
        this.__P_229_0.forceUnblock();

        var windows = this.__P_229_0.getWindows(); // z-index for all three window kinds
        ...
        for (var i = 0, l = windows.length; i < l; i++) {
          ...
          if (win.isModal()) {
            ...
            this.__P_229_0.blockContent(zIndexModal - 1);
        ...
        this.__P_229_0.setActiveWindow(active);
      },
      // interface implementation
      bringToFront: function bringToFront(win) {
        var windows = this.__P_229_0.getWindows();
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_229_0");
    }
  });
  qx.ui.window.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1593552915382