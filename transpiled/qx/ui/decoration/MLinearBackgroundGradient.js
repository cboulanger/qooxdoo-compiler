  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient: function _styleLinearBackgroundGradient(styles) {
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__P_140_4(startColors[i]);

            var endColor = this.__P_140_4(endColors[i]);
       ...
       */
      __P_140_1: function __P_140_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_140_2: function me(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        if (!me.__P_140_5) {
          me.__P_140_5 = document.createElement("canvas");
        }
        ...
        me.__P_140_5.width = width;
        me.__P_140_5.height = height;

        var ctx = me.__P_140_5.getContext('2d');
        ...
        backgroundStyle.push("url(" + me.__P_140_5.toDataURL() + ") " + size);
        return true;
      },
       ...
       */
      __P_140_3: function __P_140_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_140_0: function __P_140_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       */
      __P_140_4: function __P_140_4(color) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map?dt=1593594361184