  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__P_103_5(); // Bind target and livupdate to placeToWidget


          this.__P_103_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_103_2); // Remove the listener when the element disappears.

          this.__P_103_4 = function () {
            this.__P_103_5();
          };

          this.addListener("disappear", this.__P_103_4, this);
        }
      ...
      __P_103_5: function __P_103_5() {
        if (this.__P_103_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_103_2);
          this.__P_103_2 = null;
        }

        if (this.__P_103_4) {
          this.removeListener("disappear", this.__P_103_4, this);
          this.__P_103_4 = null;
        }
      },
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_103_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_103_2); // Remove the listener when the element disappears.
       ...
       *    first argument
       */
      __P_103_6: function __P_103_6(callback) {
        var size = null;
...
//# sourceMappingURL=MPlacement.js.map?dt=1595486328254