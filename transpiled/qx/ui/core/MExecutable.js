    ...
    */
    members: {
      ...
      _applyCommand: function _applyCommand(value, old) {
        // execute forwarding
        if (old != null) {
          old.removeListenerById(this.__P_165_2);
        }

        if (value != null) {
          this.__P_165_2 = value.addListener("execute", this.__P_165_3, this);
        } // binding stuff


        var ids = this.__P_165_0;
...
//# sourceMappingURL=MExecutable.js.map?dt=1596533213914