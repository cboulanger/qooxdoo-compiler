  ...
  qx.Mixin.define("qx.ui.core.MBlocker", {
    ...
    members: {
      ...
      isBlocked: function isBlocked() {
        return this.__P_132_0 && this.__P_132_0.isBlocked();
      },
      ...
      getBlocker: function getBlocker() {
        if (!this.__P_132_0) {
          this.__P_132_0 = this._createBlocker();
        }

        return this.__P_132_0;
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_132_0");
    }
  });
  qx.ui.core.MBlocker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MBlocker.js.map?dt=1593587982584