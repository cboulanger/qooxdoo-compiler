  ...
  qx.Mixin.define("qx.ui.core.MResizable", {
    ...
    */
    construct: function construct() {
      ...
      content.addListener("pointerdown", this.__P_227_0, this, true);
      content.addListener("pointerup", this.__P_227_1, this);
      content.addListener("pointermove", this.__P_227_2, this);
      content.addListener("pointerout", this.__P_227_3, this);
      content.addListener("losecapture", this.__P_227_4, this); // Get a reference of the drag and drop handler
      ...
      this.__P_227_5 = qx.event.Registration.getManager(domElement).getHandler(qx.event.handler.DragDrop);
    },
    ...
    members: {
      ...
      */
      ...
      _getResizeFrame: function _getResizeFrame() {
        var frame = this.__P_227_6;

        if (!frame) {
          frame = this.__P_227_6 = new qx.ui.core.Widget();
       ...
       */
      __P_227_12: function __P_227_12() {
      ...
      */
       ...
       */
      __P_227_13: function __P_227_13(e) {
        // Detect mode
        var resizeActive = this.__P_227_7; // Read size hint

        var hint = this.getSizeHint();
        var range = this.__P_227_11; // Read original values

        var start = this.__P_227_10;
        ...
        if (resizeActive & this.RESIZE_TOP || resizeActive & this.RESIZE_BOTTOM) {
          diff = Math.max(range.top, Math.min(range.bottom, e.getDocumentTop())) - this.__P_227_9;
        ...
        if (resizeActive & this.RESIZE_LEFT || resizeActive & this.RESIZE_RIGHT) {
          diff = Math.max(range.left, Math.min(range.right, e.getDocumentLeft())) - this.__P_227_8;
       ...
       * @param e {qx.event.type.Pointer} Last pointer event
       */
      __P_227_15: function __P_227_15(e) {
        var location = this.getContentLocation();
        var pointerTolerance = this.getResizeSensitivity();
        var pointerLeft = e.getDocumentLeft();
        var pointerTop = e.getDocumentTop();

        var resizeActive = this.__P_227_16(location, pointerLeft, pointerTop, pointerTolerance); // check again in case we have a corner [BUG #1200]


        if (resizeActive > 0) {
          // this is really a | (or)!
          resizeActive = resizeActive | this.__P_227_16(location, pointerLeft, pointerTop, pointerTolerance * 2);
        }

        this.__P_227_7 = resizeActive;
      },
       ...
       */
      __P_227_16: function __P_227_16(location, pointerLeft, pointerTop, pointerTolerance) {
      ...
      */
      ...
      __P_227_0: function __P_227_0(e) {
        ...
        if (!this.__P_227_7 || !this.getEnabled() || e.getPointerType() == "touch") {
          return;
        } // Add resize state
        ...
        this.__P_227_8 = e.getDocumentLeft();
        this.__P_227_9 = e.getDocumentTop(); // Cache bounds
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __P_227_1: function __P_227_1(e) {
        // Check for active resize
        ...
        var bounds = this.__P_227_13(e); // Sync with widget
        ...
        this.__P_227_7 = 0; // Remove resize state
       ...
       */
      __P_227_4: function __P_227_4(e) {
        // Check for active resize
        if (!this.__P_227_7) {
          return;
        } // Reset cursor
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __P_227_2: function __P_227_2(e) {
        if (!this.getEnabled() || e.getPointerType() == "touch") {
          return;
        }

        if (this.hasState("resize")) {
          var bounds = this.__P_227_13(e); // Update widget
          ...
          e.stopPropagation();
        } else if (!this.hasState("maximized") && !this.__P_227_5.isSessionActive()) {
          this.__P_227_15(e);

          var resizeActive = this.__P_227_7;
          var root = this.getApplicationRoot();

          if (resizeActive) {
            var cursor = this.__P_227_14[resizeActive];
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __P_227_3: function __P_227_3(e) {
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__P_227_6 != null && !qx.core.ObjectRegistry.inShutDown) {
        this.__P_227_6.destroy();
...
//# sourceMappingURL=MResizable.js.map?dt=1596533224756