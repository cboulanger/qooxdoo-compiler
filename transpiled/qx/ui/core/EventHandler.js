  ...
  qx.Class.define("qx.ui.core.EventHandler", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_24_0 = qx.event.Registration.getManager(window);
    },
    ...
    */
    members: {
      ...
      _dispatchEvent: function _dispatchEvent(domEvent) {
        ...
        if (this.__P_24_1[domEvent.getType()]) {
        ...
        if (!currentWidget || !(currentWidget.isEnabled() || this.__P_24_2[type])) {
          return;
        } // PROCESS LISTENERS
        // Load listeners
        ...
        var listeners = this.__P_24_0.getListeners(currentWidget, type, capture);
        ...
        if (domEvent.getEventPhase() == qx.event.type.Event.AT_TARGET) {
          ...
          var otherListeners = this.__P_24_0.getListeners(currentWidget, type, !capture);
...
//# sourceMappingURL=EventHandler.js.map?dt=1593587966408