    ...
    members: {
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        if (this.getOrientation() === "horizontal") {
          this.__P_223_1 = hint.minWidth;
          hint.minWidth = 0;
        } else {
          this.__P_223_1 = hint.minHeight;
          hint.minHeight = 0;
        }
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (this.__P_223_1 >= (horizontal ? width : height)) {
      ...
      */
      ...
      _onResizeSlider: function _onResizeSlider(e) {
        ...
        if (this.getOrientation() == "vertical") {
          if (sliderSize.height < knobHint.minHeight + this.__P_223_0) {
            hideKnob = true;
          }
        } else {
          if (sliderSize.width < knobHint.minWidth + this.__P_223_0) {
            hideKnob = true;
          }
        }
...
//# sourceMappingURL=ScrollBar.js.map?dt=1593592757838