      ...
      */
      ...
      scrollToX: function scrollToX(value, duration) {
        ...
        if (duration) {
          ...
          this.__P_205_0 = new qx.bom.AnimationFrame();

          this.__P_205_0.on("end", function () {
            this.setScrollX(value);
            this.__P_205_0 = null;
            this.fireEvent("scrollAnimationEnd");
          }, this);

          this.__P_205_0.on("frame", function (timePassed) {
            var newX = parseInt(timePassed / duration * (value - from) + from);
            this.setScrollX(newX);
          }, this);

          this.__P_205_0.startSequence(duration);
        } else {
          this.setScrollX(value);
        }
      },
...
//# sourceMappingURL=ScrollPane.js.map?dt=1596533219537