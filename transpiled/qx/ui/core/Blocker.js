  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct: function construct(widget) {
      ...
      this._widget = widget;
      widget.addListener("resize", this.__P_118_0, this);
      widget.addListener("move", this.__P_118_0, this);
      widget.addListener("disappear", this.__P_118_1, this);
    ...
    members: {
      ...
      __P_118_1: function __P_118_1() {
        if (this.isBlocked()) {
          ...
          this._widget.addListenerOnce("appear", this.__P_118_8, this);
        }
      },
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__P_118_9("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__P_118_9("opacity", value);
      },
       ...
       */
      __P_118_9: function __P_118_9(key, value) {
        var blockers = [];
        this.__P_118_4 && blockers.push(this.__P_118_4);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__P_118_2.push(activeWidget);

        this.__P_118_3.push(focusedWidget);
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_118_3.length;

        if (focusElementsLength > 0) {
          widget = this.__P_118_3.pop();
        ...
        var activeElementsLength = this.__P_118_2.length;

        if (activeElementsLength > 0) {
          widget = this.__P_118_2.pop();
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__P_118_4) {
          this.__P_118_4 = this.__P_118_10();

          this.__P_118_4.setStyle("zIndex", 15);
          ...
          widget.getContentElement().add(this.__P_118_4);

          this.__P_118_4.exclude();
        }

        return this.__P_118_4;
      },
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_118_7) {
            this.__P_118_7 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex));
          }
        ...
        if (this.__P_118_5 < 2) {
          ...
          blocker.addListener("deactivate", this.__P_118_11, this);
          blocker.addListener("keypress", this.__P_118_12, this);
          blocker.addListener("keydown", this.__P_118_12, this);
          blocker.addListener("keyup", this.__P_118_12, this);
      ...
      unblock: function unblock() {
        if (this.__P_118_7) {
          this._widget.removeListenerById(this.__P_118_7);
       ...
       */
      __P_118_13: function __P_118_13() {
        this._restoreActiveWidget();

        var blocker = this.getBlockerElement();
        blocker.removeListener("deactivate", this.__P_118_11, this);
        blocker.removeListener("keypress", this.__P_118_12, this);
        blocker.removeListener("keydown", this.__P_118_12, this);
        blocker.removeListener("keyup", this.__P_118_12, this);
        blocker.exclude();
       ...
       */
      __P_118_12: function __P_118_12(e) {
    ...
    */
    destruct: function destruct() {
      ...
      this._widget.removeListener("resize", this.__P_118_0, this);

      this._widget.removeListener("move", this.__P_118_0, this);

      this._widget.removeListener("appear", this.__P_118_8, this);

      this._widget.removeListener("disappear", this.__P_118_1, this);

      if (this.__P_118_7) {
        this._widget.removeListenerById(this.__P_118_7);
      }

      this._disposeObjects("__P_118_4", "__P_118_6");

      this.__P_118_2 = this.__P_118_3 = this._widget = null;
    }
  });
  qx.ui.core.Blocker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Blocker.js.map?dt=1593552896355