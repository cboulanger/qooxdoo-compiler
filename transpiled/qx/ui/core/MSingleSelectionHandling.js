  ...
  qx.Mixin.define("qx.ui.core.MSingleSelectionHandling", {
    ...
    */
    members: {
      ...
      */
      ...
      setValue: function setValue(item) {
        ...
        if (item instanceof qx.ui.core.Widget) {
          this.__P_113_1().setSelected(item);
      ...
      getValue: function getValue() {
        return this.__P_113_1().getSelected() || null;
      },
      ...
      getSelection: function getSelection() {
        var selected = this.__P_113_1().getSelected();
      ...
      setSelection: function setSelection(items) {
        switch (items.length) {
          ...
          case 1:
            this.__P_113_1().setSelected(items[0]);
      ...
      isSelected: function isSelected(item) {
        return this.__P_113_1().isSelected(item);
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_113_1().isSelectionEmpty();
      },
      ...
      getSelectables: function getSelectables(all) {
        return this.__P_113_1().getSelectables(all);
      },
      ...
      */
       ...
       */
      __P_113_1: function __P_113_1() {
        if (this.__P_113_0 == null) {
          var that = this;
          this.__P_113_0 = new qx.ui.core.SingleSelectionManager({
          ...
          this.__P_113_0.addListener("changeSelected", this._onChangeSelected, this);
        }

        this.__P_113_0.setAllowEmptySelection(this._isAllowEmptySelection());
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_113_0");
    }
  });
  qx.ui.core.MSingleSelectionHandling.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MSingleSelectionHandling.js.map?dt=1593552895575