  ...
  qx.Class.define("qx.ui.core.FocusHandler", {
    ...
    */
    members: {
      ...
      connectTo: function connectTo(root) {
        ...
        root.addListener("keypress", this.__P_72_4, this);
      ...
      addRoot: function addRoot(widget) {
        ...
        this.__P_72_0[widget.toHashCode()] = widget;
      },
      ...
      removeRoot: function removeRoot(widget) {
        ...
        delete this.__P_72_0[widget.toHashCode()];
      },
      ...
      isFocusRoot: function isFocusRoot(widget) {
        return !!this.__P_72_0[widget.toHashCode()];
      },
      ...
      */
      ...
      _onActivate: function _onActivate(e) {
        ...
        this.__P_72_1 = target; //this.debug("active: " + target);

        var root = this.__P_72_5(target);

        if (root != this.__P_72_3) {
          this.__P_72_3 = root;
        }
      },
      ...
      _onFocusIn: function _onFocusIn(e) {
        ...
        if (target != this.__P_72_2) {
          this.__P_72_2 = target;
      ...
      __P_72_4: function __P_72_4(e) {
        ...
        var current = this.__P_72_2;

        if (!e.isShiftPressed()) {
          var next = current ? this.__P_72_6(current) : this.__P_72_7();
        } else {
          var next = current ? this.__P_72_8(current) : this.__P_72_9();
      ...
      */
       ...
       */
      __P_72_5: function __P_72_5(widget) {
        var roots = this.__P_72_0;
      ...
      */
       ...
       */
      __P_72_10: function __P_72_10(widget1, widget2) {
        if (widget1 === widget2) {
          return 0;
       ...
       *    the current root.
       */
      __P_72_7: function __P_72_7() {
        return this.__P_72_11(this.__P_72_3, null);
      },
       ...
       *    the current root.
       */
      __P_72_9: function __P_72_9() {
        return this.__P_72_12(this.__P_72_3, null);
      },
       ...
       */
      __P_72_6: function __P_72_6(widget) {
        var root = this.__P_72_3;

        if (root == widget) {
          return this.__P_72_7();
        }
        ...
        this.__P_72_13(root, widget, result);

        result.sort(this.__P_72_10);
        var len = result.length;
        return len > 0 ? result[0] : this.__P_72_7();
      },
       ...
       * @return {qx.ui.core.Widget} The found widget.
       */
      __P_72_8: function __P_72_8(widget) {
        var root = this.__P_72_3;

        if (root == widget) {
          return this.__P_72_9();
        }
        ...
        this.__P_72_14(root, widget, result);

        result.sort(this.__P_72_10);
        var len = result.length;
        return len > 0 ? result[len - 1] : this.__P_72_9();
      },
      ...
      */
       ...
       */
      __P_72_13: function __P_72_13(parent, widget, result) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable() && this.__P_72_10(widget, child) < 0) {
              result.push(child);
            }

            this.__P_72_13(child, widget, result);
          }
        }
      },
       ...
       * @param result {Array} Result list
       */
      __P_72_14: function __P_72_14(parent, widget, result) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            ...
            this.__P_72_14(child, widget, result);
          }
        }
      },
       ...
       */
      __P_72_11: function __P_72_11(parent, firstWidget) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (firstWidget == null || this.__P_72_10(child, firstWidget) < 0) {
                firstWidget = child;
              }
            } // Deep iteration into children hierarchy


            firstWidget = this.__P_72_11(child, firstWidget);
          }
        }
       ...
       */
      __P_72_12: function __P_72_12(parent, lastWidget) {
        var children = parent.getLayoutChildren();
        var child;
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (lastWidget == null || this.__P_72_10(child, lastWidget) > 0) {
                lastWidget = child;
              }
            } // Deep iteration into children hierarchy


            lastWidget = this.__P_72_12(child, lastWidget);
          }
        }
    ...
    */
    destruct: function destruct() {
      this._disposeMap("__P_72_0");

      this.__P_72_2 = this.__P_72_1 = this.__P_72_3 = null;
    }
  });
  qx.ui.core.FocusHandler.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FocusHandler.js.map?dt=1593594349121