  ...
  qx.Class.define("qx.ui.core.SingleSelectionManager", {
    ...
    */
    ...
    construct: function construct(selectionProvider) {
      ...
      this.__P_181_0 = selectionProvider;
    },
    ...
    */
    members: {
      ...
      */
      ...
      getSelectables: function getSelectables(all) {
        var items = this.__P_181_0.getItems();

        var result = [];

        for (var i = 0; i < items.length; i++) {
          if (this.__P_181_0.isItemSelectable(items[i])) {
            result.push(items[i]);
          }
      ...
      */
      // apply method
      __P_181_1: function __P_181_1(value, old) {
        if (!value) {
          this.__P_181_4(this.__P_181_2);
        }
      },
      ...
      */
       ...
       */
      __P_181_4: function __P_181_4(item) {
        var oldSelected = this.__P_181_2;
       ...
       *    <code>false</code> otherwise.
       */
      __P_181_3: function __P_181_3(item) {
        var items = this.__P_181_0.getItems();
    ...
    destruct: function destruct() {
      if (this.__P_181_0.toHashCode) {
        this._disposeObjects("__P_181_0");
      } else {
        this.__P_181_0 = null;
      }

      this._disposeObjects("__P_181_2");
    }
  });
  qx.ui.core.SingleSelectionManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SingleSelectionManager.js.map?dt=1593587988424