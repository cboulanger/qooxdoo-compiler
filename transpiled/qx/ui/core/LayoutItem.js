  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    members: {
      ...
      */
      ...
      getBounds: function getBounds() {
        return this.__P_26_5 || this.__P_26_1 || null;
      },
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        var computed = this.__P_26_1;

        if (!computed) {
          computed = this.__P_26_1 = {};
        } // Detect changes
        ...
        if (this.__P_26_2) {
          changes.local = true;
          delete this.__P_26_2;
        }

        if (this.__P_26_4) {
          changes.margin = true;
          delete this.__P_26_4;
        }
        /*
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__P_26_0) {
            // This variable is used in the next computation of the size hint
            this.__P_26_0 = flowHeight; // Re-add to layout queue
      ...
      getSizeHint: function getSizeHint(compute) {
        ...
        hint = this.__P_26_3 = this._computeSizeHint(); // Respect height for width

        if (this._hasHeightForWidth() && this.__P_26_0 && this.getHeight() == null) {
          hint.height = this.__P_26_0;
        } // normalize width
      ...
      */
      ...
      setLayoutProperties: function setLayoutProperties(props) {
        ...
        var storage = this.__P_26_6;

        if (!storage) {
          storage = this.__P_26_6 = {};
      ...
      getLayoutProperties: function getLayoutProperties() {
        return this.__P_26_6 || this.__P_26_7;
      },
      ...
      */
      ...
      clone: function clone() {
        ...
        var props = this.__P_26_6;

        if (props) {
          clone.__P_26_6 = qx.lang.Object.clone(props);
        }
    ...
    */
    destruct: function destruct() {
      ...
      this.$$parent = this.$$subparent = this.__P_26_6 = this.__P_26_1 = this.__P_26_5 = this.__P_26_3 = null;
    }
  });
  qx.ui.core.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1595486316214