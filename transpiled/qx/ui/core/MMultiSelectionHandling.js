  ...
  qx.Mixin.define("qx.ui.core.MMultiSelectionHandling", {
    ...
    */
    construct: function construct() {
      ...
      var manager = this.__P_160_0 = new clazz(this); // Add widget event listeners
    ...
    members: {
      ...
      */
      ...
      getValue: function getValue() {
        return this.__P_160_0.getSelection();
      },
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__P_160_0.isItemSelected(item);
      },
      ...
      removeFromSelection: function removeFromSelection(item) {
        ...
        this.__P_160_0.removeItem(item);
      },
      ...
      selectRange: function selectRange(begin, end) {
        this.__P_160_0.selectItemRange(begin, end);
      },
      ...
      setSelection: function setSelection(items) {
        ...
        if (items.length === 0) {
          ...
          if (!qx.lang.Array.equals(currentSelection, items)) {
            this.__P_160_0.replaceSelection(items);
          }
        }
      },
      ...
      getSortedSelection: function getSortedSelection() {
        return this.__P_160_0.getSortedSelection();
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_160_0.isSelectionEmpty();
      },
      ...
      getSelectionContext: function getSelectionContext() {
        return this.__P_160_0.getSelectionContext();
      },
      ...
      getSelectables: function getSelectables(all) {
        return this.__P_160_0.getSelectables(all);
      },
      ...
      invertSelection: function invertSelection() {
        this.__P_160_0.invertSelection();
      },
      ...
      _getLeadItem: function _getLeadItem() {
        var mode = this.__P_160_0.getMode();

        if (mode === "single" || mode === "one") {
          return this.__P_160_0.getSelectedItem();
        } else {
          return this.__P_160_0.getLeadItem();
        }
      },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_160_0");
    }
  });
  qx.ui.core.MMultiSelectionHandling.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MMultiSelectionHandling.js.map?dt=1593552904043