  ...
  qx.Mixin.define("qx.ui.core.MDragDropScrolling", {
    ...
    */
    construct: function construct() {
      ...
      widget.addListener("drag", this.__P_169_0, this);
      widget.addListener("dragend", this.__P_169_1, this);
      this.__P_169_2 = ["left", "right"];
      this.__P_169_3 = ["top", "bottom"];
    },
    ...
    */
    members: {
      ...
      _getAxis: function _getAxis(edgeType) {
        if (this.__P_169_2.indexOf(edgeType) !== -1) {
          return "x";
        } else if (this.__P_169_3.indexOf(edgeType) !== -1) {
          return "y";
        } else {
      ...
      __P_169_0: function __P_169_0(e) {
        ...
        while (scrollable) {
          ...
          if (this._isScrollbarVisible(scrollable, axis)) {
            ...
            if (this.__P_169_4) {
              this.__P_169_4.dispose();
            }

            this.__P_169_4 = new qx.event.Timer(50);

            this.__P_169_4.addListener("interval", function (scrollable, axis, amount) {
              this._scrollBy(scrollable, axis, amount);
            }.bind(this, scrollable, axis, exceedanceAmount));

            this.__P_169_4.start();
...
//# sourceMappingURL=MDragDropScrolling.js.map?dt=1593587987314