  ...
  qx.Class.define("qx.ui.core.Widget", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_5_0 = this.__P_5_1(); // Initialize properties
    ...
    */
    statics: {
      ...
      __P_5_2: new qx.util.ObjectPool()
    },
    ...
    members: {
      ...
      */
      ...
      _setLayout: function _setLayout(layout) {
        if (this.__P_5_5) {
          this.__P_5_5.connectToWidget(null);
        }
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (inner || changes.local || changes.margin) {
          if (this.__P_5_5 && this.hasLayoutChildren()) {
            ...
            this.__P_5_5.renderLayout(innerWidth, innerHeight, padding);
      ...
      */
      ...
      clearSeparators: function clearSeparators() {
        var reg = this.__P_5_6;

        if (!reg) {
          return;
        }

        var pool = qx.ui.core.Widget.__P_5_2;
        var content = this.getContentElement();
        var widget;
      ...
      renderSeparator: function renderSeparator(separator, bounds) {
        // Insert
        var widget = qx.ui.core.Widget.__P_5_2.getObject(qx.ui.core.Widget);
      ...
      */
      ...
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        if (this.__P_5_5) {
          this.__P_5_5.invalidateLayoutCache();
        }
      },
      ...
      */
      ...
      _getChildren: function _getChildren() {
        return this.__P_5_7 || this.__P_5_8;
      },
      ...
      _add: function _add(child, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__P_5_7, child);
        }

        if (this.__P_5_7) {
          this.__P_5_7.push(child);
        } else {
          this.__P_5_7 = [child];
        }

        this.__P_5_9(child, options);
      },
      ...
      _addAt: function _addAt(child, index, options) {
        ...
        if (ref) {
          qx.lang.Array.insertBefore(this.__P_5_7, child, ref);
        } else {
          this.__P_5_7.push(child);
        }
      ...
      _addBefore: function _addBefore(child, before, options) {
        ...
        qx.lang.Array.insertBefore(this.__P_5_7, child, before);
      ...
      _addAfter: function _addAfter(child, after, options) {
        ...
        qx.lang.Array.insertAfter(this.__P_5_7, child, after);
      ...
      _removeAt: function _removeAt(index) {
        ...
        var child = this.__P_5_7[index];
        qx.lang.Array.removeAt(this.__P_5_7, index);
      ...
      _removeAll: function _removeAll() {
        ...
        var children = this.__P_5_7.concat();

        this.__P_5_7.length = 0;

        for (var i = children.length - 1; i >= 0; i--) {
          this.__P_5_10(children[i]);
        }
      ...
      */
       ...
       */
      __P_5_9: function __P_5_9(child, options) {
       ...
       */
      __P_5_10: function __P_5_10(child) {
        if (child.getLayoutParent() !== this) {
        ...
        if (this.__P_5_5) {
          this.__P_5_5.invalidateChildrenCache();
        } // Add to layout queue
      ...
      */
       ...
       */
      __P_5_11: function __P_5_11(style, value) {
        var content = this.getContentElement();
        var decorator = this.getDecorator();
        decorator = qx.theme.manager.Decoration.getInstance().resolve(decorator);
      ...
      _applyToolTipText: function _applyToolTipText(value, old) {
        {
          ...
          this.__P_5_4 = manager.addListener("changeLocale", function () {
      ...
      */
      ...
      addState: function addState(state) {
        ...
        this.__P_5_12[state] = true; // Fast path for hovered state
      ...
      removeState: function removeState(state) {
        ...
        delete this.__P_5_12[state]; // Fast path for hovered state
      ...
      */
      ...
      syncAppearance: function syncAppearance() {
        ...
        if (this.__P_5_15) {
          // Clear flag
          delete this.__P_5_15; // Check if the selector was created previously
        ...
        this.fireDataEvent("syncAppearance", this.__P_5_12);
      },
      // property apply
      ...
      updateAppearance: function updateAppearance() {
        // Clear selector
        this.__P_5_15 = true; // Add to appearance queue
      ...
      */
      ...
      _createChildControl: function _createChildControl(id) {
        ...
        return this.__P_5_13[id] = control;
      },
    ...
    */
    destruct: function destruct() {
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        {
          if (this.__P_5_4) {
            qx.locale.Manager.getInstance().removeListenerById(this.__P_5_4);
          }
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        ...
        this._disposeArray("__P_5_6");
      } // Clear children array


      this._disposeArray("__P_5_7"); // Cleanup map of appearance states


      this.__P_5_12 = this.__P_5_13 = null; // Dispose layout manager and HTML elements

      this._disposeObjects("__P_5_5", "__P_5_0");
    }
  });
  qx.ui.core.Widget.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Widget.js.map?dt=1595486312429