  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__P_29_1[widget.toHashCode()]) {
          delete this.__P_29_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_29_0, widget);
        }

        delete this.__P_29_2[widget.toHashCode()];
      },
      ...
      isVisible: function isVisible(widget) {
        return this.__P_29_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __P_29_3: function __P_29_3(widget) {
        var data = this.__P_29_2;
      ...
      add: function add(widget) {
        ...
        this.__P_29_0.unshift(widget);

        this.__P_29_1[widget.toHashCode()] = widget;
      ...
      flush: function flush() {
        ...
        var queue = this.__P_29_0;
        var data = this.__P_29_2; // Dynamically add children to queue
...
//# sourceMappingURL=Visibility.js.map?dt=1593592725947