  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
      ...
      flush: function flush() {
        ...
        self.__P_32_4 = true; // Cancel timeout if called manually

        self.__P_32_1 = true;
        var jobs = self.__P_32_2;

        self.__P_32_5(function () {
          // Process jobs
       ...
       */
      __P_32_5: function __P_32_5(callback, finallyCode) {
        var self = qx.ui.core.queue.Manager;
        ...
        try {
          ...
          if (self.__P_32_3 <= self.MAX_RETRIES) {
            self.scheduleFlush();
          } else {
            throw new Error("Fatal Error: Flush terminated " + (self.__P_32_3 - 1) + " times in a row" + " due to exceptions in user code. The application has to be reloaded!");
          }
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "useraction", qx.core.Environment.get("event.touch") ? statics.__P_32_6 : statics.flush);
    }
  });
  qx.ui.core.queue.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1593594343682