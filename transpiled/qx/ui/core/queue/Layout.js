  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function remove(widget) {
        delete this.__P_28_0[widget.toHashCode()];
      },
      ...
      add: function add(widget) {
        this.__P_28_0[widget.toHashCode()] = widget;
      ...
      */
      isScheduled: function isScheduled(widget) {
        return !!this.__P_28_0[widget.toHashCode()];
      },
      ...
      flush: function flush() {
        ...
        var queue = this.__P_28_2(); // iterate in reversed order to process widgets with the smallest nesting
       ...
       */
      __P_28_3: function __P_28_3() {
        var VisibilityQueue = qx.ui.core.queue.Visibility; // clear cache

        this.__P_28_1 = {}; // sparse level array

        var levels = [];
        var queue = this.__P_28_0;
        var widget, level;
...
//# sourceMappingURL=Layout.js.map?dt=1593552881292