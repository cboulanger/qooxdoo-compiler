  ...
  qx.Mixin.define("qx.ui.core.MMovable", {
    ...
    members: {
      ...
      */
      ...
      _activateMoveHandle: function _activateMoveHandle(widget) {
        ...
        widget.addListener("losecapture", this.__P_228_10, this);
      },
      ...
      __P_228_11: function __P_228_11() {
        var frame = this.__P_228_1;

        if (!frame) {
          frame = this.__P_228_1 = new qx.ui.core.Widget();
      ...
      */
       ...
       */
      __P_228_13: function __P_228_13(e) {
        var range = this.__P_228_2;
        ...
        var viewportLeft = this.__P_228_3 + pointerLeft;
        var viewportTop = this.__P_228_4 + pointerTop;
        return {
          viewportLeft: parseInt(viewportLeft, 10),
          viewportTop: parseInt(viewportTop, 10),
          parentLeft: parseInt(viewportLeft - this.__P_228_5, 10),
          parentTop: parseInt(viewportTop - this.__P_228_6, 10)
        };
      },
      ...
      */
      ...
      _onMovePointerDown: function _onMovePointerDown(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (!parent.isBlocked()) {
            this.__P_228_8 = parent.getBlockerColor();
            this.__P_228_9 = parent.getBlockerOpacity();
        ...
        this.__P_228_5 = parentLocation.left;
        this.__P_228_6 = parentLocation.top;
        this.__P_228_3 = widgetLocation.left - e.getDocumentLeft();
        this.__P_228_4 = widgetLocation.top - e.getDocumentTop(); // Add state

        this.addState("move"); // Enable capturing

        this.__P_228_0.capture(); // Enable drag frame
      ...
      _onMovePointerMove: function _onMovePointerMove(e) {
        ...
        var coords = this.__P_228_13(e);

        if (this.getUseMoveFrame()) {
          this.__P_228_11().setDomPosition(coords.viewportLeft, coords.viewportTop);
        } else {
      ...
      _onMovePointerUp: function _onMovePointerUp(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (this.__P_228_7) {
            parent.unblock();
            parent.setBlockerColor(this.__P_228_8);
            parent.setBlockerOpacity(this.__P_228_9);
            this.__P_228_8 = null;
            this.__P_228_9 = 0;
            this.__P_228_7 = false;
          }
        } // Disable capturing


        this.__P_228_0.releaseCapture(); // Apply them to the layout
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_228_1", "__P_228_0");
...
//# sourceMappingURL=MMovable.js.map?dt=1595486348782