  ...
  qx.Class.define("qx.ui.core.selection.Abstract", {
    ...
    members: {
      ...
      */
      ...
      getSelection: function getSelection() {
        return Object.values(this.__P_235_0);
      },
      ...
      getSortedSelection: function getSortedSelection() {
        ...
        var sel = Object.values(this.__P_235_0);
      ...
      isItemSelected: function isItemSelected(item) {
        ...
        return this.__P_235_0[hash] !== undefined;
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return qx.lang.Object.isEmpty(this.__P_235_0);
      },
      ...
      */
      ...
      _getAnchorItem: function _getAnchorItem() {
        return this.__P_235_18 !== null ? this.__P_235_18 : null;
      },
      ...
      */
      ...
      handlePointerOver: function handlePointerOver(event) {
        ...
        if (this.__P_235_20 != null && this.__P_235_20 != this._getScroll().top) {
          this.__P_235_20 = null;
          return;
      ...
      handlePointerDown: function handlePointerDown(event) {
        ...
        if (this.isItemSelected(item) && !isShiftPressed && !isCtrlPressed && !this.getDrag()) {
          this.__P_235_19 = item;
          this._userInteraction = false;
          return;
        } else {
          this.__P_235_19 = null;
        ...
        if (this.getDrag() && mode !== "single" && mode !== "one" && !isShiftPressed && !isCtrlPressed && event.getPointerType() == "mouse") {
          ...
          this.__P_235_7 = this._getLocation();
          this.__P_235_4 = this._getScroll(); // Store position at start

          this.__P_235_8 = event.getDocumentLeft() + this.__P_235_4.left;
          this.__P_235_9 = event.getDocumentTop() + this.__P_235_4.top; // Switch to capture mode

          this.__P_235_10 = true;
      ...
      handleTap: function handleTap(event) {
        ...
        if (!isCtrlPressed && !isShiftPressed && this.__P_235_19 != null) {
          this._userInteraction = false;
      ...
      handlePointerMove: function handlePointerMove(event) {
        ...
        this.__P_235_11 = event.getDocumentLeft();
        this.__P_235_12 = event.getDocumentTop(); // this is a method invoked by an user interaction, so be careful to
        // set / clear the mark this._userInteraction [BUG #3344]

        this._userInteraction = true; // Detect move directions

        var dragX = this.__P_235_11 + this.__P_235_4.left;

        if (dragX > this.__P_235_8) {
          this.__P_235_13 = 1;
        } else if (dragX < this.__P_235_8) {
          this.__P_235_13 = -1;
        } else {
          this.__P_235_13 = 0;
        }

        var dragY = this.__P_235_12 + this.__P_235_4.top;

        if (dragY > this.__P_235_9) {
          this.__P_235_14 = 1;
        } else if (dragY < this.__P_235_9) {
          this.__P_235_14 = -1;
        } else {
          this.__P_235_14 = 0;
        } // Update scroll steps
        ...
        var location = this.__P_235_7;

        if (this.__P_235_11 < location.left) {
          this.__P_235_1 = this.__P_235_11 - location.left;
        } else if (this.__P_235_11 > location.right) {
          this.__P_235_1 = this.__P_235_11 - location.right;
        } else {
          this.__P_235_1 = 0;
        }

        if (this.__P_235_12 < location.top) {
          this.__P_235_2 = this.__P_235_12 - location.top;
        } else if (this.__P_235_12 > location.bottom) {
          this.__P_235_2 = this.__P_235_12 - location.bottom;
        } else {
          this.__P_235_2 = 0;
        ...
        if (!this.__P_235_3) {
          this.__P_235_3 = new qx.event.Timer(100);

          this.__P_235_3.addListener("interval", this._onInterval, this);
        } // Start interval


        this.__P_235_3.start(); // Auto select based on new cursor position
      ...
      */
      ...
      _cleanup: function _cleanup() {
        if (!this.getDrag() && this.__P_235_10) {
          return;
        ...
        delete this.__P_235_5;
        delete this.__P_235_6; // Stop capturing
      ...
      _onInterval: function _onInterval(e) {
        ...
        this._scrollBy(this.__P_235_1, this.__P_235_2); // Update scroll cache


        this.__P_235_4 = this._getScroll(); // Auto select based on new scroll position and cursor
      ...
      _autoSelect: function _autoSelect() {
        ...
        var relX = Math.max(0, Math.min(this.__P_235_11 - this.__P_235_7.left, inner.width)) + this.__P_235_4.left;

        var relY = Math.max(0, Math.min(this.__P_235_12 - this.__P_235_7.top, inner.height)) + this.__P_235_4.top; // Compare old and new relative coordinates (for performance reasons)


        if (this.__P_235_5 === relX && this.__P_235_6 === relY) {
          return;
        }

        this.__P_235_5 = relX;
        this.__P_235_6 = relY; // Cache anchor

        var anchor = this._getAnchorItem();

        var lead = anchor; // Process X-coordinate

        var moveX = this.__P_235_13;
        var nextX, locationX;
      ...
      handleKeyPress: function handleKeyPress(event) {
        ...
        if (key === "A" && isCtrlPressed) {
          ...
          if (next !== null) {
            ...
            this.__P_235_20 = this._getScroll().top;
      ...
      */
      ...
      _selectItemRange: function _selectItemRange(item1, item2, extend) {
        ...
        if (!extend) {
          var selected = this.__P_235_0;

          var mapped = this.__P_235_22(range);
       ...
       */
      __P_235_22: function __P_235_22(range) {
        var mapped = {};
        var item;
      ...
      */
      ...
      _getSelectedItem: function _getSelectedItem() {
        for (var hash in this.__P_235_0) {
          return this.__P_235_0[hash];
        }
      ...
      */
      ...
      _addToSelection: function _addToSelection(item) {
        ...
        if (this.__P_235_0[hash] == null && this._isSelectable(item)) {
          this.__P_235_0[hash] = item;

          this._styleSelectable(item, "selected", true);

          this.__P_235_15 = true;
        }
      },
      ...
      _toggleInSelection: function _toggleInSelection(item) {
        ...
        if (this.__P_235_0[hash] == null) {
          this.__P_235_0[hash] = item;

          this._styleSelectable(item, "selected", true);
        } else {
          delete this.__P_235_0[hash];
      ...
      _fireChange: function _fireChange(context) {
        if (this.__P_235_15) {
          // Store context
          this.__P_235_16 = context || null; // Fire data event which contains the current selection

          this.fireDataEvent("changeSelection", this.getSelection());
          delete this.__P_235_15;
        }
      },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_235_3");

      this.__P_235_0 = this.__P_235_19 = this.__P_235_18 = null;
      this.__P_235_17 = null;
    }
  });
  qx.ui.core.selection.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1593594374816