    ...
    members: {
      ...
      */
      ...
      _isSelectable: function _isSelectable(item) {
        return this._isItemSelectable(item) && item.getLayoutParent() === this.__P_224_0;
      },
      // overridden
      ...
      _capture: function _capture() {
        this.__P_224_0.capture();
      },
      // overridden
      _releaseCapture: function _releaseCapture() {
        this.__P_224_0.releaseCapture();
      },
      ...
      */
      ...
      _getLocation: function _getLocation() {
        var elem = this.__P_224_0.getContentElement().getDomElement();

        return elem ? qx.bom.element.Location.get(elem) : null;
      },
      // overridden
      _getDimension: function _getDimension() {
        return this.__P_224_0.getInnerSize();
      },
      // overridden
      ...
      */
      ...
      _scrollItemIntoView: function _scrollItemIntoView(item) {
        this.__P_224_0.scrollChildIntoView(item);
      },
      ...
      */
      ...
      getSelectables: function getSelectables(all) {
        ...
        var children = this.__P_224_0.getChildren();
      ...
      _getRelatedSelectable: function _getRelatedSelectable(item, relation) {
        var vertical = this.__P_224_0.getOrientation() === "vertical";
...
//# sourceMappingURL=Widget.js.map?dt=1593594373226