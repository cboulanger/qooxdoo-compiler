  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_180_0 = []; // Register pointerdown handler

      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__P_180_1, this, true); // Hide all popups on window blur
    ...
    */
    members: {
      ...
      remove: function remove(obj) {
        qx.lang.Array.remove(this.__P_180_0, obj);
      ...
      hideAll: function hideAll() {
        var l = this.__P_180_0.length,
            current = {};

        while (l--) {
          current = this.__P_180_0[l];
      ...
      */
      ...
      __P_180_2: function __P_180_2() {
        ...
        for (var i = 0; i < this.__P_180_0.length; i++) {
          this.__P_180_0[i].setZIndex(min++);
        }
      },
      ...
      */
       ...
       */
      __P_180_1: function __P_180_1(e) {
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__P_180_1, this, true);

      this._disposeArray("__P_180_0");
    }
  });
  qx.ui.popup.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1593592749981