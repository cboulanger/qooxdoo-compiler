    ...
    statics: {
      ...
      capitalize: function capitalize(str) {
        if (this.__P_64_1 === null) {
          ...
          this.__P_64_1 = new RegExp("(^|[^" + this.__P_64_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "])[" + this.__P_64_0.replace(/[0-9A-F]{4}/g, function (match) {
            return unicodeEscapePrefix + match;
          }) + "]", "g");
        }

        return str.replace(this.__P_64_1, function (match) {
...
//# sourceMappingURL=String.js.map?dt=1596533195999