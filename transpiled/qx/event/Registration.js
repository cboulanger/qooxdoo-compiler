    ...
    */
    statics: {
      ...
      getManager: function getManager(target) {
        ...
        var manager = this.__P_34_0[hash];

        if (!manager) {
          manager = new qx.event.Manager(target, this);
          this.__P_34_0[hash] = manager;
        }
       ...
       * @see #createEvent
       */
      __P_34_1: function __P_34_1(target, type, clazz, args) {
       ...
       * @see #createEvent
       */
      __P_34_2: function __P_34_2(target, type, clazz, args) {
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(target, type, clazz, args) {
        var evt = this.__P_34_2.apply(this, arguments);
      ...
      */
      ...
      addHandler: function addHandler(handler) {
        // Append to list
        this.__P_34_3.push(handler); // Re-sort list


        this.__P_34_3.sort(function (a, b) {
      ...
      */
      ...
      addDispatcher: function addDispatcher(dispatcher, priority) {
        // Append to list
        this.__P_34_4.push(dispatcher); // Re-sort list


        this.__P_34_4.sort(function (a, b) {
          return a.PRIORITY - b.PRIORITY;
        });
      },
...
//# sourceMappingURL=Registration.js.map?dt=1593594344107