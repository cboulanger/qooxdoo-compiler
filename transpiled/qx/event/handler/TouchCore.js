  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.TouchCore", {
    ...
    construct: function construct(target, emitter) {
      this.__P_201_0 = target;
      this.__P_201_1 = emitter;
    ...
    members: {
      ...
      */
      ...
      _initTouchObserver: function _initTouchObserver() {
        this.__P_201_4 = qx.lang.Function.listener(this._onTouchEvent, this);
        this.__P_201_9 = ["touchstart", "touchmove", "touchend", "touchcancel"];
        ...
        if (qx.core.Environment.get("event.mspointer")) {
          ...
          if (engineVersion == 10) {
            // IE 10
            this.__P_201_9 = ["MSPointerDown", "MSPointerMove", "MSPointerUp", "MSPointerCancel"];
          } else {
            // IE 11+
            this.__P_201_9 = ["pointerdown", "pointermove", "pointerup", "pointercancel"];
          }
        }

        for (var i = 0; i < this.__P_201_9.length; i++) {
          qx.bom.Event.addNativeListener(this.__P_201_0, this.__P_201_9[i], this.__P_201_4);
        }
      },
      ...
      */
      ...
      _stopTouchObserver: function _stopTouchObserver() {
        for (var i = 0; i < this.__P_201_9.length; i++) {
          qx.bom.Event.removeNativeListener(this.__P_201_0, this.__P_201_9[i], this.__P_201_4);
        }
      },
      ...
      */
      ...
      _calcSingleTouchDelta: function _calcSingleTouchDelta(touch) {
        if (this.__P_201_3.hasOwnProperty(touch.identifier)) {
          var touchStartPosition = this.__P_201_3[touch.identifier];
      ...
      _commonTouchEventHandler: function _commonTouchEventHandler(domEvent, type) {
        ...
        if (type == "touchstart") {
          this.__P_201_5 = this._getTarget(domEvent);

          if (domEvent.touches && domEvent.touches.length > 1) {
            this.__P_201_7 = this._getScalingDistance(domEvent.touches[0], domEvent.touches[1]);
            this.__P_201_8 = this._getRotationAngle(domEvent.touches[0], domEvent.touches[1]);
          }

          for (var i = 0; i < domEvent.changedTouches.length; i++) {
            var touch = domEvent.changedTouches[i];
            this.__P_201_3[touch.identifier] = [touch.clientX, touch.clientY];
          }
        }
        ...
        if (type == "touchmove") {
          ...
          if (typeof domEvent.scale == "undefined" && domEvent.targetTouches.length > 1) {
            ...
            domEvent.scale = currentScalingDistance / this.__P_201_7;
          ...
          if ((typeof domEvent.rotation == "undefined" || qx.core.Environment.get("event.mspointer")) && domEvent.targetTouches.length > 1) {
            ...
            domEvent._rotation = currentRotation - this.__P_201_8;
          }

          domEvent.delta = this._calcTouchesDelta(domEvent.targetTouches);
        }

        this._fireEvent(domEvent, type, this.__P_201_5);

        if (qx.core.Environment.get("event.mspointer")) {
          if (type == "touchend" || type == "touchcancel") {
            delete this.__P_201_2[domEvent.pointerId];
          }
        }

        if ((type == "touchend" || type == "touchcancel") && domEvent.changedTouches[0]) {
          delete this.__P_201_3[domEvent.changedTouches[0].identifier];
        }
      },
      ...
      */
      _detectTouchesByPointer: function _detectTouchesByPointer(domEvent, type) {
        ...
        if (type == "touchstart") {
          this.__P_201_2[domEvent.pointerId] = domEvent;
        } else if (type == "touchmove") {
          this.__P_201_2[domEvent.pointerId] = domEvent;
        }

        for (var pointerId in this.__P_201_2) {
          var pointer = this.__P_201_2[pointerId];
      ...
      */
      ...
      _getTarget: function _getTarget(domEvent) {
        ...
        if (qx.core.Environment.get("engine.name") == "webkit") {
          ...
          //
          var targetForIE = this.__P_201_10(domEvent);
       ...
       */
      __P_201_10: function __P_201_10(domEvent) {
        var clientX = null;
        var clientY = null;
      ...
      _fireEvent: function _fireEvent(domEvent, type, target) {
        ...
        if (target && target.nodeType && this.__P_201_1) {
          this.__P_201_1.emit(type, domEvent);
        }
      },
      ...
      dispose: function dispose() {
        ...
        this.__P_201_5 = this.__P_201_0 = this.__P_201_9 = this.__P_201_2 = this.__P_201_1 = this.__P_201_7 = this.__P_201_8 = null;
      }
    }
  });
...
//# sourceMappingURL=TouchCore.js.map?dt=1593552909525