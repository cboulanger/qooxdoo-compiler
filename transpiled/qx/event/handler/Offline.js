  ...
  qx.Class.define("qx.event.handler.Offline", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_150_0 = manager;
      this.__P_150_1 = manager.getWindow();
    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__P_150_2 = qx.lang.Function.listener(this._onNative, this);
        qx.bom.Event.addNativeListener(this.__P_150_1, "offline", this.__P_150_2);
        qx.bom.Event.addNativeListener(this.__P_150_1, "online", this.__P_150_2);
      },
      ...
      _stopObserver: function _stopObserver() {
        qx.bom.Event.removeNativeListener(this.__P_150_1, "offline", this.__P_150_2);
        qx.bom.Event.removeNativeListener(this.__P_150_1, "online", this.__P_150_2);
      },
      ...
      _onNative: qx.event.GlobalError.observeMethod(function (domEvent) {
        qx.event.Registration.fireEvent(this.__P_150_1, domEvent.type, qx.event.type.Event, []);
      }),
      ...
      */
      ...
      isOnline: function isOnline() {
        return !!this.__P_150_1.navigator.onLine;
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      delete qx.event.handler.Appear.__P_150_3[this.toHashCode()];
    },
...
//# sourceMappingURL=Offline.js.map?dt=1593552902698