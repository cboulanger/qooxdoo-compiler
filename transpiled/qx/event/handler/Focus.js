  ...
  qx.Class.define("qx.event.handler.Focus", {
    ...
    members: {
      ...
      */
      ...
      tryActivate: function tryActivate(element) {
        var active = this.__P_93_14(element);
      ...
      */
       ...
       */
      __P_93_15: function __P_93_15(target, related, type, bubbles) {
      ...
      */
       ...
       */
      __P_93_17: function __P_93_17() {
        // Omit doubled focus events
        // which is a common behavior at least for gecko based clients
        if (!this._windowFocused) {
          this._windowFocused = true;

          this.__P_93_15(this._window, null, "focus", false);
        }
      },
      ...
      */
      ...
      _initObserver: qx.core.Environment.select("engine.name", {
        "gecko": function gecko() {
          // Bind methods
          this.__P_93_1 = qx.lang.Function.listener(this.__P_93_18, this);
          this.__P_93_2 = qx.lang.Function.listener(this.__P_93_19, this);
          this.__P_93_3 = qx.lang.Function.listener(this.__P_93_20, this);
          this.__P_93_4 = qx.lang.Function.listener(this.__P_93_21, this);
          this.__P_93_5 = qx.lang.Function.listener(this.__P_93_22, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_93_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_93_2, true); // Capturing is needed for gecko to correctly
          // handle focus of input and textarea fields

          qx.bom.Event.addNativeListener(this._window, "focus", this.__P_93_3, true);
          qx.bom.Event.addNativeListener(this._window, "blur", this.__P_93_4, true); // Capture drag events

          qx.bom.Event.addNativeListener(this._window, "draggesture", this.__P_93_5, true);
        },
        "mshtml": function mshtml() {
          // Bind methods
          this.__P_93_1 = qx.lang.Function.listener(this.__P_93_18, this);
          this.__P_93_2 = qx.lang.Function.listener(this.__P_93_19, this);
          this.__P_93_7 = qx.lang.Function.listener(this.__P_93_23, this);
          this.__P_93_8 = qx.lang.Function.listener(this.__P_93_24, this);
          this.__P_93_6 = qx.lang.Function.listener(this.__P_93_25, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_93_1);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_93_2); // MSHTML supports their own focusin and focusout events
          ...
          qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_93_7);
          qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_93_8); // Add selectstart to prevent selection

          qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_93_6);
        },
        "webkit": qx.core.Environment.select("browser.name", {
          ...
          "edge": function edge(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_93_1, true);
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_93_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_93_6, false);
            qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_93_7);
            qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_93_8);
          },
          "default": function _default(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_93_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_93_6, false);
            qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_93_8, true);
            qx.bom.Event.addNativeListener(this._window, "focus", this.__P_93_3, true);
            qx.bom.Event.addNativeListener(this._window, "blur", this.__P_93_4, true);
          }
        }),
        "opera": function opera() {
          ...
          this.__P_93_2 = qx.lang.Function.listener(this.__P_93_19, this);
          this.__P_93_7 = qx.lang.Function.listener(this.__P_93_23, this);
          this.__P_93_8 = qx.lang.Function.listener(this.__P_93_24, this); // Register events

          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_93_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_93_2, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusIn", this.__P_93_7, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_93_8, true);
        }
      }),
      ...
      _stopObserver: qx.core.Environment.select("engine.name", {
        "gecko": function gecko() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_93_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_93_2, true);
          qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_93_3, true);
          qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_93_4, true);
          qx.bom.Event.removeNativeListener(this._window, "draggesture", this.__P_93_5, true);
        },
        "mshtml": function mshtml() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_93_1);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_93_2);
          qx.bom.Event.removeNativeListener(this._document, "focusin", this.__P_93_7);
          qx.bom.Event.removeNativeListener(this._document, "focusout", this.__P_93_8);
          qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_93_6);
        },
        "webkit": qx.core.Environment.select("browser.name", {
          // fix for [ISSUE #9174]
          // distinguish bettween MS Edge, which is reported
          ...
          "default": function _default() {
            qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_93_1, true);
            qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_93_2, true);
            qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_93_6, false);
            qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_93_8, true);
            qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_93_3, true);
            qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_93_4, true);
          }
        }),
        "opera": function opera() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_93_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_93_2, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusIn", this.__P_93_7, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_93_8, true);
        }
      }),
      ...
      */
       ...
       */
      __P_93_22: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko": function gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);

          if (!this.__P_93_26(target)) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_23: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
          // Force window focus to be the first
          this.__P_93_17(); // Update internal data
          ...
          var focusTarget = this.__P_93_27(target);
        ...
        "opera": function opera(domEvent) {
          ...
          if (target == this._document || target == this._window) {
            ...
            if (this.__P_93_9) {
              this.setFocus(this.__P_93_9);
              delete this.__P_93_9;
            }

            if (this.__P_93_10) {
              this.setActive(this.__P_93_10);
              delete this.__P_93_10;
            }
          } else {
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_24: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
          var relatedTarget = qx.bom.Event.getRelatedTarget(domEvent); // If the focus goes to nowhere (the document is blurred)

          if (relatedTarget == null) {
            // Update internal representation
            this.__P_93_16(); // Reset active and focus
        ...
        "opera": function opera(domEvent) {
          ...
          if (target == this._document) {
            this.__P_93_16(); // Store old focus/active elements
            // Opera do not fire focus events for them
            // when refocussing the window (in my opinion an error)


            this.__P_93_9 = this.getFocus();
            this.__P_93_10 = this.getActive();
            this.resetFocus();
            this.resetActive();
          } else {
            if (target === this.getFocus()) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_21: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko": function gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_20: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko": function gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);

          if (target === this._window || target === this._document) {
            this.__P_93_17(); // Always speak of the body, not the window or document
        ...
        "webkit": function webkit(domEvent) {
          ...
          if (target === this._window || target === this._document) {
            ...
            this.__P_93_13 = domEvent.relatedTarget;
            this.setFocus(target);
            this.__P_93_13 = null;
            this.tryActivate(target);
          }
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_18: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_19: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          ...
          this.tryActivate(this.__P_93_28(target));
        },
        "gecko": function gecko(domEvent) {
          // As of Firefox 3.0:
       ...
       */
      __P_93_29: function __P_93_29(target) {
       ...
       */
      __P_93_28: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(target) {
          return this.__P_93_29(target);
        },
       ...
       * @param domEvent {Event} Native event
       */
      __P_93_25: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
      ...
      */
       ...
       */
      __P_93_30: function __P_93_30(el) {
       ...
       */
      __P_93_27: function __P_93_27(el) {
        while (el && el.nodeType === 1) {
          if (el.getAttribute("qxKeepFocus") == "on") {
            return null;
          }

          if (this.__P_93_30(el)) {
            return el;
          }
       ...
       */
      __P_93_14: function __P_93_14(el) {
        var orig = el;
       ...
       */
      __P_93_26: function __P_93_26(node) {
      ...
      */
      ...
      _applyActive: function _applyActive(value, old) {
        // Fire events
        if (old) {
          this.__P_93_15(old, value, "deactivate", true);
        }

        if (value) {
          this.__P_93_15(value, old, "activate", true);
      ...
      _applyFocus: function _applyFocus(value, old) {
        ...
        if (old) {
          this.__P_93_15(old, value, "focusout", true);
        }

        if (value) {
          this.__P_93_15(value, old, "focusin", true);
        } // Fire after events


        if (old) {
          this.__P_93_15(old, value, "blur", false);
        }

        if (value) {
          this.__P_93_15(value, old || this.__P_93_13, "focus", false);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._manager = this._window = this._document = this._root = this._body = this.__P_93_31 = this.__P_93_13 = null;
    },
...
//# sourceMappingURL=Focus.js.map?dt=1593594353014