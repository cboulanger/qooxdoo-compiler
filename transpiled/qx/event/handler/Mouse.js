  ...
  qx.Class.define("qx.event.handler.Mouse", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_148_0 = manager;
      this.__P_148_1 = manager.getWindow();
      this.__P_148_2 = this.__P_148_1.document; // Initialize observers
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_148_9: function __P_148_9(domEvent, type, target) {
        if (!target) {
        ...
        qx.event.Registration.fireEvent(this.__P_148_1, "useraction", qx.event.type.Data, [type || domEvent.type]);
      },
      ...
      */
      ...
      _initButtonObserver: function _initButtonObserver() {
        this.__P_148_3 = qx.lang.Function.listener(this._onButtonEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_148_2, "mousedown", this.__P_148_3);
        Event.addNativeListener(this.__P_148_2, "mouseup", this.__P_148_3);
        Event.addNativeListener(this.__P_148_2, "click", this.__P_148_3);
        Event.addNativeListener(this.__P_148_2, "auxclick", this.__P_148_3);
        Event.addNativeListener(this.__P_148_2, "dblclick", this.__P_148_3);
        Event.addNativeListener(this.__P_148_2, "contextmenu", this.__P_148_3);
      },
      ...
      _initMoveObserver: function _initMoveObserver() {
        this.__P_148_4 = qx.lang.Function.listener(this._onMoveEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_148_2, "mousemove", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "mouseover", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "mouseout", this.__P_148_4);
      },
      ...
      _initWheelObserver: function _initWheelObserver() {
        this.__P_148_5 = qx.lang.Function.listener(this._onWheelEvent, this);
        var data = qx.bom.client.Event.getMouseWheel(this.__P_148_1);
        qx.bom.Event.addNativeListener(data.target, data.type, this.__P_148_5);
      },
      ...
      */
      ...
      _stopButtonObserver: function _stopButtonObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_148_2, "mousedown", this.__P_148_3);
        Event.removeNativeListener(this.__P_148_2, "mouseup", this.__P_148_3);
        Event.removeNativeListener(this.__P_148_2, "click", this.__P_148_3);
        Event.removeNativeListener(this.__P_148_2, "dblclick", this.__P_148_3);
        Event.removeNativeListener(this.__P_148_2, "contextmenu", this.__P_148_3);
      },
      ...
      _stopMoveObserver: function _stopMoveObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_148_2, "mousemove", this.__P_148_4);
        Event.removeNativeListener(this.__P_148_2, "mouseover", this.__P_148_4);
        Event.removeNativeListener(this.__P_148_2, "mouseout", this.__P_148_4);
      },
      ...
      _stopWheelObserver: function _stopWheelObserver() {
        var data = qx.bom.client.Event.getMouseWheel(this.__P_148_1);
        qx.bom.Event.removeNativeListener(data.target, data.type, this.__P_148_5);
      },
      ...
      */
      ...
      _onButtonEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        ...
        if (type == "click" && this.__P_148_8) {
          delete this.__P_148_8;
          return;
        ...
        var isDrag = qx.event.handler.DragDrop && this.__P_148_0.getHandler(qx.event.handler.DragDrop).isSessionActive();
        ...
        if (this.__P_148_10) {
          this.__P_148_10(domEvent, type, target);
        }

        this.__P_148_9(domEvent, type, target);
        /*
        ...
        if (type == "auxclick" && domEvent.button == 1) {
          this.__P_148_9(domEvent, "click", target);
        }

        if (this.__P_148_11) {
          this.__P_148_11(domEvent, type, target);
        }

        if (this.__P_148_12 && !isDrag) {
          this.__P_148_12(domEvent, type, target);
        }
      ...
      _onWheelEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        this.__P_148_9(domEvent, "mousewheel");
      }),
      ...
      */
       ...
       */
      __P_148_11: qx.core.Environment.select("engine.name", {
        "opera": function opera(domEvent, type, target) {
          if (type == "mouseup" && domEvent.button == 2) {
            this.__P_148_9(domEvent, "contextmenu", target);
          }
        },
        "default": null
      }),
       ...
       * @signature function(domEvent, type, target)
       */
      __P_148_10: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent, type, target) {
          ...
          if (type == "mouseup" && this.__P_148_6 == "click") {
            this.__P_148_9(domEvent, "mousedown", target);
       ...
       * @signature function(domEvent, type, target)
       */
      __P_148_12: qx.core.Environment.select("engine.name", {
        "mshtml": null,
        "default": function _default(domEvent, type, target) {
          switch (type) {
            case "mousedown":
              this.__P_148_7 = target;
              break;

            case "mouseup":
              if (target !== this.__P_148_7) {
                var commonParent = qx.dom.Hierarchy.getCommonParent(target, this.__P_148_7);

                if (commonParent) {
                  this.__P_148_9(domEvent, "click", commonParent);
                }
              }
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_148_0 = this.__P_148_1 = this.__P_148_2 = this.__P_148_7 = null;
    },
...
//# sourceMappingURL=Mouse.js.map?dt=1593592746435