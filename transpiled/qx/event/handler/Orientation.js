  ...
  qx.Class.define("qx.event.handler.Orientation", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_200_1 = manager.getWindow();
    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__P_200_3 = qx.lang.Function.listener(this._onNative, this); // Handle orientation change event for Android devices by the resize event.
        // See http://stackoverflow.com/questions/1649086/detect-rotation-of-android-phone-in-the-browser-with-javascript
        // for more information.

        this.__P_200_2 = qx.bom.Event.supportsEvent(this.__P_200_1, "orientationchange") ? "orientationchange" : "resize";
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_200_1, this.__P_200_2, this.__P_200_3);
      },
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_200_1, this.__P_200_2, this.__P_200_3);
      },
      ...
      */
      ...
      _onOrientationChange: function _onOrientationChange(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          qx.event.Registration.fireEvent(this.__P_200_1, "orientationchange", qx.event.type.Orientation, [orientation, mode]);
        }
      }
    },
...
//# sourceMappingURL=Orientation.js.map?dt=1596533218648