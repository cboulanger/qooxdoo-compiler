  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_92_0 = manager;
      this.__P_92_1 = {}; // Register

      qx.event.handler.Appear.__P_92_2[this.toHashCode()] = this;
    },
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_92_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    destruct: function destruct() {
      this.__P_92_0 = this.__P_92_1 = null; // Deregister

      delete qx.event.handler.Appear.__P_92_2[this.toHashCode()];
    },
...
//# sourceMappingURL=Appear.js.map?dt=1596533201094