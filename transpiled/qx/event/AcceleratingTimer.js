  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.AcceleratingTimer", {
    ...
    construct: function construct() {
      ...
      this.__P_213_0 = new qx.event.Timer(this.getInterval());

      this.__P_213_0.addListener("interval", this._onInterval, this);
    },
    events: {
    ...
    members: {
      ...
      start: function start() {
        this.__P_213_0.setInterval(this.getFirstInterval());

        this.__P_213_0.start();
      },
      ...
      _onInterval: function _onInterval() {
        ...
        if (this.__P_213_1 == null) {
          this.__P_213_1 = this.getInterval();
        }

        this.__P_213_1 = Math.max(this.getMinimum(), this.__P_213_1 - this.getDecrease());

        this.__P_213_0.setInterval(this.__P_213_1);
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_213_0");
    }
  });
  qx.event.AcceleratingTimer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AcceleratingTimer.js.map?dt=1593594370813