          ...
          default:
            if (!(qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") <= 8)) {
              ...
              if (this._native.button === -1) {
                return this.__P_195_1[this._native.buttons] || "none";
              }

              return this.__P_195_0[this._native.button] || "none";
            } else {
              return this.__P_195_2[this._native.button] || "none";
            }
...
//# sourceMappingURL=Mouse.js.map?dt=1595486341775