  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.dispatch.MouseCapture", {
    ...
    construct: function construct(manager, registration) {
      ...
      this.__P_35_0 = manager.getWindow();
      this.__P_35_1 = registration;
      manager.addListener(this.__P_35_0, "blur", this.releaseCapture, this);
      manager.addListener(this.__P_35_0, "focus", this.releaseCapture, this);
      manager.addListener(this.__P_35_0, "scroll", this.releaseCapture, this);
    },
    statics: {
    ...
    members: {
      ...
      */
      ...
      canDispatchEvent: function canDispatchEvent(target, event, type) {
        return !!(this.__P_35_2 && this.__P_35_4[type]);
      },
      // overridden
      dispatchEvent: function dispatchEvent(target, event, type) {
        ...
        if (this.__P_35_3 || !qx.dom.Hierarchy.contains(this.__P_35_2, target)) {
          target = this.__P_35_2;
        }
      ...
      */
      ...
      activateCapture: function activateCapture(element, containerCapture) {
        ...
        if (this.__P_35_2 === element && this.__P_35_3 == containerCapture) {
          return;
        }
        ...
        this.__P_35_3 = containerCapture;
        this.__P_35_2 = element;

        this.__P_35_1.fireEvent(element, "capture", qx.event.type.Event, [true, false]);
      },
      ...
      releaseCapture: function releaseCapture() {
        ...
        this.__P_35_1.fireEvent(element, "losecapture", qx.event.type.Event, [true, false]); // turn off native mouse capturing if the browser supports it
...
//# sourceMappingURL=MouseCapture.js.map?dt=1593552882124