    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__P_120_0(theme.fonts[value]);
       ...
       */
      __P_120_1: function __P_120_1(fonts, fontName) {
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__P_120_1(source, key);
            }

            var font = this.__P_120_0(source[key]);
       ...
       * @return {Class}
       */
      __P_120_0: function __P_120_0(config) {
        if (config.sources) {
...
//# sourceMappingURL=Font.js.map?dt=1593552896826