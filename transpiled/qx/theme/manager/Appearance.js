    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_39_3: function __P_39_3(id, theme, defaultId, chain) {
        ...
        if (!entry) {
          ...
          while (!entry && splitted.length > 0) {
            ...
            if (entry) {
              ...
              if (typeof alias === "string") {
                ...
                return this.__P_39_3(mapped, theme, defaultId, chainCopy);
              }
            }
          ...
          for (var i = 0; i < end.length - 1; i++) {
            ...
            var resolved = this.__P_39_3(subId, theme, null, chainCopy);
          ...
          if (defaultId != null) {
            return this.__P_39_3(defaultId, theme, null, chainCopy);
          ...
          return this.__P_39_3(entry, theme, defaultId, chainCopy);
        } else if (entry.include && !entry.style) {
          return this.__P_39_3(entry.include, theme, defaultId, chainCopy);
        }
      ...
      styleFrom: function styleFrom(id, states, theme, defaultId) {
        ...
        if (!resolved) {
          resolved = aliasMap[theme.name][id] = this.__P_39_3(id, theme, defaultId);
        } // Query theme for ID
...
//# sourceMappingURL=Appearance.js.map?dt=1596533191049