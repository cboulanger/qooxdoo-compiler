  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct: function construct() {
      ...
      this.__P_31_0 = [];
      this.__P_31_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    ...
    */
    members: {
      ...
      addCssClass: function addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__P_31_1 ? selector : selector + (inner ? ":" : "");

            this.__P_31_0.push(innerSelector + key);
      ...
      removeAllCssClasses: function removeAllCssClasses() {
        // remove old rules
        for (var i = 0; i < this.__P_31_0.length; i++) {
          var selector = this.__P_31_0[i];
      ...
      isCached: function isCached(decorator) {
        return !this.__P_31_2 ? false : qx.lang.Object.contains(this.__P_31_2, decorator);
      },
      // property apply
...
//# sourceMappingURL=Decoration.js.map?dt=1593587967071