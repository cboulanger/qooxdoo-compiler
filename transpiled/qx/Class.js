  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Class", {
    statics: {
       ...
       * should be included.
       */
      __P_3_0: true ? qx.core.Property : null,
      ...
      */
      ...
      define: function define(name, config) {
        ...
        // Create the class
        var clazz = this.__P_3_1(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include); // Initialise class and constructor/destructor annotations


        ["@", "@construct", "@destruct"].forEach(function (id) {
          this.__P_3_2(clazz, id, null, config[id]);
        }, this); // Members, properties, events and mixins are only allowed for non-static classes

        if (config.extend) {
          // Attach properties
          if (config.properties) {
            this.__P_3_3(clazz, config.properties, true);
          } // Attach members


          if (config.members) {
            this.__P_3_4(clazz, config.members, true, true, false);
          } // Process events


          if (config.events) {
            this.__P_3_5(clazz, config.events, true);
          } // Include mixins
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__P_3_6(clazz, config.include[i], false);
            }
          }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__P_3_7(clazz, config.implement[i]);
          }
        }
          ...
          qx.Bootstrap.addPendingDefer(clazz, function () {
            ...
            config.defer(clazz, clazz.prototype, {
              add: function add(name, config) {
                ...
                qx.Class.__P_3_3(clazz, properties, true);
              }
            });
          });
        }
      ...
      include: function include(clazz, mixin) {
        qx.Class.__P_3_6(clazz, mixin, false);
      },
      ...
      patch: function patch(clazz, mixin) {
        qx.Class.__P_3_6(clazz, mixin, true);
      ...
      */
       ...
       */
      __P_3_10: function __P_3_10(name, config) {},
       ...
       */
      __P_3_11: function __P_3_11(clazz) {},
       ...
       */
      __P_3_2: function __P_3_2(clazz, group, key, anno) {
        if (anno !== undefined) {
       ...
       */
      __P_3_1: function __P_3_1(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__P_3_12();
            }

            clazz = this.__P_3_13(construct, name, type); // Add singleton getInstance()
          ...
          if (statics) {
            ...
            for (var i = 0, a = Object.keys(statics), l = a.length; i < l; i++) {
              ...
              this.__P_3_2(clazz, "statics", key, statics["@" + key]);
            }
          }
        } // Create namespace
      ...
      */
       ...
       */
      __P_3_5: function __P_3_5(clazz, events, patch) {
        if (clazz.$$events) {
       ...
       */
      __P_3_3: function __P_3_3(clazz, properties, patch) {
        ...
        for (var name in properties) {
          ...
          if (config.event !== undefined) {
            ...
            this.__P_3_5(clazz, event, patch);
          } // Remember inheritable properties


          if (config.inheritable) {
            this.__P_3_0.$$inheritable[name] = true;

            if (!proto.$$refreshInheritables) {
              this.__P_3_0.attachRefreshInheritables(clazz);
            }
          }

          if (!config.refine) {
            this.__P_3_0.attachMethods(clazz, name, config);
          } // Add annotations


          this.__P_3_2(clazz, "properties", name, config["@"]);
        }
      },
       ...
       */
      __P_3_4: function __P_3_4(clazz, members, patch, base, wrap) {
        var proto = clazz.prototype;
        var key, member;
        ...
        for (var i = 0, a = Object.keys(members), l = a.length; i < l; i++) {
          ...
          if (key.charAt(0) === '@') {
            ...
            if (members[annoKey] === undefined) {
              this.__P_3_2(clazz, "members", annoKey, members[key]);
            }
          ...
          if (base !== false && member instanceof Function && member.$$type == null) {
            if (wrap == true) {
              ...
              member = this.__P_3_15(member, proto[key]);
            } else {
          ...
          this.__P_3_2(clazz, "members", key, members["@" + key]);
        }
      },
       ...
       */
      __P_3_15: function __P_3_15(member, base) {
        if (base) {
          return function () {
       ...
       */
      __P_3_7: function __P_3_7(clazz, iface) {
       ...
       */
      __P_3_6: function __P_3_6(clazz, mixin, patch) {
      ...
      */
       ...
       */
      __P_3_13: function __P_3_13(construct, name, type) {
...
//# sourceMappingURL=Class.js.map?dt=1596533184454