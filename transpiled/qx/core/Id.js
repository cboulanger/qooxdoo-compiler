  ...
  qx.Class.define("qx.core.Id", {
    ...
    members: {
      ...
      getAbsoluteIdOf: function getAbsoluteIdOf(obj, suppressWarnings) {
        if (this.__P_94_1 && this.__P_94_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__P_94_1 && this.__P_94_1[owner.toHashCode()] || null;
      ...
      register: function register(obj, id) {
        ...
        this.__P_94_0[id] = obj;
        this.__P_94_1[obj.toHashCode()] = id;
      ...
      unregister: function unregister(data) {
        ...
        if (obj) {
          delete this.__P_94_0[id];
          delete this.__P_94_1[obj.toHashCode()];
...
//# sourceMappingURL=Id.js.map?dt=1593594353072