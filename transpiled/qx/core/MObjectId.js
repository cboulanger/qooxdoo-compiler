    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_78_1) {
          ...
          if (owner) {
            owner.__P_78_2(this, value, oldValue);
          }
       ...
       */
      __P_78_2: function __P_78_2(obj, newId, oldId) {
        delete this.__P_78_0[oldId];
        this.__P_78_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_78_0) {
          for (var name in this.__P_78_0) {
            var obj = this.__P_78_0[name];
       ...
       */
      __P_78_3: function __P_78_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_78_0 ? Object.values(this.__P_78_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1593552888853