  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_179_0 = [];
      this.__P_179_1 = [];
      this.__P_179_2 = 0; // timeout handling

      this.__P_179_3 = new qx.event.Timer(500);

      this.__P_179_3.addListener("interval", this._oninterval, this);
    },
    ...
    members: {
      ...
      */
      ...
      _check: function _check() {
        ...
        if (this.__P_179_1.length == 0 && this.__P_179_0.length == 0) {
          this.__P_179_3.stop();
        } // Checking if enabled
        ...
        if (this.__P_179_0.length == 0 || this.__P_179_0[0].isAsynchronous() && this.__P_179_1.length >= this.getMaxConcurrentRequests()) {
          return;
        } // Checking number of total requests


        if (this.getMaxTotalRequests() != null && this.__P_179_2 >= this.getMaxTotalRequests()) {
          return;
        }

        var vRequest = this.__P_179_0.shift();

        var vTransport = new qx.io.remote.Exchange(vRequest); // Increment counter

        this.__P_179_2++; // Add to active queue

        this.__P_179_1.push(vTransport); // Debug output
      ...
      _remove: function _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__P_179_1, vTransport); // Dispose transport object
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        ...
        this.__P_179_3.setEnabled(value);
      },
      ...
      */
      ...
      add: function add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__P_179_0.push(vRequest);
        } else {
          this.__P_179_0.unshift(vRequest);
        }

        this._check();

        if (this.getEnabled()) {
          this.__P_179_3.start();
        }
      },
      ...
      abort: function abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__P_179_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__P_179_0, vRequest);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__P_179_1");

      this._disposeObjects("__P_179_3");
...
//# sourceMappingURL=RequestQueue.js.map?dt=1593587988313