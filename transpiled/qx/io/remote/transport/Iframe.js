  ...
  qx.Class.define("qx.io.remote.transport.Iframe", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_230_0 = qx.bom.Iframe.create({
        id: vFrameName,
        name: vFrameName,
        src: vFrameSource
      });
      qx.bom.element.Style.set(this.__P_230_0, "display", "none"); // Create form element with textarea as conduit for request data.
      ...
      this.__P_230_1 = qx.dom.Element.create("form", {
        id: vFormName,
        name: vFormName,
        target: vFrameName
      });
      qx.bom.element.Style.set(this.__P_230_1, "display", "none");
      qx.dom.Element.insertEnd(this.__P_230_1, qx.dom.Node.getBodyElement(document));
      this.__P_230_2 = qx.dom.Element.create("textarea", {
        id: "_data_",
        name: "_data_"
      });
      qx.dom.Element.insertEnd(this.__P_230_2, this.__P_230_1); // Finally, attach iframe to DOM and add listeners

      qx.dom.Element.insertEnd(this.__P_230_0, qx.dom.Node.getBodyElement(document));
      qx.event.Registration.addListener(this.__P_230_0, "load", this._onload, this); // qx.event.handler.Iframe does not yet support the readystatechange event

      this.__P_230_3 = qx.lang.Function.listener(this._onreadystatechange, this);
      qx.bom.Event.addNativeListener(this.__P_230_0, "readystatechange", this.__P_230_3);
    },
    ...
    members: {
      ...
      */
      ...
      send: function send() {
        ...
        for (var vId in vFormFields) {
          ...
          this.__P_230_1.appendChild(vField);
        } // --------------------------------------
        //   Preparing form
        // --------------------------------------


        this.__P_230_1.action = vUrl;
        this.__P_230_1.method = vMethod; // --------------------------------------
        //   Sending data
        // --------------------------------------

        this.__P_230_2.appendChild(document.createTextNode(this.getData()));

        this.__P_230_1.submit();
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        this._switchReadyState(qx.io.remote.transport.Iframe._numericMap[this.__P_230_0.readyState]);
      }),
      ...
      _switchReadyState: function _switchReadyState(vReadyState) {
        ...
        while (this.__P_230_4 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__P_230_4]);
        }
      },
      ...
      */
      ...
      getIframeWindow: function getIframeWindow() {
        return qx.bom.Iframe.getWindow(this.__P_230_0);
      },
      ...
      getIframeDocument: function getIframeDocument() {
        return qx.bom.Iframe.getDocument(this.__P_230_0);
      },
      ...
      getIframeBody: function getIframeBody() {
        return qx.bom.Iframe.getBody(this.__P_230_0);
      },
    ...
    */
    destruct: function destruct() {
      if (this.__P_230_0) {
        qx.event.Registration.removeListener(this.__P_230_0, "load", this._onload, this);
        qx.bom.Event.removeNativeListener(this.__P_230_0, "readystatechange", this.__P_230_3); // Reset source to a blank image for gecko
        // Otherwise it will switch into a load-without-end behaviour

        if (qx.core.Environment.get("engine.name") == "gecko") {
          this.__P_230_0.src = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.gif");
        } // Finally, remove element node


        qx.dom.Element.remove(this.__P_230_0);
      }

      if (this.__P_230_1) {
        qx.dom.Element.remove(this.__P_230_1);
      }
...
//# sourceMappingURL=Iframe.js.map?dt=1596533224996