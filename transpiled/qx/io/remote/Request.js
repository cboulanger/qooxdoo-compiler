  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct: function construct(vUrl, vMethod, vResponseType) {
      ...
      this.__P_112_4 = ++qx.io.remote.Request.__P_112_4;
    },
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_112_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      _oncompleted: function _oncompleted(e) {
        ...
        this.__P_112_5(e); // Automatically dispose after event completion
      ...
      */
      ...
      getRequestHeader: function getRequestHeader(vId) {
        return this.__P_112_0[vId] || null;
      },
      ...
      */
      ...
      setParameter: function setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__P_112_2[vId] = vValue;
        } else {
          this.__P_112_1[vId] = vValue;
        }
      },
      ...
      removeParameter: function removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__P_112_2[vId];
        } else {
          delete this.__P_112_1[vId];
        }
      },
      ...
      getParameter: function getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__P_112_2[vId] || null;
        } else {
          return this.__P_112_1[vId] || null;
        }
      },
      ...
      getParameters: function getParameters(bFromData) {
        return bFromData ? this.__P_112_2 : this.__P_112_1;
      },
      ...
      */
      ...
      getFormField: function getFormField(vId) {
        return this.__P_112_3[vId] || null;
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_112_0 = this.__P_112_1 = this.__P_112_2 = this.__P_112_3 = null;
    }
  });
  qx.io.remote.Request.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Request.js.map?dt=1593592739286