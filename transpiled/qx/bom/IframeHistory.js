  ...
  qx.Class.define("qx.bom.IframeHistory", {
    ...
    members: {
      ...
      _readState: function _readState() {
        ...
        var doc = this.__P_127_1.contentWindow.document;
      ...
      _writeState: function _writeState(state) {
        if (!this.__P_127_2) {
          ...
          this.__P_127_3 = qx.event.Timer.once(function () {
       ...
       */
      __P_127_6: function __P_127_6() {
        if (this.__P_127_3) {
          this.__P_127_3.stop();

          this.__P_127_3.dispose();
        }
      },
      ...
      __P_127_0: function __P_127_0() {
        this.__P_127_7(function () {
          qx.event.Idle.getInstance().addListener("interval", this.__P_127_8, this);
        });
      },
       ...
       */
      __P_127_8: function __P_127_8(e) {
        ...
        if (!this.__P_127_9(locationState)) {
          currentState = this.__P_127_10(locationState);
        } else {
       ...
       * @return {String}
       */
      __P_127_10: function __P_127_10(locationState) {
       ...
       * @return {Boolean}
       */
      __P_127_9: function __P_127_9(locationState) {
        return qx.lang.Type.isString(locationState) && locationState == this.__P_127_5;
      },
       ...
       */
      __P_127_7: function __P_127_7(handler) {
        this.__P_127_1 = this.__P_127_11();
        document.body.appendChild(this.__P_127_1);

        this.__P_127_12(function () {
       ...
       */
      __P_127_11: function __P_127_11() {
       ...
       */
      __P_127_12: function __P_127_12(callback, context, retry) {
        if (typeof retry === "undefined") {
          retry = 0;
        }

        if (!this.__P_127_1.contentWindow || !this.__P_127_1.contentWindow.document) {
          if (retry > 20) {
            throw new Error("can't initialize iframe");
          }

          qx.event.Timer.once(function () {
            this.__P_127_12(callback, context, ++retry);
          }, this, 10);
          return;
        }
    ...
    destruct: function destruct() {
      ...
      qx.event.Idle.getInstance().removeListener("interval", this.__P_127_8, this);
    }
  });
  qx.bom.IframeHistory.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=IframeHistory.js.map?dt=1593552898179