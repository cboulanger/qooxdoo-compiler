  ...
  qx.Class.define("qx.bom.HashHistory", {
    ...
    members: {
      ...
      __P_126_0: function __P_126_0() {
        this.__P_126_2 = this.__P_126_4();
        document.body.appendChild(this.__P_126_2);

        this.__P_126_5(function () {
          this._baseUrl = this.__P_126_2.contentWindow.document.location.href;
       ...
       */
      __P_126_5: function __P_126_5(callback, context, retry) {
        if (typeof retry === "undefined") {
          retry = 0;
        }

        if (!this.__P_126_2.contentWindow || !this.__P_126_2.contentWindow.document) {
          if (retry > 20) {
            throw new Error("can't initialize iframe");
          }

          qx.event.Timer.once(function () {
            this.__P_126_5(callback, context, ++retry);
          }, this, 10);
          return;
        }
       ...
       */
      __P_126_6: function __P_126_6() {
        qx.event.Idle.getInstance().addListener("interval", this.__P_126_7, this);
      },

      /**
       * Remove hash change listeners
       */
      __P_126_8: function __P_126_8() {
        qx.event.Idle.getInstance().removeListener("interval", this.__P_126_7, this);
      },
      ...
      _getHash: function _getHash() {
        ...
        return this.__P_126_2.contentWindow.document.location.hash;
      },
      ...
      _setHash: function _setHash(value) {
        if (!this.__P_126_2 || !this._baseUrl) {
          return;
        }

        var hash = !this.__P_126_2.contentWindow.document.location.hash ? "" : this.__P_126_2.contentWindow.document.location.hash.substr(1);

        if (value != hash) {
          this.__P_126_2.contentWindow.document.location.hash = value;
        }
      }
    },
...
//# sourceMappingURL=HashHistory.js.map?dt=1596533207327