    ...
    statics: {
      ...
      addClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          if (old) {
            result = old.split(this.__P_197_0);
      ...
      removeClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          return element.className = element.className.replace(reg, "").replace(this.__P_197_1, "").replace(this.__P_197_0, " ");
        }
      }[qx.core.Environment.get("html.classlist") ? "native" : "default"],
...
//# sourceMappingURL=Class.js.map?dt=1593587990266