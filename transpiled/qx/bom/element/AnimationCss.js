  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      __P_198_5: qx.core.Environment.get("css.animation"),
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        this.__P_198_6(desc); // debug validation
        ...
        if (!this.__P_198_0) {
          this.__P_198_0 = qx.bom.Stylesheet.createElement();
        }
        ...
        if (this.__P_198_5 != null) {
          var name = this.__P_198_7(keyFrames, reverse);

          var style = name + " " + duration + "ms " + desc.timing + " " + (desc.delay ? desc.delay + "ms " : "") + desc.repeat + " " + (desc.alternate ? "alternate" : "");
          qx.bom.Event.addNativeListener(el, this.__P_198_5["start-event"], this.__P_198_8);
          qx.bom.Event.addNativeListener(el, this.__P_198_5["iteration-event"], this.__P_198_9);
          qx.bom.Event.addNativeListener(el, this.__P_198_5["end-event"], this.__P_198_10);
          el.style[qx.lang.String.camelCase(this.__P_198_5["name"])] = style; // use the fill mode property if available and suitable

          if (keep && keep == 100 && this.__P_198_5["fill-mode"]) {
            el.style[this.__P_198_5["fill-mode"]] = "forwards";
          }
        }
        ...
        if (this.__P_198_5 == null) {
          window.setTimeout(function () {
            qx.bom.element.AnimationCss.__P_198_10({
              target: el
            });
          }, 0);
        }
       ...
       */
      __P_198_8: function __P_198_8(e) {
       ...
       * @param e {Event} The native event from the browser.
       */
      __P_198_9: function __P_198_9(e) {
       ...
       * @param e {Event} The native event from the browser.
       */
      __P_198_10: function __P_198_10(e) {
        var el = e.target;
        ...
        if (qx.bom.element.AnimationCss.__P_198_5 != null) {
          // reset the styling
          var key = qx.lang.String.camelCase(qx.bom.element.AnimationCss.__P_198_5["name"]);
          el.style[key] = "";
          qx.bom.Event.removeNativeListener(el, qx.bom.element.AnimationCss.__P_198_5["name"], qx.bom.element.AnimationCss.__P_198_10);
        }
        ...
        qx.bom.element.AnimationCss.__P_198_11(el, desc.keyFrames[animation.keep]);
       ...
       */
      __P_198_11: function __P_198_11(el, endFrame) {
        // keep the element at this animation step
        var transforms;

        for (var style in endFrame) {
          if (style in qx.bom.element.AnimationCss.__P_198_4) {
            if (!transforms) {
              transforms = {};
            }
       ...
       */
      __P_198_6: function __P_198_6(desc) {
       ...
       */
      __P_198_7: function __P_198_7(frames, reverse) {
        ...
        if (this.__P_198_3[rule]) {
          return this.__P_198_3[rule];
        }

        var name = this.__P_198_1 + this.__P_198_2++;
        var selector = this.__P_198_5["keyframes"] + " " + name;
        qx.bom.Stylesheet.addRule(this.__P_198_0, selector, rule);
        this.__P_198_3[rule] = name;
        return name;
      },
       ...
       */
      __P_198_13: function __P_198_13() {
        this.__P_198_2 = 0;

        if (this.__P_198_0) {
          this.__P_198_0.ownerNode.remove();
...
//# sourceMappingURL=AnimationCss.js.map?dt=1593594367943