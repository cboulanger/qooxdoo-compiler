    ...
    */
    statics: {
      ...
      compile: function compile(cursor) {
        return "cursor:" + (this.__P_134_0[cursor] || cursor) + ";";
      },
      ...
      set: function set(element, value) {
        element.style.cursor = this.__P_134_0[value] || value;
      },
    ...
    defer: function defer(statics) {
      ...
      if (qx.core.Environment.get("engine.name") == "mshtml" && (parseFloat(qx.core.Environment.get("engine.version")) < 9 || qx.core.Environment.get("browser.documentmode") < 9) && !qx.core.Environment.get("browser.quirksmode")) {
        statics.__P_134_0["nesw-resize"] = "ne-resize";
        statics.__P_134_0["nwse-resize"] = "nw-resize";
      }
    }
  });
...
//# sourceMappingURL=Cursor.js.map?dt=1595486333613