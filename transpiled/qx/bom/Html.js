  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    statics: {
       ...
       */
      __P_237_0: function __P_237_0(all, front, tag) {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__P_237_0);
      },
       ...
       */
      __P_237_2: function __P_237_2(html, context) {
      ...
      clean: function clean(objs, context, fragment) {
        ...
        for (var i = 0, l = objs.length; i < l; i++) {
          ...
          if (typeof obj === "string") {
            obj = this.__P_237_2(obj, context);
...
//# sourceMappingURL=Html.js.map?dt=1593594375104