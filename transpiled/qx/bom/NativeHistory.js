    ...
    members: {
      ...
      __P_128_0: function __P_128_0() {
        if (qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT) {
          var boundFunc = qx.lang.Function.bind(this.__P_128_2, this);
          this.__P_128_1 = qx.event.GlobalError.observeMethod(boundFunc);
          qx.bom.Event.addNativeListener(window, "hashchange", this.__P_128_1);
        } else {
          qx.event.Idle.getInstance().addListener("interval", this.__P_128_2, this);
        }
      },
       ...
       */
      __P_128_3: function __P_128_3() {
        if (qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT) {
          qx.bom.Event.removeNativeListener(window, "hashchange", this.__P_128_1);
        } else {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_128_2, this);
        }
      },
...
//# sourceMappingURL=NativeHistory.js.map?dt=1596533207456