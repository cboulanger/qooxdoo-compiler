  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    statics: {
       ...
       */
      __P_125_1: function __P_125_1() {
        var el = this.__P_125_2(false);
       ...
       */
      __P_125_2: function __P_125_2(html) {
       ...
       */
      __P_125_4: function __P_125_4(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_125_4(html));
        }
      ...
      setValue: function setValue(element, value) {
        ...
        if (element.useHtml) {
          if (qx.bom.Label.__P_125_5 && typeof qx.bom.Label.__P_125_5 === "function") {
            value = qx.bom.Label.__P_125_5(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__P_125_3(); // apply width


        element.style.width = width != undefined ? width + "px" : "auto"; // insert content

        element.innerHTML = content;
        return this.__P_125_6(element, styles);
      },
      ...
      getTextSize: function getTextSize(text, styles) {
        var element = this._textElement || this.__P_125_1();
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_125_6: function __P_125_6(element, styles) {
        // sync styles
...
//# sourceMappingURL=Label.js.map?dt=1593587981272