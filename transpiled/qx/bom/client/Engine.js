  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_19_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_19_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_19_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_19_3()) {
      ...
      __P_19_0: function __P_19_0() {
        ...
        if (qx.bom.client.Engine.__P_19_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1595486314955