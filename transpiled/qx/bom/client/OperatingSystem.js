  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
      ...
      getVersion: function getVersion() {
        var version = qx.bom.client.OperatingSystem.__P_73_1(navigator.userAgent);

        if (version == null) {
          version = qx.bom.client.OperatingSystem.__P_73_2(navigator.userAgent);
        }
       ...
       */
      __P_73_1: function __P_73_1(userAgent) {
        var str = [];

        for (var key in qx.bom.client.OperatingSystem.__P_73_0) {
          str.push(key);
        }
        ...
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__P_73_0[match[1]];
        }
       ...
       * @return {String} version number as string or null.
       */
      __P_73_2: function __P_73_2(userAgent) {
...
//# sourceMappingURL=OperatingSystem.js.map?dt=1593594349150