  ...
  qx.Bootstrap.define("qx.bom.client.Css", {
    statics: {
      ...
      getLinearGradient: function getLinearGradient() {
        qx.bom.client.Css.__P_61_0 = false;
        ...
        if (!style) {
          ...
          if (style) {
            qx.bom.client.Css.__P_61_0 = true;
          }
        } // not supported
      ...
      getLegacyWebkitGradient: function getLegacyWebkitGradient() {
        if (qx.bom.client.Css.__P_61_0 === null) {
          qx.bom.client.Css.getLinearGradient();
        }

        return qx.bom.client.Css.__P_61_0;
      },
...
//# sourceMappingURL=Css.js.map?dt=1593587970256