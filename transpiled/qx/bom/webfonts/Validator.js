  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    construct: function construct(fontFamily, comparisonString) {
      ...
      if (fontFamily) {
        ...
        this.__P_214_0 = this._getRequestedHelpers();
      }
    },
    ...
    */
    statics: {
      ...
      removeDefaultHelperElements: function removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_214_2;
        ...
        delete qx.bom.webfonts.Validator.__P_214_2;
      }
    },
    ...
    members: {
      ...
      */
      ...
      validate: function validate() {
        this.__P_214_4 = new Date().getTime();

        if (this.__P_214_3) {
          this.__P_214_3.restart();
        } else {
          this.__P_214_3 = new qx.event.Timer(100);

          this.__P_214_3.addListener("interval", this.__P_214_5, this); // Give the browser a chance to render the new elements
      ...
      */
      ...
      _reset: function _reset() {
        if (this.__P_214_0) {
          for (var prop in this.__P_214_0) {
            var elem = this.__P_214_0[prop];
      ...
      _isFontValid: function _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_214_1) {
          this.__P_214_6();
        }
        ...
        this.__P_214_0.sans.style.visibility = "visible";
        this.__P_214_0.sans.style.visibility = "hidden";
        this.__P_214_0.serif.style.visibility = "visible";
        this.__P_214_0.serif.style.visibility = "hidden";
        var requestedSans = qx.bom.element.Dimension.getWidth(this.__P_214_0.sans);
        var requestedSerif = qx.bom.element.Dimension.getWidth(this.__P_214_0.serif);
        var cls = qx.bom.webfonts.Validator;

        if (requestedSans !== cls.__P_214_1.sans || requestedSerif !== cls.__P_214_1.serif) {
          return true;
        }
      ...
      */
      ...
      __P_214_6: function __P_214_6() {
        ...
        cls.__P_214_1 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_214_2.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_214_2.serif)
        };
      },
      ...
      __P_214_5: function __P_214_5() {
        if (this._isFontValid()) {
          ...
          if (now - this.__P_214_4 >= this.getTimeout()) {
            this.__P_214_3.stop();
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_214_3.removeListener("interval", this.__P_214_5, this);
...
//# sourceMappingURL=Validator.js.map?dt=1596533221439