  ...
  qx.Class.define("qx.bom.webfonts.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_187_1 = {};
      this.__P_187_2 = [];
      this.__P_187_3 = this.getPreferredFormats();
    },
    ...
    */
    members: {
      ...
      */
      ...
      require: function require(familyName, sourcesList, callback, context) {
        ...
        if (qx.core.Environment.get("engine.name") == "mshtml" && (parseInt(qx.core.Environment.get("engine.version")) < 9 || qx.core.Environment.get("browser.documentmode") < 9)) {
          if (!this.__P_187_5) {
            this.__P_187_5 = new qx.event.Timer(100);

            this.__P_187_5.addListener("interval", this.__P_187_6, this);
          }

          if (!this.__P_187_5.isEnabled()) {
            this.__P_187_5.start();
          }

          this.__P_187_2.push([familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context]);
        } else {
          this.__P_187_7(familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context);
        }
      },
      ...
      remove: function remove(familyName, fontWeight, fontStyle) {
        var fontLookupKey = this.__P_187_8(familyName, fontWeight, fontStyle);

        var index = null;

        for (var i = 0, l = this.__P_187_0.length; i < l; i++) {
          if (this.__P_187_0[i] == fontLookupKey) {
            index = i;

            this.__P_187_9(familyName, fontWeight, fontStyle);
        ...
        if (index !== null) {
          qx.lang.Array.removeAt(this.__P_187_0, index);
        }

        if (familyName in this.__P_187_1) {
          this.__P_187_1[familyName].dispose();

          delete this.__P_187_1[familyName];
        }
      },
      ...
      removeStyleSheet: function removeStyleSheet() {
        ...
        if (this.__P_187_4) {
          qx.bom.Stylesheet.removeSheet(this.__P_187_4);
        }
      ...
      */
       ...
       */
      __P_187_8: function __P_187_8(familyName, fontWeight, fontStyle) {
       ...
       * @param context {Object?} Optional context for the callback function
       */
      __P_187_7: function __P_187_7(familyName, sources, fontWeight, fontStyle, comparisonString, version, callback, context) {
        var fontLookupKey = this.__P_187_8(familyName, fontWeight, fontStyle);

        if (!this.__P_187_0.includes(fontLookupKey)) {
          var sourcesMap = this.__P_187_10(sources);

          var rule = this.__P_187_11(familyName, fontWeight, fontStyle, sourcesMap, version);
          ...
          if (!this.__P_187_4) {
            this.__P_187_4 = qx.bom.Stylesheet.createElement();
          }

          try {
            this.__P_187_12(rule);
          } catch (ex) {}

          this.__P_187_0.push(fontLookupKey);
        }

        if (!this.__P_187_1[familyName]) {
          this.__P_187_1[familyName] = new qx.bom.webfonts.Validator(familyName, comparisonString);

          this.__P_187_1[familyName].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);

          this.__P_187_1[familyName].addListenerOnce("changeStatus", this.__P_187_13, this);
        }

        if (callback) {
          var cbContext = context || window;

          this.__P_187_1[familyName].addListenerOnce("changeStatus", callback, cbContext);
        }

        this.__P_187_1[familyName].validate();
      },

      /**
       * Processes the next item in the queue
       */
      __P_187_6: function __P_187_6() {
        if (this.__P_187_2.length == 0) {
          this.__P_187_5.stop();

          return;
        }

        var next = this.__P_187_2.shift();

        this.__P_187_7.apply(this, next);
      },
       ...
       */
      __P_187_13: function __P_187_13(ev) {
       ...
       */
      __P_187_10: function __P_187_10(sources) {
       ...
       */
      __P_187_11: function __P_187_11(familyName, fontWeight, fontStyle, sourcesMap, version) {
        var rules = [];
        var formatList = this.__P_187_3.length > 0 ? this.__P_187_3 : qx.bom.webfonts.Manager.FONT_FORMATS;

        for (var i = 0, l = formatList.length; i < l; i++) {
          var format = formatList[i];

          if (sourcesMap[format]) {
            rules.push(this.__P_187_14(format, sourcesMap[format], version));
          }
        }
       ...
       */
      __P_187_14: function __P_187_14(format, url, version) {
        if (version) {
          url += "?" + version;
        }
       ...
       */
      __P_187_12: function __P_187_12(rule) {
        var completeRule = "@font-face {" + rule + "}\n";

        if (qx.core.Environment.get("browser.name") == "ie" && qx.core.Environment.get("browser.documentmode") < 9) {
          var cssText = this.__P_187_15(this.__P_187_4.cssText);

          cssText += completeRule;
          this.__P_187_4.cssText = cssText;
        } else {
          this.__P_187_4.insertRule(completeRule, this.__P_187_4.cssRules.length);
        }
      },
       ...
       */
      __P_187_9: function __P_187_9(familyName, fontWeight, fontStyle) {
        ...
        for (var i = 0, l = document.styleSheets.length; i < l; i++) {
          ...
          if (sheet.cssText) {
            ...
            cssText = this.__P_187_15(cssText);
       ...
       */
      __P_187_15: function __P_187_15(cssText) {
    ...
    */
    destruct: function destruct() {
      if (this.__P_187_5) {
        ...
        this.__P_187_5.dispose();
      }

      delete this.__P_187_0;
      this.removeStyleSheet();

      for (var prop in this.__P_187_1) {
        this.__P_187_1[prop].dispose();
      }
...
//# sourceMappingURL=Manager.js.map?dt=1593587988990