    ...
    members: {
      ...
      _getTocHtml: function _getTocHtml(classNode) {
        ...
        this.getPanels().forEach(function (panel) {
          ...
          q(tocItem).on("tap", function (firstItem) {
            return function () {
              this.__P_190_0(firstItem, firstItem.getName());
      ...
      _getDescriptionHtml: function _getDescriptionHtml(classNode) {
        ...
        if (classNode.getType() === "interface") {
          classHtml.add(this.__P_190_1(classNode));
        } else {
          classHtml.add(this.__P_190_2(classNode));
        }

        return classNode.getChildClasses().then(function (childClasses) {
          classHtml.add(_this2.__P_190_3(childClasses, "Direct " + subObjectsName + ":"));
          classHtml.add(_this2.__P_190_3(classNode.getInterfaces(), "Implemented interfaces:"));
          classHtml.add(_this2.__P_190_3(classNode.getMixins(), "Included mixins:"));
          return classNode.getImplementations();
        }).then(function (classes) {
          classHtml.add(_this2.__P_190_3(classes, "Implementations of this interface:"));
          return classNode.getIncluder();
        }).then(function (classes) {
          classHtml.add(_this2.__P_190_3(classes, "Classes including this mixin:"));
       ...
       */
      __P_190_3: function __P_190_3(dependentClasses, title) {
        var result = "";
       ...
       */
      __P_190_2: function __P_190_2(classNode) {
       ...
       * @return {String} HTML fragemnt
       */
      __P_190_1: function __P_190_1(classNode) {
      ...
      showItem: function showItem(itemName) {
        ...
        this.__P_190_0(itemNode, itemName);
       ...
       */
      __P_190_0: function __P_190_0(itemNode, itemName) {
...
//# sourceMappingURL=ClassViewer.js.map?dt=1596533216653