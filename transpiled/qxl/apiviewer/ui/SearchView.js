  ...
  qx.Class.define("qxl.apiviewer.ui.SearchView", {
    ...
    members: {
      ...
      search: function search(term) {
        ...
        if (qx.lang.Object.getLength(this.apiindex) == 0) {
          ...
          this.__P_46_5 = null; // Set search box value
      ...
      _showSearchForm: function _showSearchForm() {
        ...
        this.__P_46_3 = new qx.data.Array([true, true, true, true, true, true, true]);
        ...
        for (var i = 0; i < types.length; i++) {
          ...
          typeToggleButton.bind("value", this.__P_46_3, "[" + i + "]");
          ...
          this.__P_46_3.bind("[" + i + "]", typeToggleButton, "value");
        }
        ...
        typeToggleButtonAll.addListener("changeValue", function (e) {
          for (var i = 0; i < this.__P_46_3.length; i++) {
            this.__P_46_3.setItem(i, e.getData());
          }
        ...
        this.__P_46_0 = true;
        this.__P_46_2 = table; // table.addListener("appear", this.__handleNote, this);
      ...
      _searchResult: function _searchResult(svalue) {
        ...
        for (var i = 0; i < this.__P_46_3.length; i++) {
          if (this.__P_46_3.getItem(i) === true) {
      ...
      _isTypeFilteredIn: function _isTypeFilteredIn(type) {
        return this.__P_46_3.getItem(this.__P_46_4[type]);
      },
      ...
      _load: function _load() {
        ...
        req.addListener("completed", function (evt) {
          ...
          if (this.__P_46_5) {
            setTimeout(function () {
              this.sinput.setValue(this.__P_46_5);
              this.__P_46_5 = null;
            }.bind(this), 0);
          }
        }, this);
      ...
      __P_46_6: function __P_46_6(table) {
        this.__P_46_1 = new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({
          autoHide: false,
          width: 170
        });
        ...
        this.__P_46_1.add(hint, {
          edge: 3
        });

        this.__P_46_1.setPosition("bottom-left");

        this.__P_46_1.placeToWidget(this.sinput, false);

        this.__P_46_1.show();
      },
      __P_46_7: function __P_46_7(e) {
        if (this.__P_46_1) {
    ...
    */
    destruct: function destruct() {
      this.apiindex = this._table = this.__P_46_2 = this._tableModel = this.__P_46_3 = this.__P_46_4 = this._selectionModel = null;

      this._disposeObjects("sinput", "__P_46_1");
...
//# sourceMappingURL=SearchView.js.map?dt=1593587968503