  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __P_218_0: function __P_218_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }

        if (node.isPrivate()) {
          var access = "__P_218_1";
      ...
      __P_218_2: function __P_218_2(node) {
        var attributes = [];
       ...
       */
      __P_218_3: function __P_218_3(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__P_218_2(node));
          textHtml.add(this.__P_218_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__P_218_3(node));
...
//# sourceMappingURL=PropertyPanel.js.map?dt=1593594371624