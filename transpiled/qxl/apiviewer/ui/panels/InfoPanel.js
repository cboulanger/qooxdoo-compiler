  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.InfoPanel", {
    ...
    members: {
      ...
      getItemHtml: function getItemHtml(node, currentDocNode, showDetails) {
        ...
        if (this.itemHasDetails(node, currentDocNode)) {
          ...
          html.add("<img src=\"", qx.util.ResourceManager.getInstance().toUri("qxl/apiviewer/image/open.gif"), "\" onclick=\"", this.__P_216_0(this), ".toggleShowItemDetails('", node.getName(), "'", parentNode != currentDocNode ? ",'" + parentNode.getFullName() + "'" : "", ")\"/>");
        } else {
          html.add("&#160;");
        }
        ...
        if (this.itemHasDetails(node, currentDocNode)) {
          html.add(" onclick=\"", this.__P_216_0(this), ".toggleShowItemDetails('", node.getName(), "'", parentNode != currentDocNode ? ",'" + parentNode.getFullName() + "'" : "", ")\">");
        } else {
          html.add(">");
        }
      ...
      __P_216_0: function __P_216_0(object) {
      ...
      getPanelHtml: function getPanelHtml(viewer) {
        ...
        html.add("<img class=\"openclose\" src=\"", qx.util.ResourceManager.getInstance().toUri("qxl/apiviewer/image/" + (this.getIsOpen() ? "close.gif" : "open.gif")), "\" onclick=\"", this.__P_216_0(viewer), ".togglePanelVisibility(" + this.__P_216_0(this), ")\"/> ", "<span onclick=\"", this.__P_216_0(viewer), ".togglePanelVisibility(", this.__P_216_0(this), ")\">", uppercaseLabelText, "</span>");
       ...
       */
      __P_216_1: function __P_216_1(nodeArr, expandProperties, showProtected, showPrivate, showInternal) {
      ...
      update: function update(classViewer, currentClassDocNode) {
        ...
        return this.setDocNodeAsync(currentClassDocNode).then(function () {
          ...
          if (nodeArr && nodeArr.length > 0) {
            ...
            nodeArr = _this.__P_216_1(nodeArr, expandProperties, showProtected, showPrivate, showInternal);
    ...
    statics: {
          ...
          if (useIcon) {
            ...
            if (classNode && classNode.isLoaded && classNode.isLoaded()) {
              ...
              if (itemName) {
                ...
                itemNode = this.__P_216_2(cleanItemName, classNode);
       ...
       *
       */
      __P_216_2: function __P_216_2(itemName, baseClassNode) {
       ...
       */
      __P_216_3: function __P_216_3(text) {
      ...
      descriptionHasDetails: function descriptionHasDetails(node) {
        ...
        if (desc) {
          return this.__P_216_3(desc) != desc;
        }
...
//# sourceMappingURL=InfoPanel.js.map?dt=1593592755918