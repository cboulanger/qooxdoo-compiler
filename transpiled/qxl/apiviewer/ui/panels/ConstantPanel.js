  ...
  qx.Class.define("qxl.apiviewer.ui.panels.ConstantPanel", {
    ...
    members: {
      ...
      itemHasDetails: function itemHasDetails(node, currentClassDocNode) {
        return node.getSee().length > 0 || node.getErrors().length > 0 || qxl.apiviewer.ui.panels.InfoPanel.descriptionHasDetails(node) || this.__P_217_0(node);
      },
       ...
       */
      __P_217_0: function __P_217_0(node) {
       ...
       */
      __P_217_1: function __P_217_1(node) {
...
//# sourceMappingURL=ConstantPanel.js.map?dt=1593587993946