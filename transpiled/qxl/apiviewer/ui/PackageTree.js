  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.PackageTree", {
    ...
    construct: function construct() {
      ...
      this.setPadding(0);
      this.__P_45_0 = new qx.ui.tree.TreeFolder("Packages");

      this.__P_45_0.setOpen(true);

      this.setRoot(this.__P_45_0);
      this.setSelection([this.__P_45_0]); // Workaround: Since navigating in qx.ui.tree.Tree doesn't work, we've to
    ...
    */
    members: {
      ...
      setTreeData: function setTreeData(docTree) {
        ...
        this.__P_45_1(this.__P_45_0, docTree, 0);
      ...
      selectTreeNodeByClassName: function selectTreeNodeByClassName(className) {
        ...
        if (!className) {
          ...
          this.setSelection([this.__P_45_0]);
          this.scrollChildIntoView(this.__P_45_0);
          return qx.Promise.resolve(true);
        }
       ...
       */
      __P_45_2: function __P_45_2(packageTreeNode, packageDoc, depth) {
        var self = this;
        return function () {
          if (!packageTreeNode.loaded) {
            packageTreeNode.loaded = true;

            self.__P_45_1(packageTreeNode, packageDoc, depth + 1);
       ...
       *          {var} current depth in the tree
       */
      __P_45_1: function __P_45_1(treeNode, docNode, depth) {
        var _this2 = this;
        ...
        qx.Promise.map(packagesDoc, function (packageDoc) {
          ...
          packageTreeNode.addListener("changeOpen", _this2.__P_45_2(packageTreeNode, packageDoc, depth + 1), _this2); // Register the tree node
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_45_0");
    }
  });
  qxl.apiviewer.ui.PackageTree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=PackageTree.js.map?dt=1593552882879