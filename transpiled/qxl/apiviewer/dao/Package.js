  ...
  qx.Class.define("qxl.apiviewer.dao.Package", {
    ...
    statics: {
      ...
      getPackage: function getPackage(name, create) {
        var root = qxl.apiviewer.dao.Package.__P_59_0;

        if (!root) {
          root = qxl.apiviewer.dao.Package.__P_59_0 = new qxl.apiviewer.dao.Package("");
        }
...
//# sourceMappingURL=Package.js.map?dt=1593552885029