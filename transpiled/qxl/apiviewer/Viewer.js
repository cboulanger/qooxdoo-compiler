  ...
  qx.Class.define("qxl.apiviewer.Viewer", {
    ...
    */
    construct: function construct() {
      ...
      this.add(this.__P_7_1());
      this.add(this.__P_7_2());
      ...
      var toggleView = this.__P_7_3(tree, this._searchView, legend);

      var mainFrame = this.__P_7_4();

      this.add(this.__P_7_5(toggleView, mainFrame), {
        flex: 1
      ...
      if (parsedUri.queryKey && parsedUri.queryKey.search) {
        ...
        this.__P_7_6.setSelection([this.__P_7_6.getChildren()[1]]);
      }
    },
    ...
    */
    members: {
       ...
       */
      __P_7_3: function __P_7_3(treeWidget, searchWidget, infoWidget) {
        ...
        this.__P_7_6.addListener("changeSelection", function (e) {
      ...
      __P_7_2: function __P_7_2() {
        ...
        this.__P_7_8 = new qx.ui.menu.Menu();
        chevron.setMenu(this.__P_7_8); // add the listener
      ...
      _getMenuItems: function _getMenuItems(toolbarPart) {
        ...
        if (toolbarPart.toHashCode() === this.__P_7_7) {
          var cachedItem = this.__P_7_0[toolbarPart.toHashCode()];

          if (!cachedItem) {
            cachedItem = new qx.ui.menu.Separator();

            this.__P_7_8.addAt(cachedItem, 0);

            this.__P_7_0[toolbarPart.toHashCode()] = cachedItem;
          }
        ...
        for (var i = partChildren.length - 1; i >= 0; i--) {
          ...
          cachedItem = this.__P_7_0[toolbarItem.toHashCode()];
          ...
          if (!cachedItem) {
            ...
            this.__P_7_0[toolbarItem.toHashCode()] = cachedItem;
          }
       ...
       */
      __P_7_9: function __P_7_9(toolbar, detailFrame) {
       ...
       */
      __P_7_5: function __P_7_5(leftWidget, rightWidget) {
    ...
    */
    destruct: function destruct() {
      this._classTreeNodeHash = this.__P_7_6 = null;
...
//# sourceMappingURL=Viewer.js.map?dt=1593552876850