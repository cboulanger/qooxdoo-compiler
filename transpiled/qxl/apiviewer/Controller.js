  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      btn_inherited.addListener("changeValue", this.__P_8_3, this);
      btn_included.addListener("changeValue", this.__P_8_3, this);
      this._history = qx.bom.History.getInstance();

      this.__P_8_4();

      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__P_8_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __P_8_5: false,
      ...
      load: function load(apidata) {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            if (state) {
              _this.__P_8_6(_this.__P_8_7(state));
            } else {
              _this.__P_8_6("");
            }
          });
       ...
       * bind history events
       */
      __P_8_4: function __P_8_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__P_8_7(evt.getData());
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__P_8_8(className), newTitle);
      },
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  _context.next = 7;
                  return this._tabViewController.openClass(classNode, this.__P_8_5);
                ...
                case 9:
                  _context.next = 11;
                  return this._tabViewController.openPackage(classNode, this.__P_8_5);
       ...
       * 
       */
      __P_8_6: function __P_8_6(fullItemName) {
        var _this2 = this;
      ...
      __P_8_8: function __P_8_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __P_8_7: function __P_8_7(encodedState) {
...
//# sourceMappingURL=Controller.js.map?dt=1595486312753