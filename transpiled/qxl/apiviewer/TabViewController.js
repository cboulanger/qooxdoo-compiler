  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.TabViewController", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      this._tabView.addListener("changeSelection", this.__P_57_0, this);
    },
    events: {
    ...
    members: {
      ...
      openPackage: function openPackage(classNode, newTab) {
        return this.__P_57_1(classNode, qxl.apiviewer.ui.tabview.PackagePage, newTab);
      },
      openClass: function openClass(classNode, newTab) {
        return this.__P_57_1(classNode, qxl.apiviewer.ui.tabview.ClassPage, newTab);
      },
      __P_57_1: function __P_57_1(classNode, clazz, newTab) {
      ...
      __P_57_0: function __P_57_0(event) {
...
//# sourceMappingURL=TabViewController.js.map?dt=1593594346448